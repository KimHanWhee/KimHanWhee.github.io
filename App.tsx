  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        `}</style>
        <span className="text-5xl inline-block animate-[bounce_2s_infinite] select-none">😎</span>
        <div
          className="w-10 h-2 bg-slate-400 rounded-full blur-sm mt-1"
          style={{ animation: 'emoji-shadow 2s cubic-bezier(0.8,0,1,1) infinite' }}
        />
      </div>
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const removeTimer = setTimeout(() => setIsLoading(false), LOADING_DURATION + 500);
    return () => {
