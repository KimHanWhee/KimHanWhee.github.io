 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Gd;function x0(){if(Gd)return P;Gd=1;var u=Symbol.for("react.transitional.element"),s=Symbol.for("react.portal"),r=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),h=Symbol.for("react.consumer"),p=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),A=Symbol.for("react.activity"),z=Symbol.iterator;function M(S){return S===null||typeof S!="object"?null:(S=z&&S[z]||S["@@iterator"],typeof S=="function"?S:null)}var B={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},L=Object.assign,G={};function V(S,U,Q){this.props=S,this.context=U,this.refs=G,this.updater=Q||B}V.prototype.isReactComponent={},V.prototype.setState=function(S,U){if(typeof S!="object"&&typeof S!="function"&&S!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,S,U,"setState")},V.prototype.forceUpdate=function(S){this.updater.enqueueForceUpdate(this,S,"forceUpdate")};function K(){}K.prototype=V.prototype;function H(S,U,Q){this.props=S,this.context=U,this.refs=G,this.updater=Q||B}var W=H.prototype=new K;W.constructor=H,L(W,V.prototype),W.isPureReactComponent=!0;var ee=Array.isArray;function se(){}var I={H:null,A:null,T:null,S:null},ke=Object.prototype.hasOwnProperty;function Ve(S,U,Q){var X=Q.ref;return{$$typeof:u,type:S,key:U,ref:X!==void 0?X:null,props:Q}}function vt(S,U){return Ve(S.type,U,S.props)}function Lt(S){return typeof S=="object"&&S!==null&&S.$$typeof===u}function et(S){var U={"=":"=0",":":"=2"};return"$"+S.replace(/[=:]/g,function(Q){return U[Q]})}var qn=/\/+/g;function Vt(S,U){return typeof S=="object"&&S!==null&&S.key!=null?et(""+S.key):U.toString(36)}function zt(S){switch(S.status){case"fulfilled":return S.value;case"rejected":throw S.reason;default:switch(typeof S.status=="string"?S.then(se,se):(S.status="pending",S.then(function(U){S.status==="pending"&&(S.status="fulfilled",S.value=U)},function(U){S.status==="pending"&&(S.status="rejected",S.reason=U)})),S.status){case"fulfilled":return S.value;case"rejected":throw S.reason}}throw S}function k(S,U,Q,X,te){var ae=typeof S;(ae==="undefined"||ae==="boolean")&&(S=null);var pe=!1;if(S===null)pe=!0;else switch(ae){case"bigint":case"string":case"number":pe=!0;break;case"object":switch(S.$$typeof){case u:case s:pe=!0;break;case E:return pe=S._init,k(pe(S._payload),U,Q,X,te)}}if(pe)return te=te(S),pe=X===""?"."+Vt(S,0):X,ee(te)?(Q="",pe!=null&&(Q=pe.replace(qn,"$&/")+"/"),k(te,U,Q,"",function(Il){return Il})):te!=null&&(Lt(te)&&(te=vt(te,Q+(te.key==null||S&&S.key===te.key?"":(""+te.key).replace(qn,"$&/")+"/")+pe)),U.push(te)),1;pe=0;var Fe=X===""?".":X+":";if(ee(S))for(var we=0;we<S.length;we++)X=S[we],ae=Fe+Vt(X,we),pe+=k(X,U,Q,ae,te);else if(we=M(S),typeof we=="function")for(S=we.call(S),we=0;!(X=S.next()).done;)X=X.value,ae=Fe+Vt(X,we++),pe+=k(X,U,Q,ae,te);else if(ae==="object"){if(typeof S.then=="function")return k(zt(S),U,Q,X,te);throw U=String(S),Error("Objects are not valid as a React child (found: "+(U==="[object Object]"?"object with keys {"+Object.keys(S).join(", ")+"}":U)+"). If you meant to render a collection of children, use an array instead.")}return pe}function q(S,U,Q){if(S==null)return S;var X=[],te=0;return k(S,X,"","",function(ae){return U.call(Q,ae,te++)}),X}function F(S){if(S._status===-1){var U=S._result;U=U(),U.then(function(Q){(S._status===0||S._status===-1)&&(S._status=1,S._result=Q)},function(Q){(S._status===0||S._status===-1)&&(S._status=2,S._result=Q)}),S._status===-1&&(S._status=0,S._result=U)}if(S._status===1)return S._result.default;throw S._result}var ve=typeof reportError=="function"?reportError:function(S){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var U=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof S=="object"&&S!==null&&typeof S.message=="string"?String(S.message):String(S),error:S});if(!window.dispatchEvent(U))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",S);return}console.error(S)},Te={map:q,forEach:function(S,U,Q){q(S,function(){U.apply(this,arguments)},Q)},count:function(S){var U=0;return q(S,function(){U++}),U},toArray:function(S){return q(S,function(U){return U})||[]},only:function(S){if(!Lt(S))throw Error("React.Children.only expected to receive a single React element child.");return S}};return P.Activity=A,P.Children=Te,P.Component=V,P.Fragment=r,P.Profiler=f,P.PureComponent=H,P.StrictMode=c,P.Suspense=b,P.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=I,P.__COMPILER_RUNTIME={__proto__:null,c:function(S){return I.H.useMemoCache(S)}},P.cache=function(S){return function(){return S.apply(null,arguments)}},P.cacheSignal=function(){return null},P.cloneElement=function(S,U,Q){if(S==null)throw Error("The argument must be a React element, but you passed "+S+".");var X=L({},S.props),te=S.key;if(U!=null)for(ae in U.key!==void 0&&(te=""+U.key),U)!ke.call(U,ae)||ae==="key"||ae==="__self"||ae==="__source"||ae==="ref"&&U.ref===void 0||(X[ae]=U[ae]);var ae=arguments.length-2;if(ae===1)X.children=Q;else if(1<ae){for(var pe=Array(ae),Fe=0;Fe<ae;Fe++)pe[Fe]=arguments[Fe+2];X.children=pe}return Ve(S.type,te,X)},P.createContext=function(S){return S={$$typeof:p,_currentValue:S,_currentValue2:S,_threadCount:0,Provider:null,Consumer:null},S.Provider=S,S.Consumer={$$typeof:h,_context:S},S},P.createElement=function(S,U,Q){var X,te={},ae=null;if(U!=null)for(X in U.key!==void 0&&(ae=""+U.key),U)ke.call(U,X)&&X!=="key"&&X!=="__self"&&X!=="__source"&&(te[X]=U[X]);var pe=arguments.length-2;if(pe===1)te.children=Q;else if(1<pe){for(var Fe=Array(pe),we=0;we<pe;we++)Fe[we]=arguments[we+2];te.children=Fe}if(S&&S.defaultProps)for(X in pe=S.defaultProps,pe)te[X]===void 0&&(te[X]=pe[X]);return Ve(S,ae,te)},P.createRef=function(){return{current:null}},P.forwardRef=function(S){return{$$typeof:g,render:S}},P.isValidElement=Lt,P.lazy=function(S){return{$$typeof:E,_payload:{_status:-1,_result:S},_init:F}},P.memo=function(S,U){return{$$typeof:m,type:S,compare:U===void 0?null:U}},P.startTransition=function(S){var U=I.T,Q={};I.T=Q;try{var X=S(),te=I.S;te!==null&&te(Q,X),typeof X=="object"&&X!==null&&typeof X.then=="function"&&X.then(se,ve)}catch(ae){ve(ae)}finally{U!==null&&Q.types!==null&&(U.types=Q.types),I.T=U}},P.unstable_useCacheRefresh=function(){return I.H.useCacheRefresh()},P.use=function(S){return I.H.use(S)},P.useActionState=function(S,U,Q){return I.H.useActionState(S,U,Q)},P.useCallback=function(S,U){return I.H.useCallback(S,U)},P.useContext=function(S){return I.H.useContext(S)},P.useDebugValue=function(){},P.useDeferredValue=function(S,U){return I.H.useDeferredValue(S,U)},P.useEffect=function(S,U){return I.H.useEffect(S,U)},P.useEffectEvent=function(S){return I.H.useEffectEvent(S)},P.useId=function(){return I.H.useId()},P.useImperativeHandle=function(S,U,Q){return I.H.useImperativeHandle(S,U,Q)},P.useInsertionEffect=function(S,U){return I.H.useInsertionEffect(S,U)},P.useLayoutEffect=function(S,U){return I.H.useLayoutEffect(S,U)},P.useMemo=function(S,U){return I.H.useMemo(S,U)},P.useOptimistic=function(S,U){return I.H.useOptimistic(S,U)},P.useReducer=function(S,U,Q){return I.H.useReducer(S,U,Q)},P.useRef=function(S){return I.H.useRef(S)},P.useState=function(S){return I.H.useState(S)},P.useSyncExternalStore=function(S,U,Q){return I.H.useSyncExternalStore(S,U,Q)},P.useTransition=function(){return I.H.useTransition()},P.version="19.2.3",P}var Bd;function gc(){return Bd||(Bd=1,Pr.exports=x0()),Pr.exports}var D=gc();const S0=pm(D);var ec={exports:{}},Va={},tc={exports:{}},nc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var qd;function E0(){return qd||(qd=1,(function(u){function s(k,q){var F=k.length;k.push(q);e:for(;0<F;){var ve=F-1>>>1,Te=k[ve];if(0<f(Te,q))k[ve]=q,k[F]=Te,F=ve;else break e}}function r(k){return k.length===0?null:k[0]}function c(k){if(k.length===0)return null;var q=k[0],F=k.pop();if(F!==q){k[0]=F;e:for(var ve=0,Te=k.length,S=Te>>>1;ve<S;){var U=2*(ve+1)-1,Q=k[U],X=U+1,te=k[X];if(0>f(Q,F))X<Te&&0>f(te,Q)?(k[ve]=te,k[X]=F,ve=X):(k[ve]=Q,k[U]=F,ve=U);else if(X<Te&&0>f(te,F))k[ve]=te,k[X]=F,ve=X;else break e}}return q}function f(k,q){var F=k.sortIndex-q.sortIndex;return F!==0?F:k.id-q.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;u.unstable_now=function(){return h.now()}}else{var p=Date,g=p.now();u.unstable_now=function(){return p.now()-g}}var b=[],m=[],E=1,A=null,z=3,M=!1,B=!1,L=!1,G=!1,V=typeof setTimeout=="function"?setTimeout:null,K=typeof clearTimeout=="function"?clearTimeout:null,H=typeof setImmediate<"u"?setImmediate:null;function W(k){for(var q=r(m);q!==null;){if(q.callback===null)c(m);else if(q.startTime<=k)c(m),q.sortIndex=q.expirationTime,s(b,q);else break;q=r(m)}}function ee(k){if(L=!1,W(k),!B)if(r(b)!==null)B=!0,se||(se=!0,et());else{var q=r(m);q!==null&&zt(ee,q.startTime-k)}}var se=!1,I=-1,ke=5,Ve=-1;function vt(){return G?!0:!(u.unstable_now()-Ve<ke)}function Lt(){if(G=!1,se){var k=u.unstable_now();Ve=k;var q=!0;try{e:{B=!1,L&&(L=!1,K(I),I=-1),M=!0;var F=z;try{t:{for(W(k),A=r(b);A!==null&&!(A.expirationTime>k&&vt());){var ve=A.callback;if(typeof ve=="function"){A.callback=null,z=A.priorityLevel;var Te=ve(A.expirationTime<=k);if(k=u.unstable_now(),typeof Te=="function"){A.callback=Te,W(k),q=!0;break t}A===r(b)&&c(b),W(k)}else c(b);A=r(b)}if(A!==null)q=!0;else{var S=r(m);S!==null&&zt(ee,S.startTime-k),q=!1}}break e}finally{A=null,z=F,M=!1}q=void 0}}finally{q?et():se=!1}}}var et;if(typeof H=="function")et=function(){H(Lt)};else if(typeof MessageChannel<"u"){var qn=new MessageChannel,Vt=qn.port2;qn.port1.onmessage=Lt,et=function(){Vt.postMessage(null)}}else et=function(){V(Lt,0)};function zt(k,q){I=V(function(){k(u.unstable_now())},q)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(k){k.callback=null},u.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ke=0<k?Math.floor(1e3/k):5},u.unstable_getCurrentPriorityLevel=function(){return z},u.unstable_next=function(k){switch(z){case 1:case 2:case 3:var q=3;break;default:q=z}var F=z;z=q;try{return k()}finally{z=F}},u.unstable_requestPaint=function(){G=!0},u.unstable_runWithPriority=function(k,q){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var F=z;z=k;try{return q()}finally{z=F}},u.unstable_scheduleCallback=function(k,q,F){var ve=u.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?ve+F:ve):F=ve,k){case 1:var Te=-1;break;case 2:Te=250;break;case 5:Te=1073741823;break;case 4:Te=1e4;break;default:Te=5e3}return Te=F+Te,k={id:E++,callback:q,priorityLevel:k,startTime:F,expirationTime:Te,sortIndex:-1},F>ve?(k.sortIndex=F,s(m,k),r(b)===null&&k===r(m)&&(L?(K(I),I=-1):L=!0,zt(ee,F-ve))):(k.sortIndex=Te,s(b,k),B||M||(B=!0,se||(se=!0,et()))),k},u.unstable_shouldYield=vt,u.unstable_wrapCallback=function(k){var q=z;return function(){var F=z;z=q;try{return k.apply(this,arguments)}finally{z=F}}}})(nc)),nc}var Qd;function A0(){return Qd||(Qd=1,tc.exports=E0()),tc.exports}var lc={exports:{}},Ie={};/**
 * @license React
 ...
 *
 * @license MIT
 */var Jd="popstate";function M0(u={}){function s(c,f){let{pathname:h,search:p,hash:g}=c.location;return oc("",{pathname:h,search:p,hash:g},f.state&&f.state.usr||null,f.state&&f.state.key||"default")}function r(c,f){return typeof f=="string"?f:Fa(f)}return O0(s,r,null,u)}function Ne(u,s){if(u===!1||u===null||typeof u>"u")throw new Error(s)}function Ut(u,s){if(!u){typeof console<"u"&&console.warn(s);try{throw new Error(s)}catch{}}}function z0(){return Math.random().toString(36).substring(2,10)}function Kd(u,s){return{usr:u.state,key:u.key,idx:s}}function oc(u,s,r=null,c){return{pathname:typeof u=="string"?u:u.pathname,search:"",hash:"",...typeof s=="string"?Jl(s):s,state:r,key:s&&s.key||c||z0()}}function Fa({pathname:u="/",search:s="",hash:r=""}){return s&&s!=="?"&&(u+=s.charAt(0)==="?"?s:"?"+s),r&&r!=="#"&&(u+=r.charAt(0)==="#"?r:"#"+r),u}function Jl(u){let s={};if(u){let r=u.indexOf("#");r>=0&&(s.hash=u.substring(r),u=u.substring(0,r));let c=u.indexOf("?");c>=0&&(s.search=u.substring(c),u=u.substring(0,c)),u&&(s.pathname=u)}return s}function O0(u,s,r,c={}){let{window:f=document.defaultView,v5Compat:h=!1}=c,p=f.history,g="POP",b=null,m=E();m==null&&(m=0,p.replaceState({...p.state,idx:m},""));function E(){return(p.state||{idx:null}).idx}function A(){g="POP";let G=E(),V=G==null?null:G-m;m=G,b&&b({action:g,location:L.location,delta:V})}function z(G,V){g="PUSH";let K=oc(L.location,G,V);m=E()+1;let H=Kd(K,m),W=L.createHref(K);try{p.pushState(H,"",W)}catch(ee){if(ee instanceof DOMException&&ee.name==="DataCloneError")throw ee;f.location.assign(W)}h&&b&&b({action:g,location:L.location,delta:1})}function M(G,V){g="REPLACE";let K=oc(L.location,G,V);m=E();let H=Kd(K,m),W=L.createHref(K);p.replaceState(H,"",W),h&&b&&b({action:g,location:L.location,delta:0})}function B(G){return k0(G)}let L={get action(){return g},get location(){return u(f,p)},listen(G){if(b)throw new Error("A history only accepts one active listener");return f.addEventListener(Jd,A),b=G,()=>{f.removeEventListener(Jd,A),b=null}},createHref(G){return s(f,G)},createURL:B,encodeLocation(G){let V=B(G);return{pathname:V.pathname,search:V.search,hash:V.hash}},push:z,replace:M,go(G){return p.go(G)}};return L}function k0(u,s=!1){let r="http://localhost";typeof window<"u"&&(r=window.location.origin!=="null"?window.location.origin:window.location.href),Ne(r,"No window.location.(origin|href) available to create URL");let c=typeof u=="string"?u:Fa(u);return c=c.replace(/ $/,"%20"),!s&&c.startsWith("//")&&(c=r+c),new URL(c,r)}function gm(u,s,r="/"){return w0(u,s,r,!1)}function w0(u,s,r,c){let f=typeof s=="string"?Jl(s):s,h=mn(f.pathname||"/",r);if(h==null)return null;let p=ym(u);j0(p);let g=null;for(let b=0;g==null&&b<p.length;++b){let m=Z0(h);g=V0(p[b],m,c)}return g}function ym(u,s=[],r=[],c="",f=!1){let h=(p,g,b=f,m)=>{let E={relativePath:m===void 0?p.path||"":m,caseSensitive:p.caseSensitive===!0,childrenIndex:g,route:p};if(E.relativePath.startsWith("/")){if(!E.relativePath.startsWith(c)&&b)return;Ne(E.relativePath.startsWith(c),`Absolute route path "${E.relativePath}" nested under path "${c}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),E.relativePath=E.relativePath.slice(c.length)}let A=dn([c,E.relativePath]),z=r.concat(E);p.children&&p.children.length>0&&(Ne(p.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${A}".`),ym(p.children,s,z,A,b)),!(p.path==null&&!p.index)&&s.push({path:A,score:Q0(A,p.index),routesMeta:z})};return u.forEach((p,g)=>{var b;if(p.path===""||!((b=p.path)!=null&&b.includes("?")))h(p,g);else for(let m of bm(p.path))h(p,g,!0,m)}),s}function bm(u){let s=u.split("/");if(s.length===0)return[];let[r,...c]=s,f=r.endsWith("?"),h=r.replace(/\?$/,"");if(c.length===0)return f?[h,""]:[h];let p=bm(c.join("/")),g=[];return g.push(...p.map(b=>b===""?h:[h,b].join("/"))),f&&g.push(...p),g.map(b=>u.startsWith("/")&&b===""?"/":b)}function j0(u){u.sort((s,r)=>s.score!==r.score?r.score-s.score:Y0(s.routesMeta.map(c=>c.childrenIndex),r.routesMeta.map(c=>c.childrenIndex)))}var H0=/^:[\w-]+$/,U0=3,L0=2,G0=1,B0=10,q0=-2,$d=u=>u==="*";function Q0(u,s){let r=u.split("/"),c=r.length;return r.some($d)&&(c+=q0),s&&(c+=L0),r.filter(f=>!$d(f)).reduce((f,h)=>f+(H0.test(h)?U0:h===""?G0:B0),c)}function Y0(u,s){return u.length===s.length&&u.slice(0,-1).every((c,f)=>c===s[f])?u[u.length-1]-s[s.length-1]:0}function V0(u,s,r=!1){let{routesMeta:c}=u,f={},h="/",p=[];for(let g=0;g<c.length;++g){let b=c[g],m=g===c.length-1,E=h==="/"?s:s.slice(h.length)||"/",A=_u({path:b.relativePath,caseSensitive:b.caseSensitive,end:m},E),z=b.route;if(!A&&m&&r&&!c[c.length-1].route.index&&(A=_u({path:b.relativePath,caseSensitive:b.caseSensitive,end:!1},E)),!A)return null;Object.assign(f,A.params),p.push({params:f,pathname:dn([h,A.pathname]),pathnameBase:I0(dn([h,A.pathnameBase])),route:z}),A.pathnameBase!=="/"&&(h=dn([h,A.pathnameBase]))}return p}function _u(u,s){typeof u=="string"&&(u={path:u,caseSensitive:!1,end:!0});let[r,c]=X0(u.path,u.caseSensitive,u.end),f=s.match(r);if(!f)return null;let h=f[0],p=h.replace(/(.)\/+$/,"$1"),g=f.slice(1);return{params:c.reduce((m,{paramName:E,isOptional:A},z)=>{if(E==="*"){let B=g[z]||"";p=h.slice(0,h.length-B.length).replace(/(.)\/+$/,"$1")}const M=g[z];return A&&!M?m[E]=void 0:m[E]=(M||"").replace(/%2F/g,"/"),m},{}),pathname:h,pathnameBase:p,pattern:u}}function X0(u,s=!1,r=!0){Ut(u==="*"||!u.endsWith("*")||u.endsWith("/*"),`Route path "${u}" will be treated as if it were "${u.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${u.replace(/\*$/,"/*")}".`);let c=[],f="^"+u.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(p,g,b)=>(c.push({paramName:g,isOptional:b!=null}),b?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return u.endsWith("*")?(c.push({paramName:"*"}),f+=u==="*"||u==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):r?f+="\\/*$":u!==""&&u!=="/"&&(f+="(?:(?=\\/|$))"),[new RegExp(f,s?void 0:"i"),c]}function Z0(u){try{return u.split("/").map(s=>decodeURIComponent(s).replace(/\//g,"%2F")).join("/")}catch(s){return Ut(!1,`The URL path "${u}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${s}).`),u}}function mn(u,s){if(s==="/")return u;if(!u.toLowerCase().startsWith(s.toLowerCase()))return null;let r=s.endsWith("/")?s.length-1:s.length,c=u.charAt(r);return c&&c!=="/"?null:u.slice(r)||"/"}var J0=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i;function K0(u,s="/"){let{pathname:r,search:c="",hash:f=""}=typeof u=="string"?Jl(u):u,h;return r?(r=r.replace(/\/\/+/g,"/"),r.startsWith("/")?h=Id(r.substring(1),"/"):h=Id(r,s)):h=s,{pathname:h,search:F0(c),hash:W0(f)}}function Id(u,s){let r=s.replace(/\/+$/,"").split("/");return u.split("/").forEach(f=>{f===".."?r.length>1&&r.pop():f!=="."&&r.push(f)}),r.length>1?r.join("/"):"/"}function ac(u,s,r,c){return`Cannot include a '${u}' character in a manually specified \`to.${s}\` field [${JSON.stringify(c)}].  Please separate it out to the \`to.${r}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function $0(u){return u.filter((s,r)=>r===0||s.route.path&&s.route.path.length>0)}function yc(u){let s=$0(u);return s.map((r,c)=>c===s.length-1?r.pathname:r.pathnameBase)}function bc(u,s,r,c=!1){let f;typeof u=="string"?f=Jl(u):(f={...u},Ne(!f.pathname||!f.pathname.includes("?"),ac("?","pathname","search",f)),Ne(!f.pathname||!f.pathname.includes("#"),ac("#","pathname","hash",f)),Ne(!f.search||!f.search.includes("#"),ac("#","search","hash",f)));let h=u===""||f.pathname==="",p=h?"/":f.pathname,g;if(p==null)g=r;else{let A=s.length-1;if(!c&&p.startsWith("..")){let z=p.split("/");for(;z[0]==="..";)z.shift(),A-=1;f.pathname=z.join("/")}g=A>=0?s[A]:"/"}let b=K0(f,g),m=p&&p!=="/"&&p.endsWith("/"),E=(h||p===".")&&r.endsWith("/");return!b.pathname.endsWith("/")&&(m||E)&&(b.pathname+="/"),b}var dn=u=>u.join("/").replace(/\/\/+/g,"/"),I0=u=>u.replace(/\/+$/,"").replace(/^\/*/,"/"),F0=u=>!u||u==="?"?"":u.startsWith("?")?u:"?"+u,W0=u=>!u||u==="#"?"":u.startsWith("#")?u:"#"+u,P0=class{constructor(u,s,r,c=!1){this.status=u,this.statusText=s||"",this.internal=c,r instanceof Error?(this.data=r.toString(),this.error=r):this.data=r}};function ey(u){return u!=null&&typeof u.status=="number"&&typeof u.statusText=="string"&&typeof u.internal=="boolean"&&"data"in u}function ty(u){return u.map(s=>s.route.path).filter(Boolean).join("/").replace(/\/\/*/g,"/")||"/"}var vm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function xm(u,s){let r=u;if(typeof r!="string"||!J0.test(r))return{absoluteURL:void 0,isExternal:!1,to:r};let c=r,f=!1;if(vm)try{let h=new URL(window.location.href),p=r.startsWith("//")?new URL(h.protocol+r):new URL(r),g=mn(p.pathname,s);p.origin===h.origin&&g!=null?r=g+p.search+p.hash:f=!0}catch{Ut(!1,`<Link to="${r}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}return{absoluteURL:c,isExternal:f,to:r}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");var Sm=["POST","PUT","PATCH","DELETE"];new Set(Sm);var ny=["GET",...Sm];new Set(ny);var Kl=D.createContext(null);Kl.displayName="DataRouter";var Mu=D.createContext(null);Mu.displayName="DataRouterState";var ly=D.createContext(!1),Em=D.createContext({isTransitioning:!1});Em.displayName="ViewTransition";var ay=D.createContext(new Map);ay.displayName="Fetchers";var iy=D.createContext(null);iy.displayName="Await";var bt=D.createContext(null);bt.displayName="Navigation";var Wa=D.createContext(null);Wa.displayName="Location";var Mt=D.createContext({outlet:null,matches:[],isDataRoute:!1});Mt.displayName="Route";var vc=D.createContext(null);vc.displayName="RouteError";var Am="REACT_ROUTER_ERROR",uy="REDIRECT",sy="ROUTE_ERROR_RESPONSE";function ry(u){if(u.startsWith(`${Am}:${uy}:{`))try{let s=JSON.parse(u.slice(28));if(typeof s=="object"&&s&&typeof s.status=="number"&&typeof s.statusText=="string"&&typeof s.location=="string"&&typeof s.reloadDocument=="boolean"&&typeof s.replace=="boolean")return s}catch{}}function cy(u){if(u.startsWith(`${Am}:${sy}:{`))try{let s=JSON.parse(u.slice(40));if(typeof s=="object"&&s&&typeof s.status=="number"&&typeof s.statusText=="string")return new P0(s.status,s.statusText,s.data)}catch{}}function oy(u,{relative:s}={}){Ne($l(),"useHref() may be used only in the context of a <Router> component.");let{basename:r,navigator:c}=D.useContext(bt),{hash:f,pathname:h,search:p}=Pa(u,{relative:s}),g=h;return r!=="/"&&(g=h==="/"?r:dn([r,h])),c.createHref({pathname:g,search:p,hash:f})}function $l(){return D.useContext(Wa)!=null}function pn(){return Ne($l(),"useLocation() may be used only in the context of a <Router> component."),D.useContext(Wa).location}var Tm="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function _m(u){D.useContext(bt).static||D.useLayoutEffect(u)}function Rm(){let{isDataRoute:u}=D.useContext(Mt);return u?Ry():fy()}function fy(){Ne($l(),"useNavigate() may be used only in the context of a <Router> component.");let u=D.useContext(Kl),{basename:s,navigator:r}=D.useContext(bt),{matches:c}=D.useContext(Mt),{pathname:f}=pn(),h=JSON.stringify(yc(c)),p=D.useRef(!1);return _m(()=>{p.current=!0}),D.useCallback((b,m={})=>{if(Ut(p.current,Tm),!p.current)return;if(typeof b=="number"){r.go(b);return}let E=bc(b,JSON.parse(h),f,m.relative==="path");u==null&&s!=="/"&&(E.pathname=E.pathname==="/"?s:dn([s,E.pathname])),(m.replace?r.replace:r.push)(E,m.state,m)},[s,r,h,f,u])}var hy=D.createContext(null);function dy(u){let s=D.useContext(Mt).outlet;return D.useMemo(()=>s&&D.createElement(hy.Provider,{value:u},s),[s,u])}function my(){let{matches:u}=D.useContext(Mt),s=u[u.length-1];return s?s.params:{}}function Pa(u,{relative:s}={}){let{matches:r}=D.useContext(Mt),{pathname:c}=pn(),f=JSON.stringify(yc(r));return D.useMemo(()=>bc(u,JSON.parse(f),c,s==="path"),[u,f,c,s])}function py(u,s){return Cm(u,s)}function Cm(u,s,r,c,f){var K;Ne($l(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:h}=D.useContext(bt),{matches:p}=D.useContext(Mt),g=p[p.length-1],b=g?g.params:{},m=g?g.pathname:"/",E=g?g.pathnameBase:"/",A=g&&g.route;{let H=A&&A.path||"";Nm(m,!A||H.endsWith("*")||H.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${m}" (under <Route path="${H}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${H}"> to <Route path="${H==="/"?"*":`${H}/*`}">.`)}let z=pn(),M;if(s){let H=typeof s=="string"?Jl(s):s;Ne(E==="/"||((K=H.pathname)==null?void 0:K.startsWith(E)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${E}" but pathname "${H.pathname}" was given in the \`location\` prop.`),M=H}else M=z;let B=M.pathname||"/",L=B;if(E!=="/"){let H=E.replace(/^\//,"").split("/");L="/"+B.replace(/^\//,"").split("/").slice(H.length).join("/")}let G=gm(u,{pathname:L});Ut(A||G!=null,`No routes matched location "${M.pathname}${M.search}${M.hash}" `),Ut(G==null||G[G.length-1].route.element!==void 0||G[G.length-1].route.Component!==void 0||G[G.length-1].route.lazy!==void 0,`Matched leaf route at location "${M.pathname}${M.search}${M.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let V=xy(G&&G.map(H=>Object.assign({},H,{params:Object.assign({},b,H.params),pathname:dn([E,h.encodeLocation?h.encodeLocation(H.pathname.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathname]),pathnameBase:H.pathnameBase==="/"?E:dn([E,h.encodeLocation?h.encodeLocation(H.pathnameBase.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathnameBase])})),p,r,c,f);return s&&V?D.createElement(Wa.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...M},navigationType:"POP"}},V):V}function gy(){let u=_y(),s=ey(u)?`${u.status} ${u.statusText}`:u instanceof Error?u.message:JSON.stringify(u),r=u instanceof Error?u.stack:null,c="rgba(200,200,200, 0.5)",f={padding:"0.5rem",backgroundColor:c},h={padding:"2px 4px",backgroundColor:c},p=null;return console.error("Error handled by React Router default ErrorBoundary:",u),p=D.createElement(D.Fragment,null,D.createElement("p",null,"💿 Hey developer 👋"),D.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",D.createElement("code",{style:h},"ErrorBoundary")," or"," ",D.createElement("code",{style:h},"errorElement")," prop on your route.")),D.createElement(D.Fragment,null,D.createElement("h2",null,"Unexpected Application Error!"),D.createElement("h3",{style:{fontStyle:"italic"}},s),r?D.createElement("pre",{style:f},r):null,p)}var yy=D.createElement(gy,null),Dm=class extends D.Component{constructor(u){super(u),this.state={location:u.location,revalidation:u.revalidation,error:u.error}}static getDerivedStateFromError(u){return{error:u}}static getDerivedStateFromProps(u,s){return s.location!==u.location||s.revalidation!=="idle"&&u.revalidation==="idle"?{error:u.error,location:u.location,revalidation:u.revalidation}:{error:u.error!==void 0?u.error:s.error,location:s.location,revalidation:u.revalidation||s.revalidation}}componentDidCatch(u,s){this.props.onError?this.props.onError(u,s):console.error("React Router caught the following error during render",u)}render(){let u=this.state.error;if(this.context&&typeof u=="object"&&u&&"digest"in u&&typeof u.digest=="string"){const r=cy(u.digest);r&&(u=r)}let s=u!==void 0?D.createElement(Mt.Provider,{value:this.props.routeContext},D.createElement(vc.Provider,{value:u,children:this.props.component})):this.props.children;return this.context?D.createElement(by,{error:u},s):s}};Dm.contextType=ly;var ic=new WeakMap;function by({children:u,error:s}){let{basename:r}=D.useContext(bt);if(typeof s=="object"&&s&&"digest"in s&&typeof s.digest=="string"){let c=ry(s.digest);if(c){let f=ic.get(s);if(f)throw f;let h=xm(c.location,r);if(vm&&!ic.get(s))if(h.isExternal||c.reloadDocument)window.location.href=h.absoluteURL||h.to;else{const p=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(h.to,{replace:c.replace}));throw ic.set(s,p),p}return D.createElement("meta",{httpEquiv:"refresh",content:`0;url=${h.absoluteURL||h.to}`})}}return u}function vy({routeContext:u,match:s,children:r}){let c=D.useContext(Kl);return c&&c.static&&c.staticContext&&(s.route.errorElement||s.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=s.route.id),D.createElement(Mt.Provider,{value:u},r)}function xy(u,s=[],r=null,c=null,f=null){if(u==null){if(!r)return null;if(r.errors)u=r.matches;else if(s.length===0&&!r.initialized&&r.matches.length>0)u=r.matches;else return null}let h=u,p=r==null?void 0:r.errors;if(p!=null){let E=h.findIndex(A=>A.route.id&&(p==null?void 0:p[A.route.id])!==void 0);Ne(E>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(p).join(",")}`),h=h.slice(0,Math.min(h.length,E+1))}let g=!1,b=-1;if(r)for(let E=0;E<h.length;E++){let A=h[E];if((A.route.HydrateFallback||A.route.hydrateFallbackElement)&&(b=E),A.route.id){let{loaderData:z,errors:M}=r,B=A.route.loader&&!z.hasOwnProperty(A.route.id)&&(!M||M[A.route.id]===void 0);if(A.route.lazy||B){g=!0,b>=0?h=h.slice(0,b+1):h=[h[0]];break}}}let m=r&&c?(E,A)=>{var z,M;c(E,{location:r.location,params:((M=(z=r.matches)==null?void 0:z[0])==null?void 0:M.params)??{},unstable_pattern:ty(r.matches),errorInfo:A})}:void 0;return h.reduceRight((E,A,z)=>{let M,B=!1,L=null,G=null;r&&(M=p&&A.route.id?p[A.route.id]:void 0,L=A.route.errorElement||yy,g&&(b<0&&z===0?(Nm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),B=!0,G=null):b===z&&(B=!0,G=A.route.hydrateFallbackElement||null)));let V=s.concat(h.slice(0,z+1)),K=()=>{let H;return M?H=L:B?H=G:A.route.Component?H=D.createElement(A.route.Component,null):A.route.element?H=A.route.element:H=E,D.createElement(vy,{match:A,routeContext:{outlet:E,matches:V,isDataRoute:r!=null},children:H})};return r&&(A.route.ErrorBoundary||A.route.errorElement||z===0)?D.createElement(Dm,{location:r.location,revalidation:r.revalidation,component:L,error:M,children:K(),routeContext:{outlet:null,matches:V,isDataRoute:!0},onError:m}):K()},null)}function xc(u){return`${u} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Sy(u){let s=D.useContext(Kl);return Ne(s,xc(u)),s}function Ey(u){let s=D.useContext(Mu);return Ne(s,xc(u)),s}function Ay(u){let s=D.useContext(Mt);return Ne(s,xc(u)),s}function Sc(u){let s=Ay(u),r=s.matches[s.matches.length-1];return Ne(r.route.id,`${u} can only be used on routes that contain a unique "id"`),r.route.id}function Ty(){return Sc("useRouteId")}function _y(){var c;let u=D.useContext(vc),s=Ey("useRouteError"),r=Sc("useRouteError");return u!==void 0?u:(c=s.errors)==null?void 0:c[r]}function Ry(){let{router:u}=Sy("useNavigate"),s=Sc("useNavigate"),r=D.useRef(!1);return _m(()=>{r.current=!0}),D.useCallback(async(f,h={})=>{Ut(r.current,Tm),r.current&&(typeof f=="number"?await u.navigate(f):await u.navigate(f,{fromRouteId:s,...h}))},[u,s])}var Fd={};function Nm(u,s,r){!s&&!Fd[u]&&(Fd[u]=!0,Ut(!1,r))}D.memo(Cy);function Cy({routes:u,future:s,state:r,onError:c}){return Cm(u,void 0,r,c,s)}function Dy({to:u,replace:s,state:r,relative:c}){Ne($l(),"<Navigate> may be used only in the context of a <Router> component.");let{static:f}=D.useContext(bt);Ut(!f,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:h}=D.useContext(Mt),{pathname:p}=pn(),g=Rm(),b=bc(u,yc(h),p,c==="path"),m=JSON.stringify(b);return D.useEffect(()=>{g(JSON.parse(m),{replace:s,state:r,relative:c})},[g,m,c,s,r]),null}function Ny(u){return dy(u.context)}function fn(u){Ne(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function My({basename:u="/",children:s=null,location:r,navigationType:c="POP",navigator:f,static:h=!1,unstable_useTransitions:p}){Ne(!$l(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let g=u.replace(/^\/*/,"/"),b=D.useMemo(()=>({basename:g,navigator:f,static:h,unstable_useTransitions:p,future:{}}),[g,f,h,p]);typeof r=="string"&&(r=Jl(r));let{pathname:m="/",search:E="",hash:A="",state:z=null,key:M="default"}=r,B=D.useMemo(()=>{let L=mn(m,g);return L==null?null:{location:{pathname:L,search:E,hash:A,state:z,key:M},navigationType:c}},[g,m,E,A,z,M,c]);return Ut(B!=null,`<Router basename="${g}"> is not able to match the URL "${m}${E}${A}" because it does not start with the basename, so the <Router> won't render anything.`),B==null?null:D.createElement(bt.Provider,{value:b},D.createElement(Wa.Provider,{children:s,value:B}))}function zy({children:u,location:s}){return py(fc(u),s)}function fc(u,s=[]){let r=[];return D.Children.forEach(u,(c,f)=>{if(!D.isValidElement(c))return;let h=[...s,f];if(c.type===D.Fragment){r.push.apply(r,fc(c.props.children,h));return}Ne(c.type===fn,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ne(!c.props.index||!c.props.children,"An index route cannot have child routes.");let p={id:c.props.id||h.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,middleware:c.props.middleware,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(p.children=fc(c.props.children,h)),r.push(p)}),r}var Eu="get",Au="application/x-www-form-urlencoded";function zu(u){return typeof HTMLElement<"u"&&u instanceof HTMLElement}function Oy(u){return zu(u)&&u.tagName.toLowerCase()==="button"}function ky(u){return zu(u)&&u.tagName.toLowerCase()==="form"}function wy(u){return zu(u)&&u.tagName.toLowerCase()==="input"}function jy(u){return!!(u.metaKey||u.altKey||u.ctrlKey||u.shiftKey)}function Hy(u,s){return u.button===0&&(!s||s==="_self")&&!jy(u)}var vu=null;function Uy(){if(vu===null)try{new FormData(document.createElement("form"),0),vu=!1}catch{vu=!0}return vu}var Ly=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function uc(u){return u!=null&&!Ly.has(u)?(Ut(!1,`"${u}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Au}"`),null):u}function Gy(u,s){let r,c,f,h,p;if(ky(u)){let g=u.getAttribute("action");c=g?mn(g,s):null,r=u.getAttribute("method")||Eu,f=uc(u.getAttribute("enctype"))||Au,h=new FormData(u)}else if(Oy(u)||wy(u)&&(u.type==="submit"||u.type==="image")){let g=u.form;if(g==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let b=u.getAttribute("formaction")||g.getAttribute("action");if(c=b?mn(b,s):null,r=u.getAttribute("formmethod")||g.getAttribute("method")||Eu,f=uc(u.getAttribute("formenctype"))||uc(g.getAttribute("enctype"))||Au,h=new FormData(g,u),!Uy()){let{name:m,type:E,value:A}=u;if(E==="image"){let z=m?`${m}.`:"";h.append(`${z}x`,"0"),h.append(`${z}y`,"0")}else m&&h.append(m,A)}}else{if(zu(u))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');r=Eu,c=null,f=Au,p=u}return h&&f==="text/plain"&&(p=h,h=void 0),{action:c,method:r.toLowerCase(),encType:f,formData:h,body:p}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Ec(u,s){if(u===!1||u===null||typeof u>"u")throw new Error(s)}function By(u,s,r,c){let f=typeof u=="string"?new URL(u,typeof window>"u"?"server://singlefetch/":window.location.origin):u;return r?f.pathname.endsWith("/")?f.pathname=`${f.pathname}_.${c}`:f.pathname=`${f.pathname}.${c}`:f.pathname==="/"?f.pathname=`_root.${c}`:s&&mn(f.pathname,s)==="/"?f.pathname=`${s.replace(/\/$/,"")}/_root.${c}`:f.pathname=`${f.pathname.replace(/\/$/,"")}.${c}`,f}async function qy(u,s){if(u.id in s)return s[u.id];try{let r=await import(u.module);return s[u.id]=r,r}catch(r){return console.error(`Error loading route module \`${u.module}\`, reloading page...`),console.error(r),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Qy(u){return u==null?!1:u.href==null?u.rel==="preload"&&typeof u.imageSrcSet=="string"&&typeof u.imageSizes=="string":typeof u.rel=="string"&&typeof u.href=="string"}async function Yy(u,s,r){let c=await Promise.all(u.map(async f=>{let h=s.routes[f.route.id];if(h){let p=await qy(h,r);return p.links?p.links():[]}return[]}));return Jy(c.flat(1).filter(Qy).filter(f=>f.rel==="stylesheet"||f.rel==="preload").map(f=>f.rel==="stylesheet"?{...f,rel:"prefetch",as:"style"}:{...f,rel:"prefetch"}))}function Wd(u,s,r,c,f,h){let p=(b,m)=>r[m]?b.route.id!==r[m].route.id:!0,g=(b,m)=>{var E;return r[m].pathname!==b.pathname||((E=r[m].route.path)==null?void 0:E.endsWith("*"))&&r[m].params["*"]!==b.params["*"]};return h==="assets"?s.filter((b,m)=>p(b,m)||g(b,m)):h==="data"?s.filter((b,m)=>{var A;let E=c.routes[b.route.id];if(!E||!E.hasLoader)return!1;if(p(b,m)||g(b,m))return!0;if(b.route.shouldRevalidate){let z=b.route.shouldRevalidate({currentUrl:new URL(f.pathname+f.search+f.hash,window.origin),currentParams:((A=r[0])==null?void 0:A.params)||{},nextUrl:new URL(u,window.origin),nextParams:b.params,defaultShouldRevalidate:!0});if(typeof z=="boolean")return z}return!0}):[]}function Vy(u,s,{includeHydrateFallback:r}={}){return Xy(u.map(c=>{let f=s.routes[c.route.id];if(!f)return[];let h=[f.module];return f.clientActionModule&&(h=h.concat(f.clientActionModule)),f.clientLoaderModule&&(h=h.concat(f.clientLoaderModule)),r&&f.hydrateFallbackModule&&(h=h.concat(f.hydrateFallbackModule)),f.imports&&(h=h.concat(f.imports)),h}).flat(1))}function Xy(u){return[...new Set(u)]}function Zy(u){let s={},r=Object.keys(u).sort();for(let c of r)s[c]=u[c];return s}function Jy(u,s){let r=new Set;return new Set(s),u.reduce((c,f)=>{let h=JSON.stringify(Zy(f));return r.has(h)||(r.add(h),c.push({key:h,link:f})),c},[])}function Mm(){let u=D.useContext(Kl);return Ec(u,"You must render this element inside a <DataRouterContext.Provider> element"),u}function Ky(){let u=D.useContext(Mu);return Ec(u,"You must render this element inside a <DataRouterStateContext.Provider> element"),u}var Ac=D.createContext(void 0);Ac.displayName="FrameworkContext";function zm(){let u=D.useContext(Ac);return Ec(u,"You must render this element inside a <HydratedRouter> element"),u}function $y(u,s){let r=D.useContext(Ac),[c,f]=D.useState(!1),[h,p]=D.useState(!1),{onFocus:g,onBlur:b,onMouseEnter:m,onMouseLeave:E,onTouchStart:A}=s,z=D.useRef(null);D.useEffect(()=>{if(u==="render"&&p(!0),u==="viewport"){let L=V=>{V.forEach(K=>{p(K.isIntersecting)})},G=new IntersectionObserver(L,{threshold:.5});return z.current&&G.observe(z.current),()=>{G.disconnect()}}},[u]),D.useEffect(()=>{if(c){let L=setTimeout(()=>{p(!0)},100);return()=>{clearTimeout(L)}}},[c]);let M=()=>{f(!0)},B=()=>{f(!1),p(!1)};return r?u!=="intent"?[h,z,{}]:[h,z,{onFocus:Xa(g,M),onBlur:Xa(b,B),onMouseEnter:Xa(m,M),onMouseLeave:Xa(E,B),onTouchStart:Xa(A,M)}]:[!1,z,{}]}function Xa(u,s){return r=>{u&&u(r),r.defaultPrevented||s(r)}}function Iy({page:u,...s}){let{router:r}=Mm(),c=D.useMemo(()=>gm(r.routes,u,r.basename),[r.routes,u,r.basename]);return c?D.createElement(Wy,{page:u,matches:c,...s}):null}function Fy(u){let{manifest:s,routeModules:r}=zm(),[c,f]=D.useState([]);return D.useEffect(()=>{let h=!1;return Yy(u,s,r).then(p=>{h||f(p)}),()=>{h=!0}},[u,s,r]),c}function Wy({page:u,matches:s,...r}){let c=pn(),{future:f,manifest:h,routeModules:p}=zm(),{basename:g}=Mm(),{loaderData:b,matches:m}=Ky(),E=D.useMemo(()=>Wd(u,s,m,h,c,"data"),[u,s,m,h,c]),A=D.useMemo(()=>Wd(u,s,m,h,c,"assets"),[u,s,m,h,c]),z=D.useMemo(()=>{if(u===c.pathname+c.search+c.hash)return[];let L=new Set,G=!1;if(s.forEach(K=>{var W;let H=h.routes[K.route.id];!H||!H.hasLoader||(!E.some(ee=>ee.route.id===K.route.id)&&K.route.id in b&&((W=p[K.route.id])!=null&&W.shouldRevalidate)||H.hasClientLoader?G=!0:L.add(K.route.id))}),L.size===0)return[];let V=By(u,g,f.unstable_trailingSlashAwareDataRequests,"data");return G&&L.size>0&&V.searchParams.set("_routes",s.filter(K=>L.has(K.route.id)).map(K=>K.route.id).join(",")),[V.pathname+V.search]},[g,f.unstable_trailingSlashAwareDataRequests,b,c,h,E,s,u,p]),M=D.useMemo(()=>Vy(A,h),[A,h]),B=Fy(A);return D.createElement(D.Fragment,null,z.map(L=>D.createElement("link",{key:L,rel:"prefetch",as:"fetch",href:L,...r})),M.map(L=>D.createElement("link",{key:L,rel:"modulepreload",href:L,...r})),B.map(({key:L,link:G})=>D.createElement("link",{key:L,nonce:r.nonce,...G,crossOrigin:G.crossOrigin??r.crossOrigin})))}function Py(...u){return s=>{u.forEach(r=>{typeof r=="function"?r(s):r!=null&&(r.current=s)})}}var eb=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{eb&&(window.__reactRouterVersion="7.13.0")}catch{}function tb({basename:u,children:s,unstable_useTransitions:r,window:c}){let f=D.useRef();f.current==null&&(f.current=M0({window:c,v5Compat:!0}));let h=f.current,[p,g]=D.useState({action:h.action,location:h.location}),b=D.useCallback(m=>{r===!1?g(m):D.startTransition(()=>g(m))},[r]);return D.useLayoutEffect(()=>h.listen(b),[h,b]),D.createElement(My,{basename:u,children:s,location:p.location,navigationType:p.action,navigator:h,unstable_useTransitions:r})}var Om=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Yt=D.forwardRef(function({onClick:s,discover:r="render",prefetch:c="none",relative:f,reloadDocument:h,replace:p,state:g,target:b,to:m,preventScrollReset:E,viewTransition:A,unstable_defaultShouldRevalidate:z,...M},B){let{basename:L,unstable_useTransitions:G}=D.useContext(bt),V=typeof m=="string"&&Om.test(m),K=xm(m,L);m=K.to;let H=oy(m,{relative:f}),[W,ee,se]=$y(c,M),I=ab(m,{replace:p,state:g,target:b,preventScrollReset:E,relative:f,viewTransition:A,unstable_defaultShouldRevalidate:z,unstable_useTransitions:G});function ke(vt){s&&s(vt),vt.defaultPrevented||I(vt)}let Ve=D.createElement("a",{...M,...se,href:K.absoluteURL||H,onClick:K.isExternal||h?s:ke,ref:Py(B,ee),target:b,"data-discover":!V&&r==="render"?"true":void 0});return W&&!V?D.createElement(D.Fragment,null,Ve,D.createElement(Iy,{page:H})):Ve});Yt.displayName="Link";var Tu=D.forwardRef(function({"aria-current":s="page",caseSensitive:r=!1,className:c="",end:f=!1,style:h,to:p,viewTransition:g,children:b,...m},E){let A=Pa(p,{relative:m.relative}),z=pn(),M=D.useContext(Mu),{navigator:B,basename:L}=D.useContext(bt),G=M!=null&&cb(A)&&g===!0,V=B.encodeLocation?B.encodeLocation(A).pathname:A.pathname,K=z.pathname,H=M&&M.navigation&&M.navigation.location?M.navigation.location.pathname:null;r||(K=K.toLowerCase(),H=H?H.toLowerCase():null,V=V.toLowerCase()),H&&L&&(H=mn(H,L)||H);const W=V!=="/"&&V.endsWith("/")?V.length-1:V.length;let ee=K===V||!f&&K.startsWith(V)&&K.charAt(W)==="/",se=H!=null&&(H===V||!f&&H.startsWith(V)&&H.charAt(V.length)==="/"),I={isActive:ee,isPending:se,isTransitioning:G},ke=ee?s:void 0,Ve;typeof c=="function"?Ve=c(I):Ve=[c,ee?"active":null,se?"pending":null,G?"transitioning":null].filter(Boolean).join(" ");let vt=typeof h=="function"?h(I):h;return D.createElement(Yt,{...m,"aria-current":ke,className:Ve,ref:E,style:vt,to:p,viewTransition:g},typeof b=="function"?b(I):b)});Tu.displayName="NavLink";var nb=D.forwardRef(({discover:u="render",fetcherKey:s,navigate:r,reloadDocument:c,replace:f,state:h,method:p=Eu,action:g,onSubmit:b,relative:m,preventScrollReset:E,viewTransition:A,unstable_defaultShouldRevalidate:z,...M},B)=>{let{unstable_useTransitions:L}=D.useContext(bt),G=sb(),V=rb(g,{relative:m}),K=p.toLowerCase()==="get"?"get":"post",H=typeof g=="string"&&Om.test(g),W=ee=>{if(b&&b(ee),ee.defaultPrevented)return;ee.preventDefault();let se=ee.nativeEvent.submitter,I=(se==null?void 0:se.getAttribute("formmethod"))||p,ke=()=>G(se||ee.currentTarget,{fetcherKey:s,method:I,navigate:r,replace:f,state:h,relative:m,preventScrollReset:E,viewTransition:A,unstable_defaultShouldRevalidate:z});L&&r!==!1?D.startTransition(()=>ke()):ke()};return D.createElement("form",{ref:B,method:K,action:V,onSubmit:c?b:W,...M,"data-discover":!H&&u==="render"?"true":void 0})});nb.displayName="Form";function lb(u){return`${u} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function km(u){let s=D.useContext(Kl);return Ne(s,lb(u)),s}function ab(u,{target:s,replace:r,state:c,preventScrollReset:f,relative:h,viewTransition:p,unstable_defaultShouldRevalidate:g,unstable_useTransitions:b}={}){let m=Rm(),E=pn(),A=Pa(u,{relative:h});return D.useCallback(z=>{if(Hy(z,s)){z.preventDefault();let M=r!==void 0?r:Fa(E)===Fa(A),B=()=>m(u,{replace:M,state:c,preventScrollReset:f,relative:h,viewTransition:p,unstable_defaultShouldRevalidate:g});b?D.startTransition(()=>B()):B()}},[E,m,A,r,c,s,u,f,h,p,g,b])}var ib=0,ub=()=>`__${String(++ib)}__`;function sb(){let{router:u}=km("useSubmit"),{basename:s}=D.useContext(bt),r=Ty(),c=u.fetch,f=u.navigate;return D.useCallback(async(h,p={})=>{let{action:g,method:b,encType:m,formData:E,body:A}=Gy(h,s);if(p.navigate===!1){let z=p.fetcherKey||ub();await c(z,r,p.action||g,{unstable_defaultShouldRevalidate:p.unstable_defaultShouldRevalidate,preventScrollReset:p.preventScrollReset,formData:E,body:A,formMethod:p.method||b,formEncType:p.encType||m,flushSync:p.flushSync})}else await f(p.action||g,{unstable_defaultShouldRevalidate:p.unstable_defaultShouldRevalidate,preventScrollReset:p.preventScrollReset,formData:E,body:A,formMethod:p.method||b,formEncType:p.encType||m,replace:p.replace,state:p.state,fromRouteId:r,flushSync:p.flushSync,viewTransition:p.viewTransition})},[c,f,s,r])}function rb(u,{relative:s}={}){let{basename:r}=D.useContext(bt),c=D.useContext(Mt);Ne(c,"useFormAction must be used inside a RouteContext");let[f]=c.matches.slice(-1),h={...Pa(u||".",{relative:s})},p=pn();if(u==null){h.search=p.search;let g=new URLSearchParams(h.search),b=g.getAll("index");if(b.some(E=>E==="")){g.delete("index"),b.filter(A=>A).forEach(A=>g.append("index",A));let E=g.toString();h.search=E?`?${E}`:""}}return(!u||u===".")&&f.route.index&&(h.search=h.search?h.search.replace(/^\?/,"?index&"):"?index"),r!=="/"&&(h.pathname=h.pathname==="/"?r:dn([r,h.pathname])),Fa(h)}function cb(u,{relative:s}={}){let r=D.useContext(Em);Ne(r!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=km("useViewTransitionState"),f=Pa(u,{relative:s});if(!r.isTransitioning)return!1;let h=mn(r.currentLocation.pathname,c)||r.currentLocation.pathname,p=mn(r.nextLocation.pathname,c)||r.nextLocation.pathname;return _u(f.pathname,p)!=null||_u(f.pathname,h)!=null}/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mb=D.forwardRef(({color:u="currentColor",size:s=24,strokeWidth:r=2,absoluteStrokeWidth:c,className:f="",children:h,iconNode:p,...g},b)=>D.createElement("svg",{ref:b,...db,width:s,height:s,stroke:u,strokeWidth:c?Number(r)*24/Number(s):r,className:wm("lucide",f),...!h&&!hb(g)&&{"aria-hidden":"true"},...g},[...p.map(([m,E])=>D.createElement(m,E)),...Array.isArray(h)?h:[h]]));/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oe=(u,s)=>{const r=D.forwardRef(({className:c,...f},h)=>D.createElement(mb,{ref:h,iconNode:s,className:wm(`lucide-${ob(Pd(u))}`,`lucide-${u}`,c),...f}));return r.displayName=Pd(u),r};/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Db=[["path",{d:"m16 18 6-6-6-6",key:"eg8j8"}],["path",{d:"m8 6-6 6 6 6",key:"ppft3o"}]],on=Oe("code",Db);/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
${m}`:m,f=f?`${f}
${E}`:E;let A=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(E,h,!0),this.lexer.state.top=A,r.length===0)break;let z=h.at(-1);if((z==null?void 0:z.type)==="code")break;if((z==null?void 0:z.type)==="blockquote"){let M=z,B=M.raw+`
`+r.join(`
`),L=this.blockquote(B);h[h.length-1]=L,c=c.substring(0,c.length-M.raw.length)+L.raw,f=f.substring(0,f.length-M.text.length)+L.text;break}else if((z==null?void 0:z.type)==="list"){let M=z,B=M.raw+`
`+r.join(`
`),L=this.list(B);h[h.length-1]=L,c=c.substring(0,c.length-z.raw.length)+L.raw,f=f.substring(0,f.length-M.raw.length)+L.raw,r=B.substring(h.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:c,tokens:h,text:f}}}list(u){var r,c;let s=this.rules.block.list.exec(u);if(s){let f=s[1].trim(),h=f.length>1,p={type:"list",raw:"",ordered:h,start:h?+f.slice(0,-1):"",loose:!1,items:[]};f=h?`\\d{1,9}\\${f.slice(-1)}`:`\\${f}`,this.options.pedantic&&(f=h?f:"[*+-]");let g=this.rules.other.listItemRegex(f),b=!1;for(;u;){let E=!1,A="",z="";if(!(s=g.exec(u))||this.rules.block.hr.test(u))break;A=s[0],u=u.substring(A.length);let M=s[2].split(`
`,1)[0].replace(this.rules.other.listReplaceTabs,V=>" ".repeat(3*V.length)),B=u.split(`
`,1)[0],L=!M.trim(),G=0;if(this.options.pedantic?(G=2,z=M.trimStart()):L?G=s[1].length+1:(G=s[2].search(this.rules.other.nonSpaceChar),G=G>4?1:G,z=M.slice(G),G+=s[1].length),L&&this.rules.other.blankLine.test(B)&&(A+=B+`
`,u=u.substring(B.length+1),E=!0),!E){let V=this.rules.other.nextBulletRegex(G),K=this.rules.other.hrRegex(G),H=this.rules.other.fencesBeginRegex(G),W=this.rules.other.headingBeginRegex(G),ee=this.rules.other.htmlBeginRegex(G);for(;u;){let se=u.split(`
`,1)[0],I;if(B=se,this.options.pedantic?(B=B.replace(this.rules.other.listReplaceNesting,"  "),I=B):I=B.replace(this.rules.other.tabCharGlobal,"    "),H.test(B)||W.test(B)||ee.test(B)||V.test(B)||K.test(B))break;if(I.search(this.rules.other.nonSpaceChar)>=G||!B.trim())z+=`
`+I.slice(G);else{if(L||M.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||H.test(M)||W.test(M)||K.test(M))break;z+=`
`+B}!L&&!B.trim()&&(L=!0),A+=se+`
`,u=u.substring(se.length+1),M=I.slice(G)}}p.loose||(b?p.loose=!0:this.rules.other.doubleBlankLine.test(A)&&(b=!0)),p.items.push({type:"list_item",raw:A,task:!!this.options.gfm&&this.rules.other.listIsTask.test(z),loose:!1,text:z,tokens:[]}),p.raw+=A}let m=p.items.at(-1);if(m)m.raw=m.raw.trimEnd(),m.text=m.text.trimEnd();else return;p.raw=p.raw.trimEnd();for(let E of p.items){if(this.lexer.state.top=!1,E.tokens=this.lexer.blockTokens(E.text,[]),E.task){if(E.text=E.text.replace(this.rules.other.listReplaceTask,""),((r=E.tokens[0])==null?void 0:r.type)==="text"||((c=E.tokens[0])==null?void 0:c.type)==="paragraph"){E.tokens[0].raw=E.tokens[0].raw.replace(this.rules.other.listReplaceTask,""),E.tokens[0].text=E.tokens[0].text.replace(this.rules.other.listReplaceTask,"");for(let z=this.lexer.inlineQueue.length-1;z>=0;z--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[z].src)){this.lexer.inlineQueue[z].src=this.lexer.inlineQueue[z].src.replace(this.rules.other.listReplaceTask,"");break}}let A=this.rules.other.listTaskCheckbox.exec(E.raw);if(A){let z={type:"checkbox",raw:A[0]+" ",checked:A[0]!=="[ ]"};E.checked=z.checked,p.loose?E.tokens[0]&&["paragraph","text"].includes(E.tokens[0].type)&&"tokens"in E.tokens[0]&&E.tokens[0].tokens?(E.tokens[0].raw=z.raw+E.tokens[0].raw,E.tokens[0].text=z.raw+E.tokens[0].text,E.tokens[0].tokens.unshift(z)):E.tokens.unshift({type:"paragraph",raw:z.raw,text:z.raw,tokens:[z]}):E.tokens.unshift(z)}}if(!p.loose){let A=E.tokens.filter(M=>M.type==="space"),z=A.length>0&&A.some(M=>this.rules.other.anyLine.test(M.raw));p.loose=z}}if(p.loose)for(let E of p.items){E.loose=!0;for(let A of E.tokens)A.type==="text"&&(A.type="paragraph")}return p}}html(u){let s=this.rules.block.html.exec(u);if(s)return{type:"html",block:!0,raw:s[0],pre:s[1]==="pre"||s[1]==="script"||s[1]==="style",text:s[0]}}def(u){let s=this.rules.block.def.exec(u);if(s){let r=s[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),c=s[2]?s[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",f=s[3]?s[3].substring(1,s[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):s[3];return{type:"def",tag:r,raw:s[0],href:c,title:f}}}table(u){var p;let s=this.rules.block.table.exec(u);if(!s||!this.rules.other.tableDelimiter.test(s[2]))return;let r=om(s[1]),c=s[2].replace(this.rules.other.tableAlignChars,"").split("|"),f=(p=s[3])!=null&&p.trim()?s[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
`)?"":`
`)+g.raw,m.text+=`
`+g.raw,this.inlineQueue.at(-1).src=m.text):this.tokens.links[g.tag]||(this.tokens.links[g.tag]={href:g.href,title:g.title},r.push(g));continue}if(g=this.tokenizer.table(s)){s=s.substring(g.raw.length),r.push(g);continue}if(g=this.tokenizer.lheading(s)){s=s.substring(g.raw.length),r.push(g);continue}let b=s;if((p=this.options.extensions)!=null&&p.startBlock){let m=1/0,E=s.slice(1),A;this.options.extensions.startBlock.forEach(z=>{A=z.call({lexer:this},E),typeof A=="number"&&A>=0&&(m=Math.min(m,A))}),m<1/0&&m>=0&&(b=s.substring(0,m+1))}if(this.state.top&&(g=this.tokenizer.paragraph(b))){let m=r.at(-1);c&&(m==null?void 0:m.type)==="paragraph"?(m.raw+=(m.raw.endsWith(`
`)?"":`
`)+g.raw,m.text+=`
...
`)?"":`
`)+g.raw,m.text+=`
`+g.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=m.text):r.push(g);continue}if(s){let m="Infinite loop on byte: "+s.charCodeAt(0);if(this.options.silent){console.error(m);break}else throw new Error(m)}}return this.state.top=!0,r}inline(s,r=[]){return this.inlineQueue.push({src:s,tokens:r}),r}inlineTokens(s,r=[]){var b,m,E,A,z;let c=s,f=null;if(this.tokens.links){let M=Object.keys(this.tokens.links);if(M.length>0)for(;(f=this.tokenizer.rules.inline.reflinkSearch.exec(c))!=null;)M.includes(f[0].slice(f[0].lastIndexOf("[")+1,-1))&&(c=c.slice(0,f.index)+"["+"a".repeat(f[0].length-2)+"]"+c.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(f=this.tokenizer.rules.inline.anyPunctuation.exec(c))!=null;)c=c.slice(0,f.index)+"++"+c.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let h;for(;(f=this.tokenizer.rules.inline.blockSkip.exec(c))!=null;)h=f[2]?f[2].length:0,c=c.slice(0,f.index+h)+"["+"a".repeat(f[0].length-h-2)+"]"+c.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);c=((m=(b=this.options.hooks)==null?void 0:b.emStrongMask)==null?void 0:m.call({lexer:this},c))??c;let p=!1,g="";for(;s;){p||(g=""),p=!1;let M;if((A=(E=this.options.extensions)==null?void 0:E.inline)!=null&&A.some(L=>(M=L.call({lexer:this},s,r))?(s=s.substring(M.raw.length),r.push(M),!0):!1))continue;if(M=this.tokenizer.escape(s)){s=s.substring(M.raw.length),r.push(M);continue}if(M=this.tokenizer.tag(s)){s=s.substring(M.raw.length),r.push(M);continue}if(M=this.tokenizer.link(s)){s=s.substring(M.raw.length),r.push(M);continue}if(M=this.tokenizer.reflink(s,this.tokens.links)){s=s.substring(M.raw.length);let L=r.at(-1);M.type==="text"&&(L==null?void 0:L.type)==="text"?(L.raw+=M.raw,L.text+=M.text):r.push(M);continue}if(M=this.tokenizer.emStrong(s,c,g)){s=s.substring(M.raw.length),r.push(M);continue}if(M=this.tokenizer.codespan(s)){s=s.substring(M.raw.length),r.push(M);continue}if(M=this.tokenizer.br(s)){s=s.substring(M.raw.length),r.push(M);continue}if(M=this.tokenizer.del(s)){s=s.substring(M.raw.length),r.push(M);continue}if(M=this.tokenizer.autolink(s)){s=s.substring(M.raw.length),r.push(M);continue}if(!this.state.inLink&&(M=this.tokenizer.url(s))){s=s.substring(M.raw.length),r.push(M);continue}let B=s;if((z=this.options.extensions)!=null&&z.startInline){let L=1/0,G=s.slice(1),V;this.options.extensions.startInline.forEach(K=>{V=K.call({lexer:this},G),typeof V=="number"&&V>=0&&(L=Math.min(L,V))}),L<1/0&&L>=0&&(B=s.substring(0,L+1))}if(M=this.tokenizer.inlineText(B)){s=s.substring(M.raw.length),M.raw.slice(-1)!=="_"&&(g=M.raw.slice(-1)),p=!0;let L=r.at(-1);(L==null?void 0:L.type)==="text"?(L.raw+=M.raw,L.text+=M.text):r.push(M);continue}if(s){let L="Infinite loop on byte: "+s.charCodeAt(0);if(this.options.silent){console.error(L);break}else throw new Error(L)}}return r}},Nu=class{constructor(u){Ae(this,"options");Ae(this,"parser");this.options=u||rl}space(u){return""}code({text:u,lang:s,escaped:r}){var h;let c=(h=(s||"").match(Pe.notSpaceStart))==null?void 0:h[0],f=u.replace(Pe.endingNewline,"")+`
