 ...
 */var Gd;function b0(){if(Gd)return Ya;Gd=1;var u=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function s(c,f,h){var p=null;if(h!==void 0&&(p=""+h),f.key!==void 0&&(p=""+f.key),"key"in f){h={};for(var g in f)g!=="key"&&(h[g]=f[g])}else h=f;return f=h.ref,{$$typeof:u,type:c,key:p,ref:f!==void 0?f:null,props:h}}return Ya.Fragment=r,Ya.jsx=s,Ya.jsxs=s,Ya}var Ud;function v0(){return Ud||(Ud=1,Ps.exports=b0()),Ps.exports}var y=v0(),Fs={exports:{}},F={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ld;function x0(){if(Ld)return F;Ld=1;var u=Symbol.for("react.transitional.element"),r=Symbol.for("react.portal"),s=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),h=Symbol.for("react.consumer"),p=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),T=Symbol.for("react.activity"),O=Symbol.iterator;function D(S){return S===null||typeof S!="object"?null:(S=O&&S[O]||S["@@iterator"],typeof S=="function"?S:null)}var B={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},U=Object.assign,L={};function V(S,G,Q){this.props=S,this.context=G,this.refs=L,this.updater=Q||B}V.prototype.isReactComponent={},V.prototype.setState=function(S,G){if(typeof S!="object"&&typeof S!="function"&&S!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,S,G,"setState")},V.prototype.forceUpdate=function(S){this.updater.enqueueForceUpdate(this,S,"forceUpdate")};function K(){}K.prototype=V.prototype;function H(S,G,Q){this.props=S,this.context=G,this.refs=L,this.updater=Q||B}var P=H.prototype=new K;P.constructor=H,U(P,V.prototype),P.isPureReactComponent=!0;var ee=Array.isArray;function re(){}var I={H:null,A:null,T:null,S:null},we=Object.prototype.hasOwnProperty;function Ve(S,G,Q){var X=Q.ref;return{$$typeof:u,type:S,key:G,ref:X!==void 0?X:null,props:Q}}function vt(S,G){return Ve(S.type,G,S.props)}function Ut(S){return typeof S=="object"&&S!==null&&S.$$typeof===u}function et(S){var G={"=":"=0",":":"=2"};return"$"+S.replace(/[=:]/g,function(Q){return G[Q]})}var qn=/\/+/g;function Vt(S,G){return typeof S=="object"&&S!==null&&S.key!=null?et(""+S.key):G.toString(36)}function Ot(S){switch(S.status){case"fulfilled":return S.value;case"rejected":throw S.reason;default:switch(typeof S.status=="string"?S.then(re,re):(S.status="pending",S.then(function(G){S.status==="pending"&&(S.status="fulfilled",S.value=G)},function(G){S.status==="pending"&&(S.status="rejected",S.reason=G)})),S.status){case"fulfilled":return S.value;case"rejected":throw S.reason}}throw S}function w(S,G,Q,X,te){var ae=typeof S;(ae==="undefined"||ae==="boolean")&&(S=null);var pe=!1;if(S===null)pe=!0;else switch(ae){case"bigint":case"string":case"number":pe=!0;break;case"object":switch(S.$$typeof){case u:case r:pe=!0;break;case E:return pe=S._init,w(pe(S._payload),G,Q,X,te)}}if(pe)return te=te(S),pe=X===""?"."+Vt(S,0):X,ee(te)?(Q="",pe!=null&&(Q=pe.replace(qn,"$&/")+"/"),w(te,G,Q,"",function(Il){return Il})):te!=null&&(Ut(te)&&(te=vt(te,Q+(te.key==null||S&&S.key===te.key?"":(""+te.key).replace(qn,"$&/")+"/")+pe)),G.push(te)),1;pe=0;var We=X===""?".":X+":";if(ee(S))for(var ke=0;ke<S.length;ke++)X=S[ke],ae=We+Vt(X,ke),pe+=w(X,G,Q,ae,te);else if(ke=D(S),typeof ke=="function")for(S=ke.call(S),ke=0;!(X=S.next()).done;)X=X.value,ae=We+Vt(X,ke++),pe+=w(X,G,Q,ae,te);else if(ae==="object"){if(typeof S.then=="function")return w(Ot(S),G,Q,X,te);throw G=String(S),Error("Objects are not valid as a React child (found: "+(G==="[object Object]"?"object with keys {"+Object.keys(S).join(", ")+"}":G)+"). If you meant to render a collection of children, use an array instead.")}return pe}function q(S,G,Q){if(S==null)return S;var X=[],te=0;return w(S,X,"","",function(ae){return G.call(Q,ae,te++)}),X}function W(S){if(S._status===-1){var G=S._result;G=G(),G.then(function(Q){(S._status===0||S._status===-1)&&(S._status=1,S._result=Q)},function(Q){(S._status===0||S._status===-1)&&(S._status=2,S._result=Q)}),S._status===-1&&(S._status=0,S._result=G)}if(S._status===1)return S._result.default;throw S._result}var ve=typeof reportError=="function"?reportError:function(S){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var G=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof S=="object"&&S!==null&&typeof S.message=="string"?String(S.message):String(S),error:S});if(!window.dispatchEvent(G))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",S);return}console.error(S)},Ae={map:q,forEach:function(S,G,Q){q(S,function(){G.apply(this,arguments)},Q)},count:function(S){var G=0;return q(S,function(){G++}),G},toArray:function(S){return q(S,function(G){return G})||[]},only:function(S){if(!Ut(S))throw Error("React.Children.only expected to receive a single React element child.");return S}};return F.Activity=T,F.Children=Ae,F.Component=V,F.Fragment=s,F.Profiler=f,F.PureComponent=H,F.StrictMode=c,F.Suspense=b,F.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=I,F.__COMPILER_RUNTIME={__proto__:null,c:function(S){return I.H.useMemoCache(S)}},F.cache=function(S){return function(){return S.apply(null,arguments)}},F.cacheSignal=function(){return null},F.cloneElement=function(S,G,Q){if(S==null)throw Error("The argument must be a React element, but you passed "+S+".");var X=U({},S.props),te=S.key;if(G!=null)for(ae in G.key!==void 0&&(te=""+G.key),G)!we.call(G,ae)||ae==="key"||ae==="__self"||ae==="__source"||ae==="ref"&&G.ref===void 0||(X[ae]=G[ae]);var ae=arguments.length-2;if(ae===1)X.children=Q;else if(1<ae){for(var pe=Array(ae),We=0;We<ae;We++)pe[We]=arguments[We+2];X.children=pe}return Ve(S.type,te,X)},F.createContext=function(S){return S={$$typeof:p,_currentValue:S,_currentValue2:S,_threadCount:0,Provider:null,Consumer:null},S.Provider=S,S.Consumer={$$typeof:h,_context:S},S},F.createElement=function(S,G,Q){var X,te={},ae=null;if(G!=null)for(X in G.key!==void 0&&(ae=""+G.key),G)we.call(G,X)&&X!=="key"&&X!=="__self"&&X!=="__source"&&(te[X]=G[X]);var pe=arguments.length-2;if(pe===1)te.children=Q;else if(1<pe){for(var We=Array(pe),ke=0;ke<pe;ke++)We[ke]=arguments[ke+2];te.children=We}if(S&&S.defaultProps)for(X in pe=S.defaultProps,pe)te[X]===void 0&&(te[X]=pe[X]);return Ve(S,ae,te)},F.createRef=function(){return{current:null}},F.forwardRef=function(S){return{$$typeof:g,render:S}},F.isValidElement=Ut,F.lazy=function(S){return{$$typeof:E,_payload:{_status:-1,_result:S},_init:W}},F.memo=function(S,G){return{$$typeof:m,type:S,compare:G===void 0?null:G}},F.startTransition=function(S){var G=I.T,Q={};I.T=Q;try{var X=S(),te=I.S;te!==null&&te(Q,X),typeof X=="object"&&X!==null&&typeof X.then=="function"&&X.then(re,ve)}catch(ae){ve(ae)}finally{G!==null&&Q.types!==null&&(G.types=Q.types),I.T=G}},F.unstable_useCacheRefresh=function(){return I.H.useCacheRefresh()},F.use=function(S){return I.H.use(S)},F.useActionState=function(S,G,Q){return I.H.useActionState(S,G,Q)},F.useCallback=function(S,G){return I.H.useCallback(S,G)},F.useContext=function(S){return I.H.useContext(S)},F.useDebugValue=function(){},F.useDeferredValue=function(S,G){return I.H.useDeferredValue(S,G)},F.useEffect=function(S,G){return I.H.useEffect(S,G)},F.useEffectEvent=function(S){return I.H.useEffectEvent(S)},F.useId=function(){return I.H.useId()},F.useImperativeHandle=function(S,G,Q){return I.H.useImperativeHandle(S,G,Q)},F.useInsertionEffect=function(S,G){return I.H.useInsertionEffect(S,G)},F.useLayoutEffect=function(S,G){return I.H.useLayoutEffect(S,G)},F.useMemo=function(S,G){return I.H.useMemo(S,G)},F.useOptimistic=function(S,G){return I.H.useOptimistic(S,G)},F.useReducer=function(S,G,Q){return I.H.useReducer(S,G,Q)},F.useRef=function(S){return I.H.useRef(S)},F.useState=function(S){return I.H.useState(S)},F.useSyncExternalStore=function(S,G,Q){return I.H.useSyncExternalStore(S,G,Q)},F.useTransition=function(){return I.H.useTransition()},F.version="19.2.3",F}var Bd;function gc(){return Bd||(Bd=1,Fs.exports=x0()),Fs.exports}var M=gc();const S0=pm(M);var ec={exports:{}},Va={},tc={exports:{}},nc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var qd;function E0(){return qd||(qd=1,(function(u){function r(w,q){var W=w.length;w.push(q);e:for(;0<W;){var ve=W-1>>>1,Ae=w[ve];if(0<f(Ae,q))w[ve]=q,w[W]=Ae,W=ve;else break e}}function s(w){return w.length===0?null:w[0]}function c(w){if(w.length===0)return null;var q=w[0],W=w.pop();if(W!==q){w[0]=W;e:for(var ve=0,Ae=w.length,S=Ae>>>1;ve<S;){var G=2*(ve+1)-1,Q=w[G],X=G+1,te=w[X];if(0>f(Q,W))X<Ae&&0>f(te,Q)?(w[ve]=te,w[X]=W,ve=X):(w[ve]=Q,w[G]=W,ve=G);else if(X<Ae&&0>f(te,W))w[ve]=te,w[X]=W,ve=X;else break e}}return q}function f(w,q){var W=w.sortIndex-q.sortIndex;return W!==0?W:w.id-q.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var h=performance;u.unstable_now=function(){return h.now()}}else{var p=Date,g=p.now();u.unstable_now=function(){return p.now()-g}}var b=[],m=[],E=1,T=null,O=3,D=!1,B=!1,U=!1,L=!1,V=typeof setTimeout=="function"?setTimeout:null,K=typeof clearTimeout=="function"?clearTimeout:null,H=typeof setImmediate<"u"?setImmediate:null;function P(w){for(var q=s(m);q!==null;){if(q.callback===null)c(m);else if(q.startTime<=w)c(m),q.sortIndex=q.expirationTime,r(b,q);else break;q=s(m)}}function ee(w){if(U=!1,P(w),!B)if(s(b)!==null)B=!0,re||(re=!0,et());else{var q=s(m);q!==null&&Ot(ee,q.startTime-w)}}var re=!1,I=-1,we=5,Ve=-1;function vt(){return L?!0:!(u.unstable_now()-Ve<we)}function Ut(){if(L=!1,re){var w=u.unstable_now();Ve=w;var q=!0;try{e:{B=!1,U&&(U=!1,K(I),I=-1),D=!0;var W=O;try{t:{for(P(w),T=s(b);T!==null&&!(T.expirationTime>w&&vt());){var ve=T.callback;if(typeof ve=="function"){T.callback=null,O=T.priorityLevel;var Ae=ve(T.expirationTime<=w);if(w=u.unstable_now(),typeof Ae=="function"){T.callback=Ae,P(w),q=!0;break t}T===s(b)&&c(b),P(w)}else c(b);T=s(b)}if(T!==null)q=!0;else{var S=s(m);S!==null&&Ot(ee,S.startTime-w),q=!1}}break e}finally{T=null,O=W,D=!1}q=void 0}}finally{q?et():re=!1}}}var et;if(typeof H=="function")et=function(){H(Ut)};else if(typeof MessageChannel<"u"){var qn=new MessageChannel,Vt=qn.port2;qn.port1.onmessage=Ut,et=function(){Vt.postMessage(null)}}else et=function(){V(Ut,0)};function Ot(w,q){I=V(function(){w(u.unstable_now())},q)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(w){w.callback=null},u.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):we=0<w?Math.floor(1e3/w):5},u.unstable_getCurrentPriorityLevel=function(){return O},u.unstable_next=function(w){switch(O){case 1:case 2:case 3:var q=3;break;default:q=O}var W=O;O=q;try{return w()}finally{O=W}},u.unstable_requestPaint=function(){L=!0},u.unstable_runWithPriority=function(w,q){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var W=O;O=w;try{return q()}finally{O=W}},u.unstable_scheduleCallback=function(w,q,W){var ve=u.unstable_now();switch(typeof W=="object"&&W!==null?(W=W.delay,W=typeof W=="number"&&0<W?ve+W:ve):W=ve,w){case 1:var Ae=-1;break;case 2:Ae=250;break;case 5:Ae=1073741823;break;case 4:Ae=1e4;break;default:Ae=5e3}return Ae=W+Ae,w={id:E++,callback:q,priorityLevel:w,startTime:W,expirationTime:Ae,sortIndex:-1},W>ve?(w.sortIndex=W,r(m,w),s(b)===null&&w===s(m)&&(U?(K(I),I=-1):U=!0,Ot(ee,W-ve))):(w.sortIndex=Ae,r(b,w),B||D||(B=!0,re||(re=!0,et()))),w},u.unstable_shouldYield=vt,u.unstable_wrapCallback=function(w){var q=O;return function(){var W=O;O=q;try{return w.apply(this,arguments)}finally{O=W}}}})(nc)),nc}var Qd;function T0(){return Qd||(Qd=1,tc.exports=E0()),tc.exports}var lc={exports:{}},Ie={};/**
 * @license React
 ...
 *
 * @license MIT
 */var Jd="popstate";function D0(u={}){function r(c,f){let{pathname:h,search:p,hash:g}=c.location;return oc("",{pathname:h,search:p,hash:g},f.state&&f.state.usr||null,f.state&&f.state.key||"default")}function s(c,f){return typeof f=="string"?f:Wa(f)}return z0(r,s,null,u)}function Ne(u,r){if(u===!1||u===null||typeof u>"u")throw new Error(r)}function Gt(u,r){if(!u){typeof console<"u"&&console.warn(r);try{throw new Error(r)}catch{}}}function O0(){return Math.random().toString(36).substring(2,10)}function Kd(u,r){return{usr:u.state,key:u.key,idx:r}}function oc(u,r,s=null,c){return{pathname:typeof u=="string"?u:u.pathname,search:"",hash:"",...typeof r=="string"?Jl(r):r,state:s,key:r&&r.key||c||O0()}}function Wa({pathname:u="/",search:r="",hash:s=""}){return r&&r!=="?"&&(u+=r.charAt(0)==="?"?r:"?"+r),s&&s!=="#"&&(u+=s.charAt(0)==="#"?s:"#"+s),u}function Jl(u){let r={};if(u){let s=u.indexOf("#");s>=0&&(r.hash=u.substring(s),u=u.substring(0,s));let c=u.indexOf("?");c>=0&&(r.search=u.substring(c),u=u.substring(0,c)),u&&(r.pathname=u)}return r}function z0(u,r,s,c={}){let{window:f=document.defaultView,v5Compat:h=!1}=c,p=f.history,g="POP",b=null,m=E();m==null&&(m=0,p.replaceState({...p.state,idx:m},""));function E(){return(p.state||{idx:null}).idx}function T(){g="POP";let L=E(),V=L==null?null:L-m;m=L,b&&b({action:g,location:U.location,delta:V})}function O(L,V){g="PUSH";let K=oc(U.location,L,V);m=E()+1;let H=Kd(K,m),P=U.createHref(K);try{p.pushState(H,"",P)}catch(ee){if(ee instanceof DOMException&&ee.name==="DataCloneError")throw ee;f.location.assign(P)}h&&b&&b({action:g,location:U.location,delta:1})}function D(L,V){g="REPLACE";let K=oc(U.location,L,V);m=E();let H=Kd(K,m),P=U.createHref(K);p.replaceState(H,"",P),h&&b&&b({action:g,location:U.location,delta:0})}function B(L){return w0(L)}let U={get action(){return g},get location(){return u(f,p)},listen(L){if(b)throw new Error("A history only accepts one active listener");return f.addEventListener(Jd,T),b=L,()=>{f.removeEventListener(Jd,T),b=null}},createHref(L){return r(f,L)},createURL:B,encodeLocation(L){let V=B(L);return{pathname:V.pathname,search:V.search,hash:V.hash}},push:O,replace:D,go(L){return p.go(L)}};return U}function w0(u,r=!1){let s="http://localhost";typeof window<"u"&&(s=window.location.origin!=="null"?window.location.origin:window.location.href),Ne(s,"No window.location.(origin|href) available to create URL");let c=typeof u=="string"?u:Wa(u);return c=c.replace(/ $/,"%20"),!r&&c.startsWith("//")&&(c=s+c),new URL(c,s)}function gm(u,r,s="/"){return k0(u,r,s,!1)}function k0(u,r,s,c){let f=typeof r=="string"?Jl(r):r,h=mn(f.pathname||"/",s);if(h==null)return null;let p=ym(u);j0(p);let g=null;for(let b=0;g==null&&b<p.length;++b){let m=Z0(h);g=V0(p[b],m,c)}return g}function ym(u,r=[],s=[],c="",f=!1){let h=(p,g,b=f,m)=>{let E={relativePath:m===void 0?p.path||"":m,caseSensitive:p.caseSensitive===!0,childrenIndex:g,route:p};if(E.relativePath.startsWith("/")){if(!E.relativePath.startsWith(c)&&b)return;Ne(E.relativePath.startsWith(c),`Absolute route path "${E.relativePath}" nested under path "${c}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),E.relativePath=E.relativePath.slice(c.length)}let T=dn([c,E.relativePath]),O=s.concat(E);p.children&&p.children.length>0&&(Ne(p.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${T}".`),ym(p.children,r,O,T,b)),!(p.path==null&&!p.index)&&r.push({path:T,score:Q0(T,p.index),routesMeta:O})};return u.forEach((p,g)=>{var b;if(p.path===""||!((b=p.path)!=null&&b.includes("?")))h(p,g);else for(let m of bm(p.path))h(p,g,!0,m)}),r}function bm(u){let r=u.split("/");if(r.length===0)return[];let[s,...c]=r,f=s.endsWith("?"),h=s.replace(/\?$/,"");if(c.length===0)return f?[h,""]:[h];let p=bm(c.join("/")),g=[];return g.push(...p.map(b=>b===""?h:[h,b].join("/"))),f&&g.push(...p),g.map(b=>u.startsWith("/")&&b===""?"/":b)}function j0(u){u.sort((r,s)=>r.score!==s.score?s.score-r.score:Y0(r.routesMeta.map(c=>c.childrenIndex),s.routesMeta.map(c=>c.childrenIndex)))}var H0=/^:[\w-]+$/,G0=3,U0=2,L0=1,B0=10,q0=-2,$d=u=>u==="*";function Q0(u,r){let s=u.split("/"),c=s.length;return s.some($d)&&(c+=q0),r&&(c+=U0),s.filter(f=>!$d(f)).reduce((f,h)=>f+(H0.test(h)?G0:h===""?L0:B0),c)}function Y0(u,r){return u.length===r.length&&u.slice(0,-1).every((c,f)=>c===r[f])?u[u.length-1]-r[r.length-1]:0}function V0(u,r,s=!1){let{routesMeta:c}=u,f={},h="/",p=[];for(let g=0;g<c.length;++g){let b=c[g],m=g===c.length-1,E=h==="/"?r:r.slice(h.length)||"/",T=_u({path:b.relativePath,caseSensitive:b.caseSensitive,end:m},E),O=b.route;if(!T&&m&&s&&!c[c.length-1].route.index&&(T=_u({path:b.relativePath,caseSensitive:b.caseSensitive,end:!1},E)),!T)return null;Object.assign(f,T.params),p.push({params:f,pathname:dn([h,T.pathname]),pathnameBase:I0(dn([h,T.pathnameBase])),route:O}),T.pathnameBase!=="/"&&(h=dn([h,T.pathnameBase]))}return p}function _u(u,r){typeof u=="string"&&(u={path:u,caseSensitive:!1,end:!0});let[s,c]=X0(u.path,u.caseSensitive,u.end),f=r.match(s);if(!f)return null;let h=f[0],p=h.replace(/(.)\/+$/,"$1"),g=f.slice(1);return{params:c.reduce((m,{paramName:E,isOptional:T},O)=>{if(E==="*"){let B=g[O]||"";p=h.slice(0,h.length-B.length).replace(/(.)\/+$/,"$1")}const D=g[O];return T&&!D?m[E]=void 0:m[E]=(D||"").replace(/%2F/g,"/"),m},{}),pathname:h,pathnameBase:p,pattern:u}}function X0(u,r=!1,s=!0){Gt(u==="*"||!u.endsWith("*")||u.endsWith("/*"),`Route path "${u}" will be treated as if it were "${u.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${u.replace(/\*$/,"/*")}".`);let c=[],f="^"+u.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(p,g,b)=>(c.push({paramName:g,isOptional:b!=null}),b?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return u.endsWith("*")?(c.push({paramName:"*"}),f+=u==="*"||u==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):s?f+="\\/*$":u!==""&&u!=="/"&&(f+="(?:(?=\\/|$))"),[new RegExp(f,r?void 0:"i"),c]}function Z0(u){try{return u.split("/").map(r=>decodeURIComponent(r).replace(/\//g,"%2F")).join("/")}catch(r){return Gt(!1,`The URL path "${u}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${r}).`),u}}function mn(u,r){if(r==="/")return u;if(!u.toLowerCase().startsWith(r.toLowerCase()))return null;let s=r.endsWith("/")?r.length-1:r.length,c=u.charAt(s);return c&&c!=="/"?null:u.slice(s)||"/"}var J0=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i;function K0(u,r="/"){let{pathname:s,search:c="",hash:f=""}=typeof u=="string"?Jl(u):u,h;return s?(s=s.replace(/\/\/+/g,"/"),s.startsWith("/")?h=Id(s.substring(1),"/"):h=Id(s,r)):h=r,{pathname:h,search:W0(c),hash:P0(f)}}function Id(u,r){let s=r.replace(/\/+$/,"").split("/");return u.split("/").forEach(f=>{f===".."?s.length>1&&s.pop():f!=="."&&s.push(f)}),s.length>1?s.join("/"):"/"}function ac(u,r,s,c){return`Cannot include a '${u}' character in a manually specified \`to.${r}\` field [${JSON.stringify(c)}].  Please separate it out to the \`to.${s}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function $0(u){return u.filter((r,s)=>s===0||r.route.path&&r.route.path.length>0)}function yc(u){let r=$0(u);return r.map((s,c)=>c===r.length-1?s.pathname:s.pathnameBase)}function bc(u,r,s,c=!1){let f;typeof u=="string"?f=Jl(u):(f={...u},Ne(!f.pathname||!f.pathname.includes("?"),ac("?","pathname","search",f)),Ne(!f.pathname||!f.pathname.includes("#"),ac("#","pathname","hash",f)),Ne(!f.search||!f.search.includes("#"),ac("#","search","hash",f)));let h=u===""||f.pathname==="",p=h?"/":f.pathname,g;if(p==null)g=s;else{let T=r.length-1;if(!c&&p.startsWith("..")){let O=p.split("/");for(;O[0]==="..";)O.shift(),T-=1;f.pathname=O.join("/")}g=T>=0?r[T]:"/"}let b=K0(f,g),m=p&&p!=="/"&&p.endsWith("/"),E=(h||p===".")&&s.endsWith("/");return!b.pathname.endsWith("/")&&(m||E)&&(b.pathname+="/"),b}var dn=u=>u.join("/").replace(/\/\/+/g,"/"),I0=u=>u.replace(/\/+$/,"").replace(/^\/*/,"/"),W0=u=>!u||u==="?"?"":u.startsWith("?")?u:"?"+u,P0=u=>!u||u==="#"?"":u.startsWith("#")?u:"#"+u,F0=class{constructor(u,r,s,c=!1){this.status=u,this.statusText=r||"",this.internal=c,s instanceof Error?(this.data=s.toString(),this.error=s):this.data=s}};function ey(u){return u!=null&&typeof u.status=="number"&&typeof u.statusText=="string"&&typeof u.internal=="boolean"&&"data"in u}function ty(u){return u.map(r=>r.route.path).filter(Boolean).join("/").replace(/\/\/*/g,"/")||"/"}var vm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function xm(u,r){let s=u;if(typeof s!="string"||!J0.test(s))return{absoluteURL:void 0,isExternal:!1,to:s};let c=s,f=!1;if(vm)try{let h=new URL(window.location.href),p=s.startsWith("//")?new URL(h.protocol+s):new URL(s),g=mn(p.pathname,r);p.origin===h.origin&&g!=null?s=g+p.search+p.hash:f=!0}catch{Gt(!1,`<Link to="${s}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}return{absoluteURL:c,isExternal:f,to:s}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");var Sm=["POST","PUT","PATCH","DELETE"];new Set(Sm);var ny=["GET",...Sm];new Set(ny);var Kl=M.createContext(null);Kl.displayName="DataRouter";var Du=M.createContext(null);Du.displayName="DataRouterState";var ly=M.createContext(!1),Em=M.createContext({isTransitioning:!1});Em.displayName="ViewTransition";var ay=M.createContext(new Map);ay.displayName="Fetchers";var iy=M.createContext(null);iy.displayName="Await";var bt=M.createContext(null);bt.displayName="Navigation";var Pa=M.createContext(null);Pa.displayName="Location";var Dt=M.createContext({outlet:null,matches:[],isDataRoute:!1});Dt.displayName="Route";var vc=M.createContext(null);vc.displayName="RouteError";var Tm="REACT_ROUTER_ERROR",uy="REDIRECT",ry="ROUTE_ERROR_RESPONSE";function sy(u){if(u.startsWith(`${Tm}:${uy}:{`))try{let r=JSON.parse(u.slice(28));if(typeof r=="object"&&r&&typeof r.status=="number"&&typeof r.statusText=="string"&&typeof r.location=="string"&&typeof r.reloadDocument=="boolean"&&typeof r.replace=="boolean")return r}catch{}}function cy(u){if(u.startsWith(`${Tm}:${ry}:{`))try{let r=JSON.parse(u.slice(40));if(typeof r=="object"&&r&&typeof r.status=="number"&&typeof r.statusText=="string")return new F0(r.status,r.statusText,r.data)}catch{}}function oy(u,{relative:r}={}){Ne($l(),"useHref() may be used only in the context of a <Router> component.");let{basename:s,navigator:c}=M.useContext(bt),{hash:f,pathname:h,search:p}=Fa(u,{relative:r}),g=h;return s!=="/"&&(g=h==="/"?s:dn([s,h])),c.createHref({pathname:g,search:p,hash:f})}function $l(){return M.useContext(Pa)!=null}function pn(){return Ne($l(),"useLocation() may be used only in the context of a <Router> component."),M.useContext(Pa).location}var Am="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function _m(u){M.useContext(bt).static||M.useLayoutEffect(u)}function Cm(){let{isDataRoute:u}=M.useContext(Dt);return u?Cy():fy()}function fy(){Ne($l(),"useNavigate() may be used only in the context of a <Router> component.");let u=M.useContext(Kl),{basename:r,navigator:s}=M.useContext(bt),{matches:c}=M.useContext(Dt),{pathname:f}=pn(),h=JSON.stringify(yc(c)),p=M.useRef(!1);return _m(()=>{p.current=!0}),M.useCallback((b,m={})=>{if(Gt(p.current,Am),!p.current)return;if(typeof b=="number"){s.go(b);return}let E=bc(b,JSON.parse(h),f,m.relative==="path");u==null&&r!=="/"&&(E.pathname=E.pathname==="/"?r:dn([r,E.pathname])),(m.replace?s.replace:s.push)(E,m.state,m)},[r,s,h,f,u])}var hy=M.createContext(null);function dy(u){let r=M.useContext(Dt).outlet;return M.useMemo(()=>r&&M.createElement(hy.Provider,{value:u},r),[r,u])}function my(){let{matches:u}=M.useContext(Dt),r=u[u.length-1];return r?r.params:{}}function Fa(u,{relative:r}={}){let{matches:s}=M.useContext(Dt),{pathname:c}=pn(),f=JSON.stringify(yc(s));return M.useMemo(()=>bc(u,JSON.parse(f),c,r==="path"),[u,f,c,r])}function py(u,r){return Rm(u,r)}function Rm(u,r,s,c,f){var K;Ne($l(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:h}=M.useContext(bt),{matches:p}=M.useContext(Dt),g=p[p.length-1],b=g?g.params:{},m=g?g.pathname:"/",E=g?g.pathnameBase:"/",T=g&&g.route;{let H=T&&T.path||"";Nm(m,!T||H.endsWith("*")||H.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${m}" (under <Route path="${H}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${H}"> to <Route path="${H==="/"?"*":`${H}/*`}">.`)}let O=pn(),D;if(r){let H=typeof r=="string"?Jl(r):r;Ne(E==="/"||((K=H.pathname)==null?void 0:K.startsWith(E)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${E}" but pathname "${H.pathname}" was given in the \`location\` prop.`),D=H}else D=O;let B=D.pathname||"/",U=B;if(E!=="/"){let H=E.replace(/^\//,"").split("/");U="/"+B.replace(/^\//,"").split("/").slice(H.length).join("/")}let L=gm(u,{pathname:U});Gt(T||L!=null,`No routes matched location "${D.pathname}${D.search}${D.hash}" `),Gt(L==null||L[L.length-1].route.element!==void 0||L[L.length-1].route.Component!==void 0||L[L.length-1].route.lazy!==void 0,`Matched leaf route at location "${D.pathname}${D.search}${D.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let V=xy(L&&L.map(H=>Object.assign({},H,{params:Object.assign({},b,H.params),pathname:dn([E,h.encodeLocation?h.encodeLocation(H.pathname.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathname]),pathnameBase:H.pathnameBase==="/"?E:dn([E,h.encodeLocation?h.encodeLocation(H.pathnameBase.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathnameBase])})),p,s,c,f);return r&&V?M.createElement(Pa.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...D},navigationType:"POP"}},V):V}function gy(){let u=_y(),r=ey(u)?`${u.status} ${u.statusText}`:u instanceof Error?u.message:JSON.stringify(u),s=u instanceof Error?u.stack:null,c="rgba(200,200,200, 0.5)",f={padding:"0.5rem",backgroundColor:c},h={padding:"2px 4px",backgroundColor:c},p=null;return console.error("Error handled by React Router default ErrorBoundary:",u),p=M.createElement(M.Fragment,null,M.createElement("p",null,"💿 Hey developer 👋"),M.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",M.createElement("code",{style:h},"ErrorBoundary")," or"," ",M.createElement("code",{style:h},"errorElement")," prop on your route.")),M.createElement(M.Fragment,null,M.createElement("h2",null,"Unexpected Application Error!"),M.createElement("h3",{style:{fontStyle:"italic"}},r),s?M.createElement("pre",{style:f},s):null,p)}var yy=M.createElement(gy,null),Mm=class extends M.Component{constructor(u){super(u),this.state={location:u.location,revalidation:u.revalidation,error:u.error}}static getDerivedStateFromError(u){return{error:u}}static getDerivedStateFromProps(u,r){return r.location!==u.location||r.revalidation!=="idle"&&u.revalidation==="idle"?{error:u.error,location:u.location,revalidation:u.revalidation}:{error:u.error!==void 0?u.error:r.error,location:r.location,revalidation:u.revalidation||r.revalidation}}componentDidCatch(u,r){this.props.onError?this.props.onError(u,r):console.error("React Router caught the following error during render",u)}render(){let u=this.state.error;if(this.context&&typeof u=="object"&&u&&"digest"in u&&typeof u.digest=="string"){const s=cy(u.digest);s&&(u=s)}let r=u!==void 0?M.createElement(Dt.Provider,{value:this.props.routeContext},M.createElement(vc.Provider,{value:u,children:this.props.component})):this.props.children;return this.context?M.createElement(by,{error:u},r):r}};Mm.contextType=ly;var ic=new WeakMap;function by({children:u,error:r}){let{basename:s}=M.useContext(bt);if(typeof r=="object"&&r&&"digest"in r&&typeof r.digest=="string"){let c=sy(r.digest);if(c){let f=ic.get(r);if(f)throw f;let h=xm(c.location,s);if(vm&&!ic.get(r))if(h.isExternal||c.reloadDocument)window.location.href=h.absoluteURL||h.to;else{const p=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(h.to,{replace:c.replace}));throw ic.set(r,p),p}return M.createElement("meta",{httpEquiv:"refresh",content:`0;url=${h.absoluteURL||h.to}`})}}return u}function vy({routeContext:u,match:r,children:s}){let c=M.useContext(Kl);return c&&c.static&&c.staticContext&&(r.route.errorElement||r.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=r.route.id),M.createElement(Dt.Provider,{value:u},s)}function xy(u,r=[],s=null,c=null,f=null){if(u==null){if(!s)return null;if(s.errors)u=s.matches;else if(r.length===0&&!s.initialized&&s.matches.length>0)u=s.matches;else return null}let h=u,p=s==null?void 0:s.errors;if(p!=null){let E=h.findIndex(T=>T.route.id&&(p==null?void 0:p[T.route.id])!==void 0);Ne(E>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(p).join(",")}`),h=h.slice(0,Math.min(h.length,E+1))}let g=!1,b=-1;if(s)for(let E=0;E<h.length;E++){let T=h[E];if((T.route.HydrateFallback||T.route.hydrateFallbackElement)&&(b=E),T.route.id){let{loaderData:O,errors:D}=s,B=T.route.loader&&!O.hasOwnProperty(T.route.id)&&(!D||D[T.route.id]===void 0);if(T.route.lazy||B){g=!0,b>=0?h=h.slice(0,b+1):h=[h[0]];break}}}let m=s&&c?(E,T)=>{var O,D;c(E,{location:s.location,params:((D=(O=s.matches)==null?void 0:O[0])==null?void 0:D.params)??{},unstable_pattern:ty(s.matches),errorInfo:T})}:void 0;return h.reduceRight((E,T,O)=>{let D,B=!1,U=null,L=null;s&&(D=p&&T.route.id?p[T.route.id]:void 0,U=T.route.errorElement||yy,g&&(b<0&&O===0?(Nm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),B=!0,L=null):b===O&&(B=!0,L=T.route.hydrateFallbackElement||null)));let V=r.concat(h.slice(0,O+1)),K=()=>{let H;return D?H=U:B?H=L:T.route.Component?H=M.createElement(T.route.Component,null):T.route.element?H=T.route.element:H=E,M.createElement(vy,{match:T,routeContext:{outlet:E,matches:V,isDataRoute:s!=null},children:H})};return s&&(T.route.ErrorBoundary||T.route.errorElement||O===0)?M.createElement(Mm,{location:s.location,revalidation:s.revalidation,component:U,error:D,children:K(),routeContext:{outlet:null,matches:V,isDataRoute:!0},onError:m}):K()},null)}function xc(u){return`${u} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Sy(u){let r=M.useContext(Kl);return Ne(r,xc(u)),r}function Ey(u){let r=M.useContext(Du);return Ne(r,xc(u)),r}function Ty(u){let r=M.useContext(Dt);return Ne(r,xc(u)),r}function Sc(u){let r=Ty(u),s=r.matches[r.matches.length-1];return Ne(s.route.id,`${u} can only be used on routes that contain a unique "id"`),s.route.id}function Ay(){return Sc("useRouteId")}function _y(){var c;let u=M.useContext(vc),r=Ey("useRouteError"),s=Sc("useRouteError");return u!==void 0?u:(c=r.errors)==null?void 0:c[s]}function Cy(){let{router:u}=Sy("useNavigate"),r=Sc("useNavigate"),s=M.useRef(!1);return _m(()=>{s.current=!0}),M.useCallback(async(f,h={})=>{Gt(s.current,Am),s.current&&(typeof f=="number"?await u.navigate(f):await u.navigate(f,{fromRouteId:r,...h}))},[u,r])}var Wd={};function Nm(u,r,s){!r&&!Wd[u]&&(Wd[u]=!0,Gt(!1,s))}M.memo(Ry);function Ry({routes:u,future:r,state:s,onError:c}){return Rm(u,void 0,s,c,r)}function My({to:u,replace:r,state:s,relative:c}){Ne($l(),"<Navigate> may be used only in the context of a <Router> component.");let{static:f}=M.useContext(bt);Gt(!f,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:h}=M.useContext(Dt),{pathname:p}=pn(),g=Cm(),b=bc(u,yc(h),p,c==="path"),m=JSON.stringify(b);return M.useEffect(()=>{g(JSON.parse(m),{replace:r,state:s,relative:c})},[g,m,c,r,s]),null}function Ny(u){return dy(u.context)}function fn(u){Ne(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function Dy({basename:u="/",children:r=null,location:s,navigationType:c="POP",navigator:f,static:h=!1,unstable_useTransitions:p}){Ne(!$l(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let g=u.replace(/^\/*/,"/"),b=M.useMemo(()=>({basename:g,navigator:f,static:h,unstable_useTransitions:p,future:{}}),[g,f,h,p]);typeof s=="string"&&(s=Jl(s));let{pathname:m="/",search:E="",hash:T="",state:O=null,key:D="default"}=s,B=M.useMemo(()=>{let U=mn(m,g);return U==null?null:{location:{pathname:U,search:E,hash:T,state:O,key:D},navigationType:c}},[g,m,E,T,O,D,c]);return Gt(B!=null,`<Router basename="${g}"> is not able to match the URL "${m}${E}${T}" because it does not start with the basename, so the <Router> won't render anything.`),B==null?null:M.createElement(bt.Provider,{value:b},M.createElement(Pa.Provider,{children:r,value:B}))}function Oy({children:u,location:r}){return py(fc(u),r)}function fc(u,r=[]){let s=[];return M.Children.forEach(u,(c,f)=>{if(!M.isValidElement(c))return;let h=[...r,f];if(c.type===M.Fragment){s.push.apply(s,fc(c.props.children,h));return}Ne(c.type===fn,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Ne(!c.props.index||!c.props.children,"An index route cannot have child routes.");let p={id:c.props.id||h.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,middleware:c.props.middleware,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(p.children=fc(c.props.children,h)),s.push(p)}),s}var Eu="get",Tu="application/x-www-form-urlencoded";function Ou(u){return typeof HTMLElement<"u"&&u instanceof HTMLElement}function zy(u){return Ou(u)&&u.tagName.toLowerCase()==="button"}function wy(u){return Ou(u)&&u.tagName.toLowerCase()==="form"}function ky(u){return Ou(u)&&u.tagName.toLowerCase()==="input"}function jy(u){return!!(u.metaKey||u.altKey||u.ctrlKey||u.shiftKey)}function Hy(u,r){return u.button===0&&(!r||r==="_self")&&!jy(u)}var vu=null;function Gy(){if(vu===null)try{new FormData(document.createElement("form"),0),vu=!1}catch{vu=!0}return vu}var Uy=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function uc(u){return u!=null&&!Uy.has(u)?(Gt(!1,`"${u}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Tu}"`),null):u}function Ly(u,r){let s,c,f,h,p;if(wy(u)){let g=u.getAttribute("action");c=g?mn(g,r):null,s=u.getAttribute("method")||Eu,f=uc(u.getAttribute("enctype"))||Tu,h=new FormData(u)}else if(zy(u)||ky(u)&&(u.type==="submit"||u.type==="image")){let g=u.form;if(g==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let b=u.getAttribute("formaction")||g.getAttribute("action");if(c=b?mn(b,r):null,s=u.getAttribute("formmethod")||g.getAttribute("method")||Eu,f=uc(u.getAttribute("formenctype"))||uc(g.getAttribute("enctype"))||Tu,h=new FormData(g,u),!Gy()){let{name:m,type:E,value:T}=u;if(E==="image"){let O=m?`${m}.`:"";h.append(`${O}x`,"0"),h.append(`${O}y`,"0")}else m&&h.append(m,T)}}else{if(Ou(u))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');s=Eu,c=null,f=Tu,p=u}return h&&f==="text/plain"&&(p=h,h=void 0),{action:c,method:s.toLowerCase(),encType:f,formData:h,body:p}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Ec(u,r){if(u===!1||u===null||typeof u>"u")throw new Error(r)}function By(u,r,s,c){let f=typeof u=="string"?new URL(u,typeof window>"u"?"server://singlefetch/":window.location.origin):u;return s?f.pathname.endsWith("/")?f.pathname=`${f.pathname}_.${c}`:f.pathname=`${f.pathname}.${c}`:f.pathname==="/"?f.pathname=`_root.${c}`:r&&mn(f.pathname,r)==="/"?f.pathname=`${r.replace(/\/$/,"")}/_root.${c}`:f.pathname=`${f.pathname.replace(/\/$/,"")}.${c}`,f}async function qy(u,r){if(u.id in r)return r[u.id];try{let s=await import(u.module);return r[u.id]=s,s}catch(s){return console.error(`Error loading route module \`${u.module}\`, reloading page...`),console.error(s),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Qy(u){return u==null?!1:u.href==null?u.rel==="preload"&&typeof u.imageSrcSet=="string"&&typeof u.imageSizes=="string":typeof u.rel=="string"&&typeof u.href=="string"}async function Yy(u,r,s){let c=await Promise.all(u.map(async f=>{let h=r.routes[f.route.id];if(h){let p=await qy(h,s);return p.links?p.links():[]}return[]}));return Jy(c.flat(1).filter(Qy).filter(f=>f.rel==="stylesheet"||f.rel==="preload").map(f=>f.rel==="stylesheet"?{...f,rel:"prefetch",as:"style"}:{...f,rel:"prefetch"}))}function Pd(u,r,s,c,f,h){let p=(b,m)=>s[m]?b.route.id!==s[m].route.id:!0,g=(b,m)=>{var E;return s[m].pathname!==b.pathname||((E=s[m].route.path)==null?void 0:E.endsWith("*"))&&s[m].params["*"]!==b.params["*"]};return h==="assets"?r.filter((b,m)=>p(b,m)||g(b,m)):h==="data"?r.filter((b,m)=>{var T;let E=c.routes[b.route.id];if(!E||!E.hasLoader)return!1;if(p(b,m)||g(b,m))return!0;if(b.route.shouldRevalidate){let O=b.route.shouldRevalidate({currentUrl:new URL(f.pathname+f.search+f.hash,window.origin),currentParams:((T=s[0])==null?void 0:T.params)||{},nextUrl:new URL(u,window.origin),nextParams:b.params,defaultShouldRevalidate:!0});if(typeof O=="boolean")return O}return!0}):[]}function Vy(u,r,{includeHydrateFallback:s}={}){return Xy(u.map(c=>{let f=r.routes[c.route.id];if(!f)return[];let h=[f.module];return f.clientActionModule&&(h=h.concat(f.clientActionModule)),f.clientLoaderModule&&(h=h.concat(f.clientLoaderModule)),s&&f.hydrateFallbackModule&&(h=h.concat(f.hydrateFallbackModule)),f.imports&&(h=h.concat(f.imports)),h}).flat(1))}function Xy(u){return[...new Set(u)]}function Zy(u){let r={},s=Object.keys(u).sort();for(let c of s)r[c]=u[c];return r}function Jy(u,r){let s=new Set;return new Set(r),u.reduce((c,f)=>{let h=JSON.stringify(Zy(f));return s.has(h)||(s.add(h),c.push({key:h,link:f})),c},[])}function Dm(){let u=M.useContext(Kl);return Ec(u,"You must render this element inside a <DataRouterContext.Provider> element"),u}function Ky(){let u=M.useContext(Du);return Ec(u,"You must render this element inside a <DataRouterStateContext.Provider> element"),u}var Tc=M.createContext(void 0);Tc.displayName="FrameworkContext";function Om(){let u=M.useContext(Tc);return Ec(u,"You must render this element inside a <HydratedRouter> element"),u}function $y(u,r){let s=M.useContext(Tc),[c,f]=M.useState(!1),[h,p]=M.useState(!1),{onFocus:g,onBlur:b,onMouseEnter:m,onMouseLeave:E,onTouchStart:T}=r,O=M.useRef(null);M.useEffect(()=>{if(u==="render"&&p(!0),u==="viewport"){let U=V=>{V.forEach(K=>{p(K.isIntersecting)})},L=new IntersectionObserver(U,{threshold:.5});return O.current&&L.observe(O.current),()=>{L.disconnect()}}},[u]),M.useEffect(()=>{if(c){let U=setTimeout(()=>{p(!0)},100);return()=>{clearTimeout(U)}}},[c]);let D=()=>{f(!0)},B=()=>{f(!1),p(!1)};return s?u!=="intent"?[h,O,{}]:[h,O,{onFocus:Xa(g,D),onBlur:Xa(b,B),onMouseEnter:Xa(m,D),onMouseLeave:Xa(E,B),onTouchStart:Xa(T,D)}]:[!1,O,{}]}function Xa(u,r){return s=>{u&&u(s),s.defaultPrevented||r(s)}}function Iy({page:u,...r}){let{router:s}=Dm(),c=M.useMemo(()=>gm(s.routes,u,s.basename),[s.routes,u,s.basename]);return c?M.createElement(Py,{page:u,matches:c,...r}):null}function Wy(u){let{manifest:r,routeModules:s}=Om(),[c,f]=M.useState([]);return M.useEffect(()=>{let h=!1;return Yy(u,r,s).then(p=>{h||f(p)}),()=>{h=!0}},[u,r,s]),c}function Py({page:u,matches:r,...s}){let c=pn(),{future:f,manifest:h,routeModules:p}=Om(),{basename:g}=Dm(),{loaderData:b,matches:m}=Ky(),E=M.useMemo(()=>Pd(u,r,m,h,c,"data"),[u,r,m,h,c]),T=M.useMemo(()=>Pd(u,r,m,h,c,"assets"),[u,r,m,h,c]),O=M.useMemo(()=>{if(u===c.pathname+c.search+c.hash)return[];let U=new Set,L=!1;if(r.forEach(K=>{var P;let H=h.routes[K.route.id];!H||!H.hasLoader||(!E.some(ee=>ee.route.id===K.route.id)&&K.route.id in b&&((P=p[K.route.id])!=null&&P.shouldRevalidate)||H.hasClientLoader?L=!0:U.add(K.route.id))}),U.size===0)return[];let V=By(u,g,f.unstable_trailingSlashAwareDataRequests,"data");return L&&U.size>0&&V.searchParams.set("_routes",r.filter(K=>U.has(K.route.id)).map(K=>K.route.id).join(",")),[V.pathname+V.search]},[g,f.unstable_trailingSlashAwareDataRequests,b,c,h,E,r,u,p]),D=M.useMemo(()=>Vy(T,h),[T,h]),B=Wy(T);return M.createElement(M.Fragment,null,O.map(U=>M.createElement("link",{key:U,rel:"prefetch",as:"fetch",href:U,...s})),D.map(U=>M.createElement("link",{key:U,rel:"modulepreload",href:U,...s})),B.map(({key:U,link:L})=>M.createElement("link",{key:U,nonce:s.nonce,...L,crossOrigin:L.crossOrigin??s.crossOrigin})))}function Fy(...u){return r=>{u.forEach(s=>{typeof s=="function"?s(r):s!=null&&(s.current=r)})}}var eb=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{eb&&(window.__reactRouterVersion="7.13.0")}catch{}function tb({basename:u,children:r,unstable_useTransitions:s,window:c}){let f=M.useRef();f.current==null&&(f.current=D0({window:c,v5Compat:!0}));let h=f.current,[p,g]=M.useState({action:h.action,location:h.location}),b=M.useCallback(m=>{s===!1?g(m):M.startTransition(()=>g(m))},[s]);return M.useLayoutEffect(()=>h.listen(b),[h,b]),M.createElement(Dy,{basename:u,children:r,location:p.location,navigationType:p.action,navigator:h,unstable_useTransitions:s})}var zm=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Yt=M.forwardRef(function({onClick:r,discover:s="render",prefetch:c="none",relative:f,reloadDocument:h,replace:p,state:g,target:b,to:m,preventScrollReset:E,viewTransition:T,unstable_defaultShouldRevalidate:O,...D},B){let{basename:U,unstable_useTransitions:L}=M.useContext(bt),V=typeof m=="string"&&zm.test(m),K=xm(m,U);m=K.to;let H=oy(m,{relative:f}),[P,ee,re]=$y(c,D),I=ab(m,{replace:p,state:g,target:b,preventScrollReset:E,relative:f,viewTransition:T,unstable_defaultShouldRevalidate:O,unstable_useTransitions:L});function we(vt){r&&r(vt),vt.defaultPrevented||I(vt)}let Ve=M.createElement("a",{...D,...re,href:K.absoluteURL||H,onClick:K.isExternal||h?r:we,ref:Fy(B,ee),target:b,"data-discover":!V&&s==="render"?"true":void 0});return P&&!V?M.createElement(M.Fragment,null,Ve,M.createElement(Iy,{page:H})):Ve});Yt.displayName="Link";var Au=M.forwardRef(function({"aria-current":r="page",caseSensitive:s=!1,className:c="",end:f=!1,style:h,to:p,viewTransition:g,children:b,...m},E){let T=Fa(p,{relative:m.relative}),O=pn(),D=M.useContext(Du),{navigator:B,basename:U}=M.useContext(bt),L=D!=null&&cb(T)&&g===!0,V=B.encodeLocation?B.encodeLocation(T).pathname:T.pathname,K=O.pathname,H=D&&D.navigation&&D.navigation.location?D.navigation.location.pathname:null;s||(K=K.toLowerCase(),H=H?H.toLowerCase():null,V=V.toLowerCase()),H&&U&&(H=mn(H,U)||H);const P=V!=="/"&&V.endsWith("/")?V.length-1:V.length;let ee=K===V||!f&&K.startsWith(V)&&K.charAt(P)==="/",re=H!=null&&(H===V||!f&&H.startsWith(V)&&H.charAt(V.length)==="/"),I={isActive:ee,isPending:re,isTransitioning:L},we=ee?r:void 0,Ve;typeof c=="function"?Ve=c(I):Ve=[c,ee?"active":null,re?"pending":null,L?"transitioning":null].filter(Boolean).join(" ");let vt=typeof h=="function"?h(I):h;return M.createElement(Yt,{...m,"aria-current":we,className:Ve,ref:E,style:vt,to:p,viewTransition:g},typeof b=="function"?b(I):b)});Au.displayName="NavLink";var nb=M.forwardRef(({discover:u="render",fetcherKey:r,navigate:s,reloadDocument:c,replace:f,state:h,method:p=Eu,action:g,onSubmit:b,relative:m,preventScrollReset:E,viewTransition:T,unstable_defaultShouldRevalidate:O,...D},B)=>{let{unstable_useTransitions:U}=M.useContext(bt),L=rb(),V=sb(g,{relative:m}),K=p.toLowerCase()==="get"?"get":"post",H=typeof g=="string"&&zm.test(g),P=ee=>{if(b&&b(ee),ee.defaultPrevented)return;ee.preventDefault();let re=ee.nativeEvent.submitter,I=(re==null?void 0:re.getAttribute("formmethod"))||p,we=()=>L(re||ee.currentTarget,{fetcherKey:r,method:I,navigate:s,replace:f,state:h,relative:m,preventScrollReset:E,viewTransition:T,unstable_defaultShouldRevalidate:O});U&&s!==!1?M.startTransition(()=>we()):we()};return M.createElement("form",{ref:B,method:K,action:V,onSubmit:c?b:P,...D,"data-discover":!H&&u==="render"?"true":void 0})});nb.displayName="Form";function lb(u){return`${u} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function wm(u){let r=M.useContext(Kl);return Ne(r,lb(u)),r}function ab(u,{target:r,replace:s,state:c,preventScrollReset:f,relative:h,viewTransition:p,unstable_defaultShouldRevalidate:g,unstable_useTransitions:b}={}){let m=Cm(),E=pn(),T=Fa(u,{relative:h});return M.useCallback(O=>{if(Hy(O,r)){O.preventDefault();let D=s!==void 0?s:Wa(E)===Wa(T),B=()=>m(u,{replace:D,state:c,preventScrollReset:f,relative:h,viewTransition:p,unstable_defaultShouldRevalidate:g});b?M.startTransition(()=>B()):B()}},[E,m,T,s,c,r,u,f,h,p,g,b])}var ib=0,ub=()=>`__${String(++ib)}__`;function rb(){let{router:u}=wm("useSubmit"),{basename:r}=M.useContext(bt),s=Ay(),c=u.fetch,f=u.navigate;return M.useCallback(async(h,p={})=>{let{action:g,method:b,encType:m,formData:E,body:T}=Ly(h,r);if(p.navigate===!1){let O=p.fetcherKey||ub();await c(O,s,p.action||g,{unstable_defaultShouldRevalidate:p.unstable_defaultShouldRevalidate,preventScrollReset:p.preventScrollReset,formData:E,body:T,formMethod:p.method||b,formEncType:p.encType||m,flushSync:p.flushSync})}else await f(p.action||g,{unstable_defaultShouldRevalidate:p.unstable_defaultShouldRevalidate,preventScrollReset:p.preventScrollReset,formData:E,body:T,formMethod:p.method||b,formEncType:p.encType||m,replace:p.replace,state:p.state,fromRouteId:s,flushSync:p.flushSync,viewTransition:p.viewTransition})},[c,f,r,s])}function sb(u,{relative:r}={}){let{basename:s}=M.useContext(bt),c=M.useContext(Dt);Ne(c,"useFormAction must be used inside a RouteContext");let[f]=c.matches.slice(-1),h={...Fa(u||".",{relative:r})},p=pn();if(u==null){h.search=p.search;let g=new URLSearchParams(h.search),b=g.getAll("index");if(b.some(E=>E==="")){g.delete("index"),b.filter(T=>T).forEach(T=>g.append("index",T));let E=g.toString();h.search=E?`?${E}`:""}}return(!u||u===".")&&f.route.index&&(h.search=h.search?h.search.replace(/^\?/,"?index&"):"?index"),s!=="/"&&(h.pathname=h.pathname==="/"?s:dn([s,h.pathname])),Wa(h)}function cb(u,{relative:r}={}){let s=M.useContext(Em);Ne(s!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=wm("useViewTransitionState"),f=Fa(u,{relative:r});if(!s.isTransitioning)return!1;let h=mn(s.currentLocation.pathname,c)||s.currentLocation.pathname,p=mn(s.nextLocation.pathname,c)||s.nextLocation.pathname;return _u(f.pathname,p)!=null||_u(f.pathname,h)!=null}/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ob=u=>u.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),fb=u=>u.replace(/^([A-Z])|[\s-_]+(\w)/g,(r,s,c)=>c?c.toUpperCase():s.toLowerCase()),Fd=u=>{const r=fb(u);return r.charAt(0).toUpperCase()+r.slice(1)},km=(...u)=>u.filter((r,s,c)=>!!r&&r.trim()!==""&&c.indexOf(r)===s).join(" ").trim(),hb=u=>{for(const r in u)if(r.startsWith("aria-")||r==="role"||r==="title")return!0};/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`;function Ac(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var sl=Ac();function jm(u){sl=u}var Ia={exec:()=>null};function de(u,r=""){let s=typeof u=="string"?u:u.source,c={replace:(f,h)=>{let p=typeof h=="string"?h:h.source;return p=p.replace(Fe.caret,"$1"),s=s.replace(f,p),c},getRegex:()=>new RegExp(s,r)};return c}var vv=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Fe={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:u=>new RegExp(`^( {0,3}${u})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}#`),htmlBeginRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}<(?:[a-z].*>|!--)`,"i")},xv=/^(?:[ \t]*(?:\n|$))+/,Sv=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Ev=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ei=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Tv=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,_c=/(?:[*+-]|\d{1,9}[.)])/,Hm=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Gm=de(Hm).replace(/bull/g,_c).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Av=de(Hm).replace(/bull/g,_c).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Cc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,_v=/^[^\n]+/,Rc=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Cv=de(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Rc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Rv=de(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,_c).getRegex(),zu="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Mc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Mv=de("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Mc).replace("tag",zu).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Um=de(Cc).replace("hr",ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",zu).getRegex(),Nv=de(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Um).getRegex(),Nc={blockquote:Nv,code:Sv,def:Cv,fences:Ev,heading:Tv,hr:ei,html:Mv,lheading:Gm,list:Rv,newline:xv,paragraph:Um,table:Ia,text:_v},um=de("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",zu).getRegex(),Dv={...Nc,lheading:Av,table:um,paragraph:de(Cc).replace("hr",ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",um).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",zu).getRegex()},Ov={...Nc,html:de(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Mc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Ia,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:de(Cc).replace("hr",ei).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Gm).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},zv=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,wv=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Lm=/^( {2,}|\\)\n(?!\s*$)/,kv=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,wu=/[\p{P}\p{S}]/u,Dc=/[\s\p{P}\p{S}]/u,Bm=/[^\s\p{P}\p{S}]/u,jv=de(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Dc).getRegex(),qm=/(?!~)[\p{P}\p{S}]/u,Hv=/(?!~)[\s\p{P}\p{S}]/u,Gv=/(?:[^\s\p{P}\p{S}]|~)/u,Uv=de(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",vv?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Qm=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Lv=de(Qm,"u").replace(/punct/g,wu).getRegex(),Bv=de(Qm,"u").replace(/punct/g,qm).getRegex(),Ym="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",qv=de(Ym,"gu").replace(/notPunctSpace/g,Bm).replace(/punctSpace/g,Dc).replace(/punct/g,wu).getRegex(),Qv=de(Ym,"gu").replace(/notPunctSpace/g,Gv).replace(/punctSpace/g,Hv).replace(/punct/g,qm).getRegex(),Yv=de("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Bm).replace(/punctSpace/g,Dc).replace(/punct/g,wu).getRegex(),Vv=de(/\\(punct)/,"gu").replace(/punct/g,wu).getRegex(),Xv=de(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Zv=de(Mc).replace("(?:-->|$)","-->").getRegex(),Jv=de("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Zv).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ru=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Kv=de(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Ru).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Vm=de(/^!?\[(label)\]\[(ref)\]/).replace("label",Ru).replace("ref",Rc).getRegex(),Xm=de(/^!?\[(ref)\](?:\[\])?/).replace("ref",Rc).getRegex(),$v=de("reflink|nolink(?!\\()","g").replace("reflink",Vm).replace("nolink",Xm).getRegex(),rm=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Oc={_backpedal:Ia,anyPunctuation:Vv,autolink:Xv,blockSkip:Uv,br:Lm,code:wv,del:Ia,emStrongLDelim:Lv,emStrongRDelimAst:qv,emStrongRDelimUnd:Yv,escape:zv,link:Kv,nolink:Xm,punctuation:jv,reflink:Vm,reflinkSearch:$v,tag:Jv,text:kv,url:Ia},Iv={...Oc,link:de(/^!?\[(label)\]\((.*?)\)/).replace("label",Ru).getRegex(),reflink:de(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ru).getRegex()},dc={...Oc,emStrongRDelimAst:Qv,emStrongLDelim:Bv,url:de(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",rm).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:de(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",rm).getRegex()},Wv={...dc,br:de(Lm).replace("{2,}","*").getRegex(),text:de(dc.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},xu={normal:Nc,gfm:Dv,pedantic:Ov},Ja={normal:Oc,gfm:dc,breaks:Wv,pedantic:Iv},Pv={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},sm=u=>Pv[u];function hn(u,r){if(r){if(Fe.escapeTest.test(u))return u.replace(Fe.escapeReplace,sm)}else if(Fe.escapeTestNoEncode.test(u))return u.replace(Fe.escapeReplaceNoEncode,sm);return u}function cm(u){try{u=encodeURI(u).replace(Fe.percentDecode,"%")}catch{return null}return u}function om(u,r){var h;let s=u.replace(Fe.findPipe,(p,g,b)=>{let m=!1,E=g;for(;--E>=0&&b[E]==="\\";)m=!m;return m?"|":" |"}),c=s.split(Fe.splitPipe),f=0;if(c[0].trim()||c.shift(),c.length>0&&!((h=c.at(-1))!=null&&h.trim())&&c.pop(),r)if(c.length>r)c.splice(r);else for(;c.length<r;)c.push("");for(;f<c.length;f++)c[f]=c[f].trim().replace(Fe.slashPipe,"|");return c}function Ka(u,r,s){let c=u.length;if(c===0)return"";let f=0;for(;f<c&&u.charAt(c-f-1)===r;)f++;return u.slice(0,c-f)}function Fv(u,r){if(u.indexOf(r[1])===-1)return-1;let s=0;for(let c=0;c<u.length;c++)if(u[c]==="\\")c++;else if(u[c]===r[0])s++;else if(u[c]===r[1]&&(s--,s<0))return c;return s>0?-2:-1}function fm(u,r,s,c,f){let h=r.href,p=r.title||null,g=u[1].replace(f.other.outputLinkReplace,"$1");c.state.inLink=!0;let b={type:u[0].charAt(0)==="!"?"image":"link",raw:s,href:h,title:p,text:g,tokens:c.inlineTokens(g)};return c.state.inLink=!1,b}function e1(u,r,s){let c=u.match(s.other.indentCodeCompensation);if(c===null)return r;let f=c[1];return r.split(`
...
${m}`:m,f=f?`${f}
${E}`:E;let T=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(E,h,!0),this.lexer.state.top=T,s.length===0)break;let O=h.at(-1);if((O==null?void 0:O.type)==="code")break;if((O==null?void 0:O.type)==="blockquote"){let D=O,B=D.raw+`
`+s.join(`
`),U=this.blockquote(B);h[h.length-1]=U,c=c.substring(0,c.length-D.raw.length)+U.raw,f=f.substring(0,f.length-D.text.length)+U.text;break}else if((O==null?void 0:O.type)==="list"){let D=O,B=D.raw+`
`+s.join(`
`),U=this.list(B);h[h.length-1]=U,c=c.substring(0,c.length-O.raw.length)+U.raw,f=f.substring(0,f.length-D.raw.length)+U.raw,s=B.substring(h.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:c,tokens:h,text:f}}}list(u){var s,c;let r=this.rules.block.list.exec(u);if(r){let f=r[1].trim(),h=f.length>1,p={type:"list",raw:"",ordered:h,start:h?+f.slice(0,-1):"",loose:!1,items:[]};f=h?`\\d{1,9}\\${f.slice(-1)}`:`\\${f}`,this.options.pedantic&&(f=h?f:"[*+-]");let g=this.rules.other.listItemRegex(f),b=!1;for(;u;){let E=!1,T="",O="";if(!(r=g.exec(u))||this.rules.block.hr.test(u))break;T=r[0],u=u.substring(T.length);let D=r[2].split(`
`,1)[0].replace(this.rules.other.listReplaceTabs,V=>" ".repeat(3*V.length)),B=u.split(`
`,1)[0],U=!D.trim(),L=0;if(this.options.pedantic?(L=2,O=D.trimStart()):U?L=r[1].length+1:(L=r[2].search(this.rules.other.nonSpaceChar),L=L>4?1:L,O=D.slice(L),L+=r[1].length),U&&this.rules.other.blankLine.test(B)&&(T+=B+`
`,u=u.substring(B.length+1),E=!0),!E){let V=this.rules.other.nextBulletRegex(L),K=this.rules.other.hrRegex(L),H=this.rules.other.fencesBeginRegex(L),P=this.rules.other.headingBeginRegex(L),ee=this.rules.other.htmlBeginRegex(L);for(;u;){let re=u.split(`
`,1)[0],I;if(B=re,this.options.pedantic?(B=B.replace(this.rules.other.listReplaceNesting,"  "),I=B):I=B.replace(this.rules.other.tabCharGlobal,"    "),H.test(B)||P.test(B)||ee.test(B)||V.test(B)||K.test(B))break;if(I.search(this.rules.other.nonSpaceChar)>=L||!B.trim())O+=`
`+I.slice(L);else{if(U||D.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||H.test(D)||P.test(D)||K.test(D))break;O+=`
`+B}!U&&!B.trim()&&(U=!0),T+=re+`
`,u=u.substring(re.length+1),D=I.slice(L)}}p.loose||(b?p.loose=!0:this.rules.other.doubleBlankLine.test(T)&&(b=!0)),p.items.push({type:"list_item",raw:T,task:!!this.options.gfm&&this.rules.other.listIsTask.test(O),loose:!1,text:O,tokens:[]}),p.raw+=T}let m=p.items.at(-1);if(m)m.raw=m.raw.trimEnd(),m.text=m.text.trimEnd();else return;p.raw=p.raw.trimEnd();for(let E of p.items){if(this.lexer.state.top=!1,E.tokens=this.lexer.blockTokens(E.text,[]),E.task){if(E.text=E.text.replace(this.rules.other.listReplaceTask,""),((s=E.tokens[0])==null?void 0:s.type)==="text"||((c=E.tokens[0])==null?void 0:c.type)==="paragraph"){E.tokens[0].raw=E.tokens[0].raw.replace(this.rules.other.listReplaceTask,""),E.tokens[0].text=E.tokens[0].text.replace(this.rules.other.listReplaceTask,"");for(let O=this.lexer.inlineQueue.length-1;O>=0;O--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[O].src)){this.lexer.inlineQueue[O].src=this.lexer.inlineQueue[O].src.replace(this.rules.other.listReplaceTask,"");break}}let T=this.rules.other.listTaskCheckbox.exec(E.raw);if(T){let O={type:"checkbox",raw:T[0]+" ",checked:T[0]!=="[ ]"};E.checked=O.checked,p.loose?E.tokens[0]&&["paragraph","text"].includes(E.tokens[0].type)&&"tokens"in E.tokens[0]&&E.tokens[0].tokens?(E.tokens[0].raw=O.raw+E.tokens[0].raw,E.tokens[0].text=O.raw+E.tokens[0].text,E.tokens[0].tokens.unshift(O)):E.tokens.unshift({type:"paragraph",raw:O.raw,text:O.raw,tokens:[O]}):E.tokens.unshift(O)}}if(!p.loose){let T=E.tokens.filter(D=>D.type==="space"),O=T.length>0&&T.some(D=>this.rules.other.anyLine.test(D.raw));p.loose=O}}if(p.loose)for(let E of p.items){E.loose=!0;for(let T of E.tokens)T.type==="text"&&(T.type="paragraph")}return p}}html(u){let r=this.rules.block.html.exec(u);if(r)return{type:"html",block:!0,raw:r[0],pre:r[1]==="pre"||r[1]==="script"||r[1]==="style",text:r[0]}}def(u){let r=this.rules.block.def.exec(u);if(r){let s=r[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),c=r[2]?r[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",f=r[3]?r[3].substring(1,r[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):r[3];return{type:"def",tag:s,raw:r[0],href:c,title:f}}}table(u){var p;let r=this.rules.block.table.exec(u);if(!r||!this.rules.other.tableDelimiter.test(r[2]))return;let s=om(r[1]),c=r[2].replace(this.rules.other.tableAlignChars,"").split("|"),f=(p=r[3])!=null&&p.trim()?r[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
`)?"":`
`)+g.raw,m.text+=`
`+g.raw,this.inlineQueue.at(-1).src=m.text):this.tokens.links[g.tag]||(this.tokens.links[g.tag]={href:g.href,title:g.title},s.push(g));continue}if(g=this.tokenizer.table(r)){r=r.substring(g.raw.length),s.push(g);continue}if(g=this.tokenizer.lheading(r)){r=r.substring(g.raw.length),s.push(g);continue}let b=r;if((p=this.options.extensions)!=null&&p.startBlock){let m=1/0,E=r.slice(1),T;this.options.extensions.startBlock.forEach(O=>{T=O.call({lexer:this},E),typeof T=="number"&&T>=0&&(m=Math.min(m,T))}),m<1/0&&m>=0&&(b=r.substring(0,m+1))}if(this.state.top&&(g=this.tokenizer.paragraph(b))){let m=s.at(-1);c&&(m==null?void 0:m.type)==="paragraph"?(m.raw+=(m.raw.endsWith(`
`)?"":`
`)+g.raw,m.text+=`
...
`)?"":`
`)+g.raw,m.text+=`
`+g.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=m.text):s.push(g);continue}if(r){let m="Infinite loop on byte: "+r.charCodeAt(0);if(this.options.silent){console.error(m);break}else throw new Error(m)}}return this.state.top=!0,s}inline(r,s=[]){return this.inlineQueue.push({src:r,tokens:s}),s}inlineTokens(r,s=[]){var b,m,E,T,O;let c=r,f=null;if(this.tokens.links){let D=Object.keys(this.tokens.links);if(D.length>0)for(;(f=this.tokenizer.rules.inline.reflinkSearch.exec(c))!=null;)D.includes(f[0].slice(f[0].lastIndexOf("[")+1,-1))&&(c=c.slice(0,f.index)+"["+"a".repeat(f[0].length-2)+"]"+c.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(f=this.tokenizer.rules.inline.anyPunctuation.exec(c))!=null;)c=c.slice(0,f.index)+"++"+c.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let h;for(;(f=this.tokenizer.rules.inline.blockSkip.exec(c))!=null;)h=f[2]?f[2].length:0,c=c.slice(0,f.index+h)+"["+"a".repeat(f[0].length-h-2)+"]"+c.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);c=((m=(b=this.options.hooks)==null?void 0:b.emStrongMask)==null?void 0:m.call({lexer:this},c))??c;let p=!1,g="";for(;r;){p||(g=""),p=!1;let D;if((T=(E=this.options.extensions)==null?void 0:E.inline)!=null&&T.some(U=>(D=U.call({lexer:this},r,s))?(r=r.substring(D.raw.length),s.push(D),!0):!1))continue;if(D=this.tokenizer.escape(r)){r=r.substring(D.raw.length),s.push(D);continue}if(D=this.tokenizer.tag(r)){r=r.substring(D.raw.length),s.push(D);continue}if(D=this.tokenizer.link(r)){r=r.substring(D.raw.length),s.push(D);continue}if(D=this.tokenizer.reflink(r,this.tokens.links)){r=r.substring(D.raw.length);let U=s.at(-1);D.type==="text"&&(U==null?void 0:U.type)==="text"?(U.raw+=D.raw,U.text+=D.text):s.push(D);continue}if(D=this.tokenizer.emStrong(r,c,g)){r=r.substring(D.raw.length),s.push(D);continue}if(D=this.tokenizer.codespan(r)){r=r.substring(D.raw.length),s.push(D);continue}if(D=this.tokenizer.br(r)){r=r.substring(D.raw.length),s.push(D);continue}if(D=this.tokenizer.del(r)){r=r.substring(D.raw.length),s.push(D);continue}if(D=this.tokenizer.autolink(r)){r=r.substring(D.raw.length),s.push(D);continue}if(!this.state.inLink&&(D=this.tokenizer.url(r))){r=r.substring(D.raw.length),s.push(D);continue}let B=r;if((O=this.options.extensions)!=null&&O.startInline){let U=1/0,L=r.slice(1),V;this.options.extensions.startInline.forEach(K=>{V=K.call({lexer:this},L),typeof V=="number"&&V>=0&&(U=Math.min(U,V))}),U<1/0&&U>=0&&(B=r.substring(0,U+1))}if(D=this.tokenizer.inlineText(B)){r=r.substring(D.raw.length),D.raw.slice(-1)!=="_"&&(g=D.raw.slice(-1)),p=!0;let U=s.at(-1);(U==null?void 0:U.type)==="text"?(U.raw+=D.raw,U.text+=D.text):s.push(D);continue}if(r){let U="Infinite loop on byte: "+r.charCodeAt(0);if(this.options.silent){console.error(U);break}else throw new Error(U)}}return s}},Nu=class{constructor(u){Te(this,"options");Te(this,"parser");this.options=u||sl}space(u){return""}code({text:u,lang:r,escaped:s}){var h;let c=(h=(r||"").match(Fe.notSpaceStart))==null?void 0:h[0],f=u.replace(Fe.endingNewline,"")+`
