 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Bh;function xg(){if(Bh)return P;Bh=1;var u=Symbol.for("react.transitional.element"),s=Symbol.for("react.portal"),r=Symbol.for("react.fragment"),c=Symbol.for("react.strict_mode"),f=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),p=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),b=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),E=Symbol.for("react.lazy"),A=Symbol.for("react.activity"),N=Symbol.iterator;function D(S){return S===null||typeof S!="object"?null:(S=N&&S[N]||S["@@iterator"],typeof S=="function"?S:null)}var G={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},L=Object.assign,B={};function X(S,U,Q){this.props=S,this.context=U,this.refs=B,this.updater=Q||G}X.prototype.isReactComponent={},X.prototype.setState=function(S,U){if(typeof S!="object"&&typeof S!="function"&&S!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,S,U,"setState")},X.prototype.forceUpdate=function(S){this.updater.enqueueForceUpdate(this,S,"forceUpdate")};function K(){}K.prototype=X.prototype;function H(S,U,Q){this.props=S,this.context=U,this.refs=B,this.updater=Q||G}var I=H.prototype=new K;I.constructor=H,L(I,X.prototype),I.isPureReactComponent=!0;var ee=Array.isArray;function se(){}var W={H:null,A:null,T:null,S:null},ke=Object.prototype.hasOwnProperty;function Xe(S,U,Q){var V=Q.ref;return{$$typeof:u,type:S,key:U,ref:V!==void 0?V:null,props:Q}}function vt(S,U){return Xe(S.type,U,S.props)}function Lt(S){return typeof S=="object"&&S!==null&&S.$$typeof===u}function et(S){var U={"=":"=0",":":"=2"};return"$"+S.replace(/[=:]/g,function(Q){return U[Q]})}var qn=/\/+/g;function Yt(S,U){return typeof S=="object"&&S!==null&&S.key!=null?et(""+S.key):U.toString(36)}function Nt(S){switch(S.status){case"fulfilled":return S.value;case"rejected":throw S.reason;default:switch(typeof S.status=="string"?S.then(se,se):(S.status="pending",S.then(function(U){S.status==="pending"&&(S.status="fulfilled",S.value=U)},function(U){S.status==="pending"&&(S.status="rejected",S.reason=U)})),S.status){case"fulfilled":return S.value;case"rejected":throw S.reason}}throw S}function k(S,U,Q,V,te){var ae=typeof S;(ae==="undefined"||ae==="boolean")&&(S=null);var pe=!1;if(S===null)pe=!0;else switch(ae){case"bigint":case"string":case"number":pe=!0;break;case"object":switch(S.$$typeof){case u:case s:pe=!0;break;case E:return pe=S._init,k(pe(S._payload),U,Q,V,te)}}if(pe)return te=te(S),pe=V===""?"."+Yt(S,0):V,ee(te)?(Q="",pe!=null&&(Q=pe.replace(qn,"$&/")+"/"),k(te,U,Q,"",function(Wl){return Wl})):te!=null&&(Lt(te)&&(te=vt(te,Q+(te.key==null||S&&S.key===te.key?"":(""+te.key).replace(qn,"$&/")+"/")+pe)),U.push(te)),1;pe=0;var Fe=V===""?".":V+":";if(ee(S))for(var we=0;we<S.length;we++)V=S[we],ae=Fe+Yt(V,we),pe+=k(V,U,Q,ae,te);else if(we=D(S),typeof we=="function")for(S=we.call(S),we=0;!(V=S.next()).done;)V=V.value,ae=Fe+Yt(V,we++),pe+=k(V,U,Q,ae,te);else if(ae==="object"){if(typeof S.then=="function")return k(Nt(S),U,Q,V,te);throw U=String(S),Error("Objects are not valid as a React child (found: "+(U==="[object Object]"?"object with keys {"+Object.keys(S).join(", ")+"}":U)+"). If you meant to render a collection of children, use an array instead.")}return pe}function q(S,U,Q){if(S==null)return S;var V=[],te=0;return k(S,V,"","",function(ae){return U.call(Q,ae,te++)}),V}function F(S){if(S._status===-1){var U=S._result;U=U(),U.then(function(Q){(S._status===0||S._status===-1)&&(S._status=1,S._result=Q)},function(Q){(S._status===0||S._status===-1)&&(S._status=2,S._result=Q)}),S._status===-1&&(S._status=0,S._result=U)}if(S._status===1)return S._result.default;throw S._result}var ve=typeof reportError=="function"?reportError:function(S){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var U=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof S=="object"&&S!==null&&typeof S.message=="string"?String(S.message):String(S),error:S});if(!window.dispatchEvent(U))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",S);return}console.error(S)},Te={map:q,forEach:function(S,U,Q){q(S,function(){U.apply(this,arguments)},Q)},count:function(S){var U=0;return q(S,function(){U++}),U},toArray:function(S){return q(S,function(U){return U})||[]},only:function(S){if(!Lt(S))throw Error("React.Children.only expected to receive a single React element child.");return S}};return P.Activity=A,P.Children=Te,P.Component=X,P.Fragment=r,P.Profiler=f,P.PureComponent=H,P.StrictMode=c,P.Suspense=b,P.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=W,P.__COMPILER_RUNTIME={__proto__:null,c:function(S){return W.H.useMemoCache(S)}},P.cache=function(S){return function(){return S.apply(null,arguments)}},P.cacheSignal=function(){return null},P.cloneElement=function(S,U,Q){if(S==null)throw Error("The argument must be a React element, but you passed "+S+".");var V=L({},S.props),te=S.key;if(U!=null)for(ae in U.key!==void 0&&(te=""+U.key),U)!ke.call(U,ae)||ae==="key"||ae==="__self"||ae==="__source"||ae==="ref"&&U.ref===void 0||(V[ae]=U[ae]);var ae=arguments.length-2;if(ae===1)V.children=Q;else if(1<ae){for(var pe=Array(ae),Fe=0;Fe<ae;Fe++)pe[Fe]=arguments[Fe+2];V.children=pe}return Xe(S.type,te,V)},P.createContext=function(S){return S={$$typeof:p,_currentValue:S,_currentValue2:S,_threadCount:0,Provider:null,Consumer:null},S.Provider=S,S.Consumer={$$typeof:d,_context:S},S},P.createElement=function(S,U,Q){var V,te={},ae=null;if(U!=null)for(V in U.key!==void 0&&(ae=""+U.key),U)ke.call(U,V)&&V!=="key"&&V!=="__self"&&V!=="__source"&&(te[V]=U[V]);var pe=arguments.length-2;if(pe===1)te.children=Q;else if(1<pe){for(var Fe=Array(pe),we=0;we<pe;we++)Fe[we]=arguments[we+2];te.children=Fe}if(S&&S.defaultProps)for(V in pe=S.defaultProps,pe)te[V]===void 0&&(te[V]=pe[V]);return Xe(S,ae,te)},P.createRef=function(){return{current:null}},P.forwardRef=function(S){return{$$typeof:g,render:S}},P.isValidElement=Lt,P.lazy=function(S){return{$$typeof:E,_payload:{_status:-1,_result:S},_init:F}},P.memo=function(S,U){return{$$typeof:m,type:S,compare:U===void 0?null:U}},P.startTransition=function(S){var U=W.T,Q={};W.T=Q;try{var V=S(),te=W.S;te!==null&&te(Q,V),typeof V=="object"&&V!==null&&typeof V.then=="function"&&V.then(se,ve)}catch(ae){ve(ae)}finally{U!==null&&Q.types!==null&&(U.types=Q.types),W.T=U}},P.unstable_useCacheRefresh=function(){return W.H.useCacheRefresh()},P.use=function(S){return W.H.use(S)},P.useActionState=function(S,U,Q){return W.H.useActionState(S,U,Q)},P.useCallback=function(S,U){return W.H.useCallback(S,U)},P.useContext=function(S){return W.H.useContext(S)},P.useDebugValue=function(){},P.useDeferredValue=function(S,U){return W.H.useDeferredValue(S,U)},P.useEffect=function(S,U){return W.H.useEffect(S,U)},P.useEffectEvent=function(S){return W.H.useEffectEvent(S)},P.useId=function(){return W.H.useId()},P.useImperativeHandle=function(S,U,Q){return W.H.useImperativeHandle(S,U,Q)},P.useInsertionEffect=function(S,U){return W.H.useInsertionEffect(S,U)},P.useLayoutEffect=function(S,U){return W.H.useLayoutEffect(S,U)},P.useMemo=function(S,U){return W.H.useMemo(S,U)},P.useOptimistic=function(S,U){return W.H.useOptimistic(S,U)},P.useReducer=function(S,U,Q){return W.H.useReducer(S,U,Q)},P.useRef=function(S){return W.H.useRef(S)},P.useState=function(S){return W.H.useState(S)},P.useSyncExternalStore=function(S,U,Q){return W.H.useSyncExternalStore(S,U,Q)},P.useTransition=function(){return W.H.useTransition()},P.version="19.2.3",P}var Gh;function gc(){return Gh||(Gh=1,Pr.exports=xg()),Pr.exports}var z=gc();const Sg=pm(z);var ec={exports:{}},Xa={},tc={exports:{}},nc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var qh;function Eg(){return qh||(qh=1,(function(u){function s(k,q){var F=k.length;k.push(q);e:for(;0<F;){var ve=F-1>>>1,Te=k[ve];if(0<f(Te,q))k[ve]=q,k[F]=Te,F=ve;else break e}}function r(k){return k.length===0?null:k[0]}function c(k){if(k.length===0)return null;var q=k[0],F=k.pop();if(F!==q){k[0]=F;e:for(var ve=0,Te=k.length,S=Te>>>1;ve<S;){var U=2*(ve+1)-1,Q=k[U],V=U+1,te=k[V];if(0>f(Q,F))V<Te&&0>f(te,Q)?(k[ve]=te,k[V]=F,ve=V):(k[ve]=Q,k[U]=F,ve=U);else if(V<Te&&0>f(te,F))k[ve]=te,k[V]=F,ve=V;else break e}}return q}function f(k,q){var F=k.sortIndex-q.sortIndex;return F!==0?F:k.id-q.id}if(u.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;u.unstable_now=function(){return d.now()}}else{var p=Date,g=p.now();u.unstable_now=function(){return p.now()-g}}var b=[],m=[],E=1,A=null,N=3,D=!1,G=!1,L=!1,B=!1,X=typeof setTimeout=="function"?setTimeout:null,K=typeof clearTimeout=="function"?clearTimeout:null,H=typeof setImmediate<"u"?setImmediate:null;function I(k){for(var q=r(m);q!==null;){if(q.callback===null)c(m);else if(q.startTime<=k)c(m),q.sortIndex=q.expirationTime,s(b,q);else break;q=r(m)}}function ee(k){if(L=!1,I(k),!G)if(r(b)!==null)G=!0,se||(se=!0,et());else{var q=r(m);q!==null&&Nt(ee,q.startTime-k)}}var se=!1,W=-1,ke=5,Xe=-1;function vt(){return B?!0:!(u.unstable_now()-Xe<ke)}function Lt(){if(B=!1,se){var k=u.unstable_now();Xe=k;var q=!0;try{e:{G=!1,L&&(L=!1,K(W),W=-1),D=!0;var F=N;try{t:{for(I(k),A=r(b);A!==null&&!(A.expirationTime>k&&vt());){var ve=A.callback;if(typeof ve=="function"){A.callback=null,N=A.priorityLevel;var Te=ve(A.expirationTime<=k);if(k=u.unstable_now(),typeof Te=="function"){A.callback=Te,I(k),q=!0;break t}A===r(b)&&c(b),I(k)}else c(b);A=r(b)}if(A!==null)q=!0;else{var S=r(m);S!==null&&Nt(ee,S.startTime-k),q=!1}}break e}finally{A=null,N=F,D=!1}q=void 0}}finally{q?et():se=!1}}}var et;if(typeof H=="function")et=function(){H(Lt)};else if(typeof MessageChannel<"u"){var qn=new MessageChannel,Yt=qn.port2;qn.port1.onmessage=Lt,et=function(){Yt.postMessage(null)}}else et=function(){X(Lt,0)};function Nt(k,q){W=X(function(){k(u.unstable_now())},q)}u.unstable_IdlePriority=5,u.unstable_ImmediatePriority=1,u.unstable_LowPriority=4,u.unstable_NormalPriority=3,u.unstable_Profiling=null,u.unstable_UserBlockingPriority=2,u.unstable_cancelCallback=function(k){k.callback=null},u.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ke=0<k?Math.floor(1e3/k):5},u.unstable_getCurrentPriorityLevel=function(){return N},u.unstable_next=function(k){switch(N){case 1:case 2:case 3:var q=3;break;default:q=N}var F=N;N=q;try{return k()}finally{N=F}},u.unstable_requestPaint=function(){B=!0},u.unstable_runWithPriority=function(k,q){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var F=N;N=k;try{return q()}finally{N=F}},u.unstable_scheduleCallback=function(k,q,F){var ve=u.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?ve+F:ve):F=ve,k){case 1:var Te=-1;break;case 2:Te=250;break;case 5:Te=1073741823;break;case 4:Te=1e4;break;default:Te=5e3}return Te=F+Te,k={id:E++,callback:q,priorityLevel:k,startTime:F,expirationTime:Te,sortIndex:-1},F>ve?(k.sortIndex=F,s(m,k),r(b)===null&&k===r(m)&&(L?(K(W),W=-1):L=!0,Nt(ee,F-ve))):(k.sortIndex=Te,s(b,k),G||D||(G=!0,se||(se=!0,et()))),k},u.unstable_shouldYield=vt,u.unstable_wrapCallback=function(k){var q=N;return function(){var F=N;N=q;try{return k.apply(this,arguments)}finally{N=F}}}})(nc)),nc}var Qh;function Ag(){return Qh||(Qh=1,tc.exports=Eg()),tc.exports}var lc={exports:{}},We={};/**
 * @license React
 ...
 *
 * @license MIT
 */var Jh="popstate";function Dg(u={}){function s(c,f){let{pathname:d,search:p,hash:g}=c.location;return oc("",{pathname:d,search:p,hash:g},f.state&&f.state.usr||null,f.state&&f.state.key||"default")}function r(c,f){return typeof f=="string"?f:Fa(f)}return Og(s,r,null,u)}function Me(u,s){if(u===!1||u===null||typeof u>"u")throw new Error(s)}function Ut(u,s){if(!u){typeof console<"u"&&console.warn(s);try{throw new Error(s)}catch{}}}function Ng(){return Math.random().toString(36).substring(2,10)}function Kh(u,s){return{usr:u.state,key:u.key,idx:s}}function oc(u,s,r=null,c){return{pathname:typeof u=="string"?u:u.pathname,search:"",hash:"",...typeof s=="string"?Jl(s):s,state:r,key:s&&s.key||c||Ng()}}function Fa({pathname:u="/",search:s="",hash:r=""}){return s&&s!=="?"&&(u+=s.charAt(0)==="?"?s:"?"+s),r&&r!=="#"&&(u+=r.charAt(0)==="#"?r:"#"+r),u}function Jl(u){let s={};if(u){let r=u.indexOf("#");r>=0&&(s.hash=u.substring(r),u=u.substring(0,r));let c=u.indexOf("?");c>=0&&(s.search=u.substring(c),u=u.substring(0,c)),u&&(s.pathname=u)}return s}function Og(u,s,r,c={}){let{window:f=document.defaultView,v5Compat:d=!1}=c,p=f.history,g="POP",b=null,m=E();m==null&&(m=0,p.replaceState({...p.state,idx:m},""));function E(){return(p.state||{idx:null}).idx}function A(){g="POP";let B=E(),X=B==null?null:B-m;m=B,b&&b({action:g,location:L.location,delta:X})}function N(B,X){g="PUSH";let K=oc(L.location,B,X);m=E()+1;let H=Kh(K,m),I=L.createHref(K);try{p.pushState(H,"",I)}catch(ee){if(ee instanceof DOMException&&ee.name==="DataCloneError")throw ee;f.location.assign(I)}d&&b&&b({action:g,location:L.location,delta:1})}function D(B,X){g="REPLACE";let K=oc(L.location,B,X);m=E();let H=Kh(K,m),I=L.createHref(K);p.replaceState(H,"",I),d&&b&&b({action:g,location:L.location,delta:0})}function G(B){return kg(B)}let L={get action(){return g},get location(){return u(f,p)},listen(B){if(b)throw new Error("A history only accepts one active listener");return f.addEventListener(Jh,A),b=B,()=>{f.removeEventListener(Jh,A),b=null}},createHref(B){return s(f,B)},createURL:G,encodeLocation(B){let X=G(B);return{pathname:X.pathname,search:X.search,hash:X.hash}},push:N,replace:D,go(B){return p.go(B)}};return L}function kg(u,s=!1){let r="http://localhost";typeof window<"u"&&(r=window.location.origin!=="null"?window.location.origin:window.location.href),Me(r,"No window.location.(origin|href) available to create URL");let c=typeof u=="string"?u:Fa(u);return c=c.replace(/ $/,"%20"),!s&&c.startsWith("//")&&(c=r+c),new URL(c,r)}function gm(u,s,r="/"){return wg(u,s,r,!1)}function wg(u,s,r,c){let f=typeof s=="string"?Jl(s):s,d=mn(f.pathname||"/",r);if(d==null)return null;let p=ym(u);jg(p);let g=null;for(let b=0;g==null&&b<p.length;++b){let m=Zg(d);g=Xg(p[b],m,c)}return g}function ym(u,s=[],r=[],c="",f=!1){let d=(p,g,b=f,m)=>{let E={relativePath:m===void 0?p.path||"":m,caseSensitive:p.caseSensitive===!0,childrenIndex:g,route:p};if(E.relativePath.startsWith("/")){if(!E.relativePath.startsWith(c)&&b)return;Me(E.relativePath.startsWith(c),`Absolute route path "${E.relativePath}" nested under path "${c}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),E.relativePath=E.relativePath.slice(c.length)}let A=hn([c,E.relativePath]),N=r.concat(E);p.children&&p.children.length>0&&(Me(p.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${A}".`),ym(p.children,s,N,A,b)),!(p.path==null&&!p.index)&&s.push({path:A,score:Qg(A,p.index),routesMeta:N})};return u.forEach((p,g)=>{var b;if(p.path===""||!((b=p.path)!=null&&b.includes("?")))d(p,g);else for(let m of bm(p.path))d(p,g,!0,m)}),s}function bm(u){let s=u.split("/");if(s.length===0)return[];let[r,...c]=s,f=r.endsWith("?"),d=r.replace(/\?$/,"");if(c.length===0)return f?[d,""]:[d];let p=bm(c.join("/")),g=[];return g.push(...p.map(b=>b===""?d:[d,b].join("/"))),f&&g.push(...p),g.map(b=>u.startsWith("/")&&b===""?"/":b)}function jg(u){u.sort((s,r)=>s.score!==r.score?r.score-s.score:Yg(s.routesMeta.map(c=>c.childrenIndex),r.routesMeta.map(c=>c.childrenIndex)))}var Hg=/^:[\w-]+$/,Ug=3,Lg=2,Bg=1,Gg=10,qg=-2,$h=u=>u==="*";function Qg(u,s){let r=u.split("/"),c=r.length;return r.some($h)&&(c+=qg),s&&(c+=Lg),r.filter(f=>!$h(f)).reduce((f,d)=>f+(Hg.test(d)?Ug:d===""?Bg:Gg),c)}function Yg(u,s){return u.length===s.length&&u.slice(0,-1).every((c,f)=>c===s[f])?u[u.length-1]-s[s.length-1]:0}function Xg(u,s,r=!1){let{routesMeta:c}=u,f={},d="/",p=[];for(let g=0;g<c.length;++g){let b=c[g],m=g===c.length-1,E=d==="/"?s:s.slice(d.length)||"/",A=_u({path:b.relativePath,caseSensitive:b.caseSensitive,end:m},E),N=b.route;if(!A&&m&&r&&!c[c.length-1].route.index&&(A=_u({path:b.relativePath,caseSensitive:b.caseSensitive,end:!1},E)),!A)return null;Object.assign(f,A.params),p.push({params:f,pathname:hn([d,A.pathname]),pathnameBase:Wg(hn([d,A.pathnameBase])),route:N}),A.pathnameBase!=="/"&&(d=hn([d,A.pathnameBase]))}return p}function _u(u,s){typeof u=="string"&&(u={path:u,caseSensitive:!1,end:!0});let[r,c]=Vg(u.path,u.caseSensitive,u.end),f=s.match(r);if(!f)return null;let d=f[0],p=d.replace(/(.)\/+$/,"$1"),g=f.slice(1);return{params:c.reduce((m,{paramName:E,isOptional:A},N)=>{if(E==="*"){let G=g[N]||"";p=d.slice(0,d.length-G.length).replace(/(.)\/+$/,"$1")}const D=g[N];return A&&!D?m[E]=void 0:m[E]=(D||"").replace(/%2F/g,"/"),m},{}),pathname:d,pathnameBase:p,pattern:u}}function Vg(u,s=!1,r=!0){Ut(u==="*"||!u.endsWith("*")||u.endsWith("/*"),`Route path "${u}" will be treated as if it were "${u.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${u.replace(/\*$/,"/*")}".`);let c=[],f="^"+u.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(p,g,b)=>(c.push({paramName:g,isOptional:b!=null}),b?"/?([^\\/]+)?":"/([^\\/]+)")).replace(/\/([\w-]+)\?(\/|$)/g,"(/$1)?$2");return u.endsWith("*")?(c.push({paramName:"*"}),f+=u==="*"||u==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):r?f+="\\/*$":u!==""&&u!=="/"&&(f+="(?:(?=\\/|$))"),[new RegExp(f,s?void 0:"i"),c]}function Zg(u){try{return u.split("/").map(s=>decodeURIComponent(s).replace(/\//g,"%2F")).join("/")}catch(s){return Ut(!1,`The URL path "${u}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${s}).`),u}}function mn(u,s){if(s==="/")return u;if(!u.toLowerCase().startsWith(s.toLowerCase()))return null;let r=s.endsWith("/")?s.length-1:s.length,c=u.charAt(r);return c&&c!=="/"?null:u.slice(r)||"/"}var Jg=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i;function Kg(u,s="/"){let{pathname:r,search:c="",hash:f=""}=typeof u=="string"?Jl(u):u,d;return r?(r=r.replace(/\/\/+/g,"/"),r.startsWith("/")?d=Wh(r.substring(1),"/"):d=Wh(r,s)):d=s,{pathname:d,search:Fg(c),hash:Ig(f)}}function Wh(u,s){let r=s.replace(/\/+$/,"").split("/");return u.split("/").forEach(f=>{f===".."?r.length>1&&r.pop():f!=="."&&r.push(f)}),r.length>1?r.join("/"):"/"}function ac(u,s,r,c){return`Cannot include a '${u}' character in a manually specified \`to.${s}\` field [${JSON.stringify(c)}].  Please separate it out to the \`to.${r}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function $g(u){return u.filter((s,r)=>r===0||s.route.path&&s.route.path.length>0)}function yc(u){let s=$g(u);return s.map((r,c)=>c===s.length-1?r.pathname:r.pathnameBase)}function bc(u,s,r,c=!1){let f;typeof u=="string"?f=Jl(u):(f={...u},Me(!f.pathname||!f.pathname.includes("?"),ac("?","pathname","search",f)),Me(!f.pathname||!f.pathname.includes("#"),ac("#","pathname","hash",f)),Me(!f.search||!f.search.includes("#"),ac("#","search","hash",f)));let d=u===""||f.pathname==="",p=d?"/":f.pathname,g;if(p==null)g=r;else{let A=s.length-1;if(!c&&p.startsWith("..")){let N=p.split("/");for(;N[0]==="..";)N.shift(),A-=1;f.pathname=N.join("/")}g=A>=0?s[A]:"/"}let b=Kg(f,g),m=p&&p!=="/"&&p.endsWith("/"),E=(d||p===".")&&r.endsWith("/");return!b.pathname.endsWith("/")&&(m||E)&&(b.pathname+="/"),b}var hn=u=>u.join("/").replace(/\/\/+/g,"/"),Wg=u=>u.replace(/\/+$/,"").replace(/^\/*/,"/"),Fg=u=>!u||u==="?"?"":u.startsWith("?")?u:"?"+u,Ig=u=>!u||u==="#"?"":u.startsWith("#")?u:"#"+u,Pg=class{constructor(u,s,r,c=!1){this.status=u,this.statusText=s||"",this.internal=c,r instanceof Error?(this.data=r.toString(),this.error=r):this.data=r}};function ey(u){return u!=null&&typeof u.status=="number"&&typeof u.statusText=="string"&&typeof u.internal=="boolean"&&"data"in u}function ty(u){return u.map(s=>s.route.path).filter(Boolean).join("/").replace(/\/\/*/g,"/")||"/"}var vm=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";function xm(u,s){let r=u;if(typeof r!="string"||!Jg.test(r))return{absoluteURL:void 0,isExternal:!1,to:r};let c=r,f=!1;if(vm)try{let d=new URL(window.location.href),p=r.startsWith("//")?new URL(d.protocol+r):new URL(r),g=mn(p.pathname,s);p.origin===d.origin&&g!=null?r=g+p.search+p.hash:f=!0}catch{Ut(!1,`<Link to="${r}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}return{absoluteURL:c,isExternal:f,to:r}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");var Sm=["POST","PUT","PATCH","DELETE"];new Set(Sm);var ny=["GET",...Sm];new Set(ny);var Kl=z.createContext(null);Kl.displayName="DataRouter";var Du=z.createContext(null);Du.displayName="DataRouterState";var ly=z.createContext(!1),Em=z.createContext({isTransitioning:!1});Em.displayName="ViewTransition";var ay=z.createContext(new Map);ay.displayName="Fetchers";var iy=z.createContext(null);iy.displayName="Await";var bt=z.createContext(null);bt.displayName="Navigation";var Ia=z.createContext(null);Ia.displayName="Location";var Dt=z.createContext({outlet:null,matches:[],isDataRoute:!1});Dt.displayName="Route";var vc=z.createContext(null);vc.displayName="RouteError";var Am="REACT_ROUTER_ERROR",uy="REDIRECT",sy="ROUTE_ERROR_RESPONSE";function ry(u){if(u.startsWith(`${Am}:${uy}:{`))try{let s=JSON.parse(u.slice(28));if(typeof s=="object"&&s&&typeof s.status=="number"&&typeof s.statusText=="string"&&typeof s.location=="string"&&typeof s.reloadDocument=="boolean"&&typeof s.replace=="boolean")return s}catch{}}function cy(u){if(u.startsWith(`${Am}:${sy}:{`))try{let s=JSON.parse(u.slice(40));if(typeof s=="object"&&s&&typeof s.status=="number"&&typeof s.statusText=="string")return new Pg(s.status,s.statusText,s.data)}catch{}}function oy(u,{relative:s}={}){Me($l(),"useHref() may be used only in the context of a <Router> component.");let{basename:r,navigator:c}=z.useContext(bt),{hash:f,pathname:d,search:p}=Pa(u,{relative:s}),g=d;return r!=="/"&&(g=d==="/"?r:hn([r,d])),c.createHref({pathname:g,search:p,hash:f})}function $l(){return z.useContext(Ia)!=null}function pn(){return Me($l(),"useLocation() may be used only in the context of a <Router> component."),z.useContext(Ia).location}var Tm="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function _m(u){z.useContext(bt).static||z.useLayoutEffect(u)}function Rm(){let{isDataRoute:u}=z.useContext(Dt);return u?Ry():fy()}function fy(){Me($l(),"useNavigate() may be used only in the context of a <Router> component.");let u=z.useContext(Kl),{basename:s,navigator:r}=z.useContext(bt),{matches:c}=z.useContext(Dt),{pathname:f}=pn(),d=JSON.stringify(yc(c)),p=z.useRef(!1);return _m(()=>{p.current=!0}),z.useCallback((b,m={})=>{if(Ut(p.current,Tm),!p.current)return;if(typeof b=="number"){r.go(b);return}let E=bc(b,JSON.parse(d),f,m.relative==="path");u==null&&s!=="/"&&(E.pathname=E.pathname==="/"?s:hn([s,E.pathname])),(m.replace?r.replace:r.push)(E,m.state,m)},[s,r,d,f,u])}var dy=z.createContext(null);function hy(u){let s=z.useContext(Dt).outlet;return z.useMemo(()=>s&&z.createElement(dy.Provider,{value:u},s),[s,u])}function my(){let{matches:u}=z.useContext(Dt),s=u[u.length-1];return s?s.params:{}}function Pa(u,{relative:s}={}){let{matches:r}=z.useContext(Dt),{pathname:c}=pn(),f=JSON.stringify(yc(r));return z.useMemo(()=>bc(u,JSON.parse(f),c,s==="path"),[u,f,c,s])}function py(u,s){return Cm(u,s)}function Cm(u,s,r,c,f){var K;Me($l(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:d}=z.useContext(bt),{matches:p}=z.useContext(Dt),g=p[p.length-1],b=g?g.params:{},m=g?g.pathname:"/",E=g?g.pathnameBase:"/",A=g&&g.route;{let H=A&&A.path||"";Mm(m,!A||H.endsWith("*")||H.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${m}" (under <Route path="${H}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${H}"> to <Route path="${H==="/"?"*":`${H}/*`}">.`)}let N=pn(),D;if(s){let H=typeof s=="string"?Jl(s):s;Me(E==="/"||((K=H.pathname)==null?void 0:K.startsWith(E)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${E}" but pathname "${H.pathname}" was given in the \`location\` prop.`),D=H}else D=N;let G=D.pathname||"/",L=G;if(E!=="/"){let H=E.replace(/^\//,"").split("/");L="/"+G.replace(/^\//,"").split("/").slice(H.length).join("/")}let B=gm(u,{pathname:L});Ut(A||B!=null,`No routes matched location "${D.pathname}${D.search}${D.hash}" `),Ut(B==null||B[B.length-1].route.element!==void 0||B[B.length-1].route.Component!==void 0||B[B.length-1].route.lazy!==void 0,`Matched leaf route at location "${D.pathname}${D.search}${D.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let X=xy(B&&B.map(H=>Object.assign({},H,{params:Object.assign({},b,H.params),pathname:hn([E,d.encodeLocation?d.encodeLocation(H.pathname.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathname]),pathnameBase:H.pathnameBase==="/"?E:hn([E,d.encodeLocation?d.encodeLocation(H.pathnameBase.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathnameBase])})),p,r,c,f);return s&&X?z.createElement(Ia.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...D},navigationType:"POP"}},X):X}function gy(){let u=_y(),s=ey(u)?`${u.status} ${u.statusText}`:u instanceof Error?u.message:JSON.stringify(u),r=u instanceof Error?u.stack:null,c="rgba(200,200,200, 0.5)",f={padding:"0.5rem",backgroundColor:c},d={padding:"2px 4px",backgroundColor:c},p=null;return console.error("Error handled by React Router default ErrorBoundary:",u),p=z.createElement(z.Fragment,null,z.createElement("p",null,"💿 Hey developer 👋"),z.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",z.createElement("code",{style:d},"ErrorBoundary")," or"," ",z.createElement("code",{style:d},"errorElement")," prop on your route.")),z.createElement(z.Fragment,null,z.createElement("h2",null,"Unexpected Application Error!"),z.createElement("h3",{style:{fontStyle:"italic"}},s),r?z.createElement("pre",{style:f},r):null,p)}var yy=z.createElement(gy,null),zm=class extends z.Component{constructor(u){super(u),this.state={location:u.location,revalidation:u.revalidation,error:u.error}}static getDerivedStateFromError(u){return{error:u}}static getDerivedStateFromProps(u,s){return s.location!==u.location||s.revalidation!=="idle"&&u.revalidation==="idle"?{error:u.error,location:u.location,revalidation:u.revalidation}:{error:u.error!==void 0?u.error:s.error,location:s.location,revalidation:u.revalidation||s.revalidation}}componentDidCatch(u,s){this.props.onError?this.props.onError(u,s):console.error("React Router caught the following error during render",u)}render(){let u=this.state.error;if(this.context&&typeof u=="object"&&u&&"digest"in u&&typeof u.digest=="string"){const r=cy(u.digest);r&&(u=r)}let s=u!==void 0?z.createElement(Dt.Provider,{value:this.props.routeContext},z.createElement(vc.Provider,{value:u,children:this.props.component})):this.props.children;return this.context?z.createElement(by,{error:u},s):s}};zm.contextType=ly;var ic=new WeakMap;function by({children:u,error:s}){let{basename:r}=z.useContext(bt);if(typeof s=="object"&&s&&"digest"in s&&typeof s.digest=="string"){let c=ry(s.digest);if(c){let f=ic.get(s);if(f)throw f;let d=xm(c.location,r);if(vm&&!ic.get(s))if(d.isExternal||c.reloadDocument)window.location.href=d.absoluteURL||d.to;else{const p=Promise.resolve().then(()=>window.__reactRouterDataRouter.navigate(d.to,{replace:c.replace}));throw ic.set(s,p),p}return z.createElement("meta",{httpEquiv:"refresh",content:`0;url=${d.absoluteURL||d.to}`})}}return u}function vy({routeContext:u,match:s,children:r}){let c=z.useContext(Kl);return c&&c.static&&c.staticContext&&(s.route.errorElement||s.route.ErrorBoundary)&&(c.staticContext._deepestRenderedBoundaryId=s.route.id),z.createElement(Dt.Provider,{value:u},r)}function xy(u,s=[],r=null,c=null,f=null){if(u==null){if(!r)return null;if(r.errors)u=r.matches;else if(s.length===0&&!r.initialized&&r.matches.length>0)u=r.matches;else return null}let d=u,p=r==null?void 0:r.errors;if(p!=null){let E=d.findIndex(A=>A.route.id&&(p==null?void 0:p[A.route.id])!==void 0);Me(E>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(p).join(",")}`),d=d.slice(0,Math.min(d.length,E+1))}let g=!1,b=-1;if(r)for(let E=0;E<d.length;E++){let A=d[E];if((A.route.HydrateFallback||A.route.hydrateFallbackElement)&&(b=E),A.route.id){let{loaderData:N,errors:D}=r,G=A.route.loader&&!N.hasOwnProperty(A.route.id)&&(!D||D[A.route.id]===void 0);if(A.route.lazy||G){g=!0,b>=0?d=d.slice(0,b+1):d=[d[0]];break}}}let m=r&&c?(E,A)=>{var N,D;c(E,{location:r.location,params:((D=(N=r.matches)==null?void 0:N[0])==null?void 0:D.params)??{},unstable_pattern:ty(r.matches),errorInfo:A})}:void 0;return d.reduceRight((E,A,N)=>{let D,G=!1,L=null,B=null;r&&(D=p&&A.route.id?p[A.route.id]:void 0,L=A.route.errorElement||yy,g&&(b<0&&N===0?(Mm("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),G=!0,B=null):b===N&&(G=!0,B=A.route.hydrateFallbackElement||null)));let X=s.concat(d.slice(0,N+1)),K=()=>{let H;return D?H=L:G?H=B:A.route.Component?H=z.createElement(A.route.Component,null):A.route.element?H=A.route.element:H=E,z.createElement(vy,{match:A,routeContext:{outlet:E,matches:X,isDataRoute:r!=null},children:H})};return r&&(A.route.ErrorBoundary||A.route.errorElement||N===0)?z.createElement(zm,{location:r.location,revalidation:r.revalidation,component:L,error:D,children:K(),routeContext:{outlet:null,matches:X,isDataRoute:!0},onError:m}):K()},null)}function xc(u){return`${u} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Sy(u){let s=z.useContext(Kl);return Me(s,xc(u)),s}function Ey(u){let s=z.useContext(Du);return Me(s,xc(u)),s}function Ay(u){let s=z.useContext(Dt);return Me(s,xc(u)),s}function Sc(u){let s=Ay(u),r=s.matches[s.matches.length-1];return Me(r.route.id,`${u} can only be used on routes that contain a unique "id"`),r.route.id}function Ty(){return Sc("useRouteId")}function _y(){var c;let u=z.useContext(vc),s=Ey("useRouteError"),r=Sc("useRouteError");return u!==void 0?u:(c=s.errors)==null?void 0:c[r]}function Ry(){let{router:u}=Sy("useNavigate"),s=Sc("useNavigate"),r=z.useRef(!1);return _m(()=>{r.current=!0}),z.useCallback(async(f,d={})=>{Ut(r.current,Tm),r.current&&(typeof f=="number"?await u.navigate(f):await u.navigate(f,{fromRouteId:s,...d}))},[u,s])}var Fh={};function Mm(u,s,r){!s&&!Fh[u]&&(Fh[u]=!0,Ut(!1,r))}z.memo(Cy);function Cy({routes:u,future:s,state:r,onError:c}){return Cm(u,void 0,r,c,s)}function zy({to:u,replace:s,state:r,relative:c}){Me($l(),"<Navigate> may be used only in the context of a <Router> component.");let{static:f}=z.useContext(bt);Ut(!f,"<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.");let{matches:d}=z.useContext(Dt),{pathname:p}=pn(),g=Rm(),b=bc(u,yc(d),p,c==="path"),m=JSON.stringify(b);return z.useEffect(()=>{g(JSON.parse(m),{replace:s,state:r,relative:c})},[g,m,c,s,r]),null}function My(u){return hy(u.context)}function on(u){Me(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function Dy({basename:u="/",children:s=null,location:r,navigationType:c="POP",navigator:f,static:d=!1,unstable_useTransitions:p}){Me(!$l(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let g=u.replace(/^\/*/,"/"),b=z.useMemo(()=>({basename:g,navigator:f,static:d,unstable_useTransitions:p,future:{}}),[g,f,d,p]);typeof r=="string"&&(r=Jl(r));let{pathname:m="/",search:E="",hash:A="",state:N=null,key:D="default"}=r,G=z.useMemo(()=>{let L=mn(m,g);return L==null?null:{location:{pathname:L,search:E,hash:A,state:N,key:D},navigationType:c}},[g,m,E,A,N,D,c]);return Ut(G!=null,`<Router basename="${g}"> is not able to match the URL "${m}${E}${A}" because it does not start with the basename, so the <Router> won't render anything.`),G==null?null:z.createElement(bt.Provider,{value:b},z.createElement(Ia.Provider,{children:s,value:G}))}function Ny({children:u,location:s}){return py(fc(u),s)}function fc(u,s=[]){let r=[];return z.Children.forEach(u,(c,f)=>{if(!z.isValidElement(c))return;let d=[...s,f];if(c.type===z.Fragment){r.push.apply(r,fc(c.props.children,d));return}Me(c.type===on,`[${typeof c.type=="string"?c.type:c.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Me(!c.props.index||!c.props.children,"An index route cannot have child routes.");let p={id:c.props.id||d.join("-"),caseSensitive:c.props.caseSensitive,element:c.props.element,Component:c.props.Component,index:c.props.index,path:c.props.path,middleware:c.props.middleware,loader:c.props.loader,action:c.props.action,hydrateFallbackElement:c.props.hydrateFallbackElement,HydrateFallback:c.props.HydrateFallback,errorElement:c.props.errorElement,ErrorBoundary:c.props.ErrorBoundary,hasErrorBoundary:c.props.hasErrorBoundary===!0||c.props.ErrorBoundary!=null||c.props.errorElement!=null,shouldRevalidate:c.props.shouldRevalidate,handle:c.props.handle,lazy:c.props.lazy};c.props.children&&(p.children=fc(c.props.children,d)),r.push(p)}),r}var Eu="get",Au="application/x-www-form-urlencoded";function Nu(u){return typeof HTMLElement<"u"&&u instanceof HTMLElement}function Oy(u){return Nu(u)&&u.tagName.toLowerCase()==="button"}function ky(u){return Nu(u)&&u.tagName.toLowerCase()==="form"}function wy(u){return Nu(u)&&u.tagName.toLowerCase()==="input"}function jy(u){return!!(u.metaKey||u.altKey||u.ctrlKey||u.shiftKey)}function Hy(u,s){return u.button===0&&(!s||s==="_self")&&!jy(u)}var vu=null;function Uy(){if(vu===null)try{new FormData(document.createElement("form"),0),vu=!1}catch{vu=!0}return vu}var Ly=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function uc(u){return u!=null&&!Ly.has(u)?(Ut(!1,`"${u}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Au}"`),null):u}function By(u,s){let r,c,f,d,p;if(ky(u)){let g=u.getAttribute("action");c=g?mn(g,s):null,r=u.getAttribute("method")||Eu,f=uc(u.getAttribute("enctype"))||Au,d=new FormData(u)}else if(Oy(u)||wy(u)&&(u.type==="submit"||u.type==="image")){let g=u.form;if(g==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let b=u.getAttribute("formaction")||g.getAttribute("action");if(c=b?mn(b,s):null,r=u.getAttribute("formmethod")||g.getAttribute("method")||Eu,f=uc(u.getAttribute("formenctype"))||uc(g.getAttribute("enctype"))||Au,d=new FormData(g,u),!Uy()){let{name:m,type:E,value:A}=u;if(E==="image"){let N=m?`${m}.`:"";d.append(`${N}x`,"0"),d.append(`${N}y`,"0")}else m&&d.append(m,A)}}else{if(Nu(u))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');r=Eu,c=null,f=Au,p=u}return d&&f==="text/plain"&&(p=d,d=void 0),{action:c,method:r.toLowerCase(),encType:f,formData:d,body:p}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Ec(u,s){if(u===!1||u===null||typeof u>"u")throw new Error(s)}function Gy(u,s,r,c){let f=typeof u=="string"?new URL(u,typeof window>"u"?"server://singlefetch/":window.location.origin):u;return r?f.pathname.endsWith("/")?f.pathname=`${f.pathname}_.${c}`:f.pathname=`${f.pathname}.${c}`:f.pathname==="/"?f.pathname=`_root.${c}`:s&&mn(f.pathname,s)==="/"?f.pathname=`${s.replace(/\/$/,"")}/_root.${c}`:f.pathname=`${f.pathname.replace(/\/$/,"")}.${c}`,f}async function qy(u,s){if(u.id in s)return s[u.id];try{let r=await import(u.module);return s[u.id]=r,r}catch(r){return console.error(`Error loading route module \`${u.module}\`, reloading page...`),console.error(r),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Qy(u){return u==null?!1:u.href==null?u.rel==="preload"&&typeof u.imageSrcSet=="string"&&typeof u.imageSizes=="string":typeof u.rel=="string"&&typeof u.href=="string"}async function Yy(u,s,r){let c=await Promise.all(u.map(async f=>{let d=s.routes[f.route.id];if(d){let p=await qy(d,r);return p.links?p.links():[]}return[]}));return Jy(c.flat(1).filter(Qy).filter(f=>f.rel==="stylesheet"||f.rel==="preload").map(f=>f.rel==="stylesheet"?{...f,rel:"prefetch",as:"style"}:{...f,rel:"prefetch"}))}function Ih(u,s,r,c,f,d){let p=(b,m)=>r[m]?b.route.id!==r[m].route.id:!0,g=(b,m)=>{var E;return r[m].pathname!==b.pathname||((E=r[m].route.path)==null?void 0:E.endsWith("*"))&&r[m].params["*"]!==b.params["*"]};return d==="assets"?s.filter((b,m)=>p(b,m)||g(b,m)):d==="data"?s.filter((b,m)=>{var A;let E=c.routes[b.route.id];if(!E||!E.hasLoader)return!1;if(p(b,m)||g(b,m))return!0;if(b.route.shouldRevalidate){let N=b.route.shouldRevalidate({currentUrl:new URL(f.pathname+f.search+f.hash,window.origin),currentParams:((A=r[0])==null?void 0:A.params)||{},nextUrl:new URL(u,window.origin),nextParams:b.params,defaultShouldRevalidate:!0});if(typeof N=="boolean")return N}return!0}):[]}function Xy(u,s,{includeHydrateFallback:r}={}){return Vy(u.map(c=>{let f=s.routes[c.route.id];if(!f)return[];let d=[f.module];return f.clientActionModule&&(d=d.concat(f.clientActionModule)),f.clientLoaderModule&&(d=d.concat(f.clientLoaderModule)),r&&f.hydrateFallbackModule&&(d=d.concat(f.hydrateFallbackModule)),f.imports&&(d=d.concat(f.imports)),d}).flat(1))}function Vy(u){return[...new Set(u)]}function Zy(u){let s={},r=Object.keys(u).sort();for(let c of r)s[c]=u[c];return s}function Jy(u,s){let r=new Set;return new Set(s),u.reduce((c,f)=>{let d=JSON.stringify(Zy(f));return r.has(d)||(r.add(d),c.push({key:d,link:f})),c},[])}function Dm(){let u=z.useContext(Kl);return Ec(u,"You must render this element inside a <DataRouterContext.Provider> element"),u}function Ky(){let u=z.useContext(Du);return Ec(u,"You must render this element inside a <DataRouterStateContext.Provider> element"),u}var Ac=z.createContext(void 0);Ac.displayName="FrameworkContext";function Nm(){let u=z.useContext(Ac);return Ec(u,"You must render this element inside a <HydratedRouter> element"),u}function $y(u,s){let r=z.useContext(Ac),[c,f]=z.useState(!1),[d,p]=z.useState(!1),{onFocus:g,onBlur:b,onMouseEnter:m,onMouseLeave:E,onTouchStart:A}=s,N=z.useRef(null);z.useEffect(()=>{if(u==="render"&&p(!0),u==="viewport"){let L=X=>{X.forEach(K=>{p(K.isIntersecting)})},B=new IntersectionObserver(L,{threshold:.5});return N.current&&B.observe(N.current),()=>{B.disconnect()}}},[u]),z.useEffect(()=>{if(c){let L=setTimeout(()=>{p(!0)},100);return()=>{clearTimeout(L)}}},[c]);let D=()=>{f(!0)},G=()=>{f(!1),p(!1)};return r?u!=="intent"?[d,N,{}]:[d,N,{onFocus:Va(g,D),onBlur:Va(b,G),onMouseEnter:Va(m,D),onMouseLeave:Va(E,G),onTouchStart:Va(A,D)}]:[!1,N,{}]}function Va(u,s){return r=>{u&&u(r),r.defaultPrevented||s(r)}}function Wy({page:u,...s}){let{router:r}=Dm(),c=z.useMemo(()=>gm(r.routes,u,r.basename),[r.routes,u,r.basename]);return c?z.createElement(Iy,{page:u,matches:c,...s}):null}function Fy(u){let{manifest:s,routeModules:r}=Nm(),[c,f]=z.useState([]);return z.useEffect(()=>{let d=!1;return Yy(u,s,r).then(p=>{d||f(p)}),()=>{d=!0}},[u,s,r]),c}function Iy({page:u,matches:s,...r}){let c=pn(),{future:f,manifest:d,routeModules:p}=Nm(),{basename:g}=Dm(),{loaderData:b,matches:m}=Ky(),E=z.useMemo(()=>Ih(u,s,m,d,c,"data"),[u,s,m,d,c]),A=z.useMemo(()=>Ih(u,s,m,d,c,"assets"),[u,s,m,d,c]),N=z.useMemo(()=>{if(u===c.pathname+c.search+c.hash)return[];let L=new Set,B=!1;if(s.forEach(K=>{var I;let H=d.routes[K.route.id];!H||!H.hasLoader||(!E.some(ee=>ee.route.id===K.route.id)&&K.route.id in b&&((I=p[K.route.id])!=null&&I.shouldRevalidate)||H.hasClientLoader?B=!0:L.add(K.route.id))}),L.size===0)return[];let X=Gy(u,g,f.unstable_trailingSlashAwareDataRequests,"data");return B&&L.size>0&&X.searchParams.set("_routes",s.filter(K=>L.has(K.route.id)).map(K=>K.route.id).join(",")),[X.pathname+X.search]},[g,f.unstable_trailingSlashAwareDataRequests,b,c,d,E,s,u,p]),D=z.useMemo(()=>Xy(A,d),[A,d]),G=Fy(A);return z.createElement(z.Fragment,null,N.map(L=>z.createElement("link",{key:L,rel:"prefetch",as:"fetch",href:L,...r})),D.map(L=>z.createElement("link",{key:L,rel:"modulepreload",href:L,...r})),G.map(({key:L,link:B})=>z.createElement("link",{key:L,nonce:r.nonce,...B,crossOrigin:B.crossOrigin??r.crossOrigin})))}function Py(...u){return s=>{u.forEach(r=>{typeof r=="function"?r(s):r!=null&&(r.current=s)})}}var eb=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{eb&&(window.__reactRouterVersion="7.13.0")}catch{}function tb({basename:u,children:s,unstable_useTransitions:r,window:c}){let f=z.useRef();f.current==null&&(f.current=Dg({window:c,v5Compat:!0}));let d=f.current,[p,g]=z.useState({action:d.action,location:d.location}),b=z.useCallback(m=>{r===!1?g(m):z.startTransition(()=>g(m))},[r]);return z.useLayoutEffect(()=>d.listen(b),[d,b]),z.createElement(Dy,{basename:u,children:s,location:p.location,navigationType:p.action,navigator:d,unstable_useTransitions:r})}var Om=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,dn=z.forwardRef(function({onClick:s,discover:r="render",prefetch:c="none",relative:f,reloadDocument:d,replace:p,state:g,target:b,to:m,preventScrollReset:E,viewTransition:A,unstable_defaultShouldRevalidate:N,...D},G){let{basename:L,unstable_useTransitions:B}=z.useContext(bt),X=typeof m=="string"&&Om.test(m),K=xm(m,L);m=K.to;let H=oy(m,{relative:f}),[I,ee,se]=$y(c,D),W=ab(m,{replace:p,state:g,target:b,preventScrollReset:E,relative:f,viewTransition:A,unstable_defaultShouldRevalidate:N,unstable_useTransitions:B});function ke(vt){s&&s(vt),vt.defaultPrevented||W(vt)}let Xe=z.createElement("a",{...D,...se,href:K.absoluteURL||H,onClick:K.isExternal||d?s:ke,ref:Py(G,ee),target:b,"data-discover":!X&&r==="render"?"true":void 0});return I&&!X?z.createElement(z.Fragment,null,Xe,z.createElement(Wy,{page:H})):Xe});dn.displayName="Link";var Tu=z.forwardRef(function({"aria-current":s="page",caseSensitive:r=!1,className:c="",end:f=!1,style:d,to:p,viewTransition:g,children:b,...m},E){let A=Pa(p,{relative:m.relative}),N=pn(),D=z.useContext(Du),{navigator:G,basename:L}=z.useContext(bt),B=D!=null&&cb(A)&&g===!0,X=G.encodeLocation?G.encodeLocation(A).pathname:A.pathname,K=N.pathname,H=D&&D.navigation&&D.navigation.location?D.navigation.location.pathname:null;r||(K=K.toLowerCase(),H=H?H.toLowerCase():null,X=X.toLowerCase()),H&&L&&(H=mn(H,L)||H);const I=X!=="/"&&X.endsWith("/")?X.length-1:X.length;let ee=K===X||!f&&K.startsWith(X)&&K.charAt(I)==="/",se=H!=null&&(H===X||!f&&H.startsWith(X)&&H.charAt(X.length)==="/"),W={isActive:ee,isPending:se,isTransitioning:B},ke=ee?s:void 0,Xe;typeof c=="function"?Xe=c(W):Xe=[c,ee?"active":null,se?"pending":null,B?"transitioning":null].filter(Boolean).join(" ");let vt=typeof d=="function"?d(W):d;return z.createElement(dn,{...m,"aria-current":ke,className:Xe,ref:E,style:vt,to:p,viewTransition:g},typeof b=="function"?b(W):b)});Tu.displayName="NavLink";var nb=z.forwardRef(({discover:u="render",fetcherKey:s,navigate:r,reloadDocument:c,replace:f,state:d,method:p=Eu,action:g,onSubmit:b,relative:m,preventScrollReset:E,viewTransition:A,unstable_defaultShouldRevalidate:N,...D},G)=>{let{unstable_useTransitions:L}=z.useContext(bt),B=sb(),X=rb(g,{relative:m}),K=p.toLowerCase()==="get"?"get":"post",H=typeof g=="string"&&Om.test(g),I=ee=>{if(b&&b(ee),ee.defaultPrevented)return;ee.preventDefault();let se=ee.nativeEvent.submitter,W=(se==null?void 0:se.getAttribute("formmethod"))||p,ke=()=>B(se||ee.currentTarget,{fetcherKey:s,method:W,navigate:r,replace:f,state:d,relative:m,preventScrollReset:E,viewTransition:A,unstable_defaultShouldRevalidate:N});L&&r!==!1?z.startTransition(()=>ke()):ke()};return z.createElement("form",{ref:G,method:K,action:X,onSubmit:c?b:I,...D,"data-discover":!H&&u==="render"?"true":void 0})});nb.displayName="Form";function lb(u){return`${u} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function km(u){let s=z.useContext(Kl);return Me(s,lb(u)),s}function ab(u,{target:s,replace:r,state:c,preventScrollReset:f,relative:d,viewTransition:p,unstable_defaultShouldRevalidate:g,unstable_useTransitions:b}={}){let m=Rm(),E=pn(),A=Pa(u,{relative:d});return z.useCallback(N=>{if(Hy(N,s)){N.preventDefault();let D=r!==void 0?r:Fa(E)===Fa(A),G=()=>m(u,{replace:D,state:c,preventScrollReset:f,relative:d,viewTransition:p,unstable_defaultShouldRevalidate:g});b?z.startTransition(()=>G()):G()}},[E,m,A,r,c,s,u,f,d,p,g,b])}var ib=0,ub=()=>`__${String(++ib)}__`;function sb(){let{router:u}=km("useSubmit"),{basename:s}=z.useContext(bt),r=Ty(),c=u.fetch,f=u.navigate;return z.useCallback(async(d,p={})=>{let{action:g,method:b,encType:m,formData:E,body:A}=By(d,s);if(p.navigate===!1){let N=p.fetcherKey||ub();await c(N,r,p.action||g,{unstable_defaultShouldRevalidate:p.unstable_defaultShouldRevalidate,preventScrollReset:p.preventScrollReset,formData:E,body:A,formMethod:p.method||b,formEncType:p.encType||m,flushSync:p.flushSync})}else await f(p.action||g,{unstable_defaultShouldRevalidate:p.unstable_defaultShouldRevalidate,preventScrollReset:p.preventScrollReset,formData:E,body:A,formMethod:p.method||b,formEncType:p.encType||m,replace:p.replace,state:p.state,fromRouteId:r,flushSync:p.flushSync,viewTransition:p.viewTransition})},[c,f,s,r])}function rb(u,{relative:s}={}){let{basename:r}=z.useContext(bt),c=z.useContext(Dt);Me(c,"useFormAction must be used inside a RouteContext");let[f]=c.matches.slice(-1),d={...Pa(u||".",{relative:s})},p=pn();if(u==null){d.search=p.search;let g=new URLSearchParams(d.search),b=g.getAll("index");if(b.some(E=>E==="")){g.delete("index"),b.filter(A=>A).forEach(A=>g.append("index",A));let E=g.toString();d.search=E?`?${E}`:""}}return(!u||u===".")&&f.route.index&&(d.search=d.search?d.search.replace(/^\?/,"?index&"):"?index"),r!=="/"&&(d.pathname=d.pathname==="/"?r:hn([r,d.pathname])),Fa(d)}function cb(u,{relative:s}={}){let r=z.useContext(Em);Me(r!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:c}=km("useViewTransitionState"),f=Pa(u,{relative:s});if(!r.isTransitioning)return!1;let d=mn(r.currentLocation.pathname,c)||r.currentLocation.pathname,p=mn(r.nextLocation.pathname,c)||r.nextLocation.pathname;return _u(f.pathname,p)!=null||_u(f.pathname,d)!=null}/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ob=u=>u.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase(),fb=u=>u.replace(/^([A-Z])|[\s-_]+(\w)/g,(s,r,c)=>c?c.toUpperCase():r.toLowerCase()),Ph=u=>{const s=fb(u);return s.charAt(0).toUpperCase()+s.slice(1)},wm=(...u)=>u.filter((s,r,c)=>!!s&&s.trim()!==""&&c.indexOf(s)===r).join(" ").trim(),db=u=>{for(const s in u)if(s.startsWith("aria-")||s==="role"||s==="title")return!0};/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Oe=(u,s)=>{const r=z.forwardRef(({className:c,...f},d)=>z.createElement(mb,{ref:d,iconNode:s,className:wm(`lucide-${ob(Ph(u))}`,`lucide-${u}`,c),...f}));return r.displayName=Ph(u),r};/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Mb=[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]],Db=Oe("copy",Mb);/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Nb=[["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M17 20v2",key:"1rnc9c"}],["path",{d:"M17 2v2",key:"11trls"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M2 17h2",key:"7oei6x"}],["path",{d:"M2 7h2",key:"asdhe0"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"M20 17h2",key:"1fpfkl"}],["path",{d:"M20 7h2",key:"1o8tra"}],["path",{d:"M7 20v2",key:"4gnj0m"}],["path",{d:"M7 2v2",key:"1i4yhu"}],["rect",{x:"4",y:"4",width:"16",height:"16",rx:"2",key:"1vbyd7"}],["rect",{x:"8",y:"8",width:"8",height:"8",rx:"1",key:"z9xiuo"}]],Ob=Oe("cpu",Nb);/**
 * @license lucide-react v0.562.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`;function Tc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var rl=Tc();function jm(u){rl=u}var Wa={exec:()=>null};function he(u,s=""){let r=typeof u=="string"?u:u.source,c={replace:(f,d)=>{let p=typeof d=="string"?d:d.source;return p=p.replace(Pe.caret,"$1"),r=r.replace(f,p),c},getRegex:()=>new RegExp(r,s)};return c}var gv=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Pe={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceTabs:/^\t+/,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,unescapeTest:/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:u=>new RegExp(`^( {0,3}${u})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}#`),htmlBeginRegex:u=>new RegExp(`^ {0,${Math.min(3,u-1)}}<(?:[a-z].*>|!--)`,"i")},yv=/^(?:[ \t]*(?:\n|$))+/,bv=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,vv=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ei=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,xv=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,_c=/(?:[*+-]|\d{1,9}[.)])/,Hm=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Um=he(Hm).replace(/bull/g,_c).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Sv=he(Hm).replace(/bull/g,_c).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Rc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Ev=/^[^\n]+/,Cc=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,Av=he(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Cc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Tv=he(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,_c).getRegex(),Ou="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",zc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,_v=he("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",zc).replace("tag",Ou).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Lm=he(Rc).replace("hr",ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ou).getRegex(),Rv=he(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Lm).getRegex(),Mc={blockquote:Rv,code:bv,def:Av,fences:vv,heading:xv,hr:ei,html:_v,lheading:Um,list:Tv,newline:yv,paragraph:Lm,table:Wa,text:Ev},um=he("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ou).getRegex(),Cv={...Mc,lheading:Sv,table:um,paragraph:he(Rc).replace("hr",ei).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",um).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Ou).getRegex()},zv={...Mc,html:he(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",zc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:Wa,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:he(Rc).replace("hr",ei).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Um).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Mv=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Dv=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Bm=/^( {2,}|\\)\n(?!\s*$)/,Nv=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,ku=/[\p{P}\p{S}]/u,Dc=/[\s\p{P}\p{S}]/u,Gm=/[^\s\p{P}\p{S}]/u,Ov=he(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Dc).getRegex(),qm=/(?!~)[\p{P}\p{S}]/u,kv=/(?!~)[\s\p{P}\p{S}]/u,wv=/(?:[^\s\p{P}\p{S}]|~)/u,jv=he(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",gv?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Qm=/^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,Hv=he(Qm,"u").replace(/punct/g,ku).getRegex(),Uv=he(Qm,"u").replace(/punct/g,qm).getRegex(),Ym="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",Lv=he(Ym,"gu").replace(/notPunctSpace/g,Gm).replace(/punctSpace/g,Dc).replace(/punct/g,ku).getRegex(),Bv=he(Ym,"gu").replace(/notPunctSpace/g,wv).replace(/punctSpace/g,kv).replace(/punct/g,qm).getRegex(),Gv=he("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Gm).replace(/punctSpace/g,Dc).replace(/punct/g,ku).getRegex(),qv=he(/\\(punct)/,"gu").replace(/punct/g,ku).getRegex(),Qv=he(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),Yv=he(zc).replace("(?:-->|$)","-->").getRegex(),Xv=he("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",Yv).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Cu=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/,Vv=he(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label",Cu).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Xm=he(/^!?\[(label)\]\[(ref)\]/).replace("label",Cu).replace("ref",Cc).getRegex(),Vm=he(/^!?\[(ref)\](?:\[\])?/).replace("ref",Cc).getRegex(),Zv=he("reflink|nolink(?!\\()","g").replace("reflink",Xm).replace("nolink",Vm).getRegex(),sm=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Nc={_backpedal:Wa,anyPunctuation:qv,autolink:Qv,blockSkip:jv,br:Bm,code:Dv,del:Wa,emStrongLDelim:Hv,emStrongRDelimAst:Lv,emStrongRDelimUnd:Gv,escape:Mv,link:Vv,nolink:Vm,punctuation:Ov,reflink:Xm,reflinkSearch:Zv,tag:Xv,text:Nv,url:Wa},Jv={...Nc,link:he(/^!?\[(label)\]\((.*?)\)/).replace("label",Cu).getRegex(),reflink:he(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Cu).getRegex()},hc={...Nc,emStrongRDelimAst:Bv,emStrongLDelim:Uv,url:he(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",sm).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:he(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",sm).getRegex()},Kv={...hc,br:he(Bm).replace("{2,}","*").getRegex(),text:he(hc.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},xu={normal:Mc,gfm:Cv,pedantic:zv},Ja={normal:Nc,gfm:hc,breaks:Kv,pedantic:Jv},$v={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},rm=u=>$v[u];function fn(u,s){if(s){if(Pe.escapeTest.test(u))return u.replace(Pe.escapeReplace,rm)}else if(Pe.escapeTestNoEncode.test(u))return u.replace(Pe.escapeReplaceNoEncode,rm);return u}function cm(u){try{u=encodeURI(u).replace(Pe.percentDecode,"%")}catch{return null}return u}function om(u,s){var d;let r=u.replace(Pe.findPipe,(p,g,b)=>{let m=!1,E=g;for(;--E>=0&&b[E]==="\\";)m=!m;return m?"|":" |"}),c=r.split(Pe.splitPipe),f=0;if(c[0].trim()||c.shift(),c.length>0&&!((d=c.at(-1))!=null&&d.trim())&&c.pop(),s)if(c.length>s)c.splice(s);else for(;c.length<s;)c.push("");for(;f<c.length;f++)c[f]=c[f].trim().replace(Pe.slashPipe,"|");return c}function Ka(u,s,r){let c=u.length;if(c===0)return"";let f=0;for(;f<c&&u.charAt(c-f-1)===s;)f++;return u.slice(0,c-f)}function Wv(u,s){if(u.indexOf(s[1])===-1)return-1;let r=0;for(let c=0;c<u.length;c++)if(u[c]==="\\")c++;else if(u[c]===s[0])r++;else if(u[c]===s[1]&&(r--,r<0))return c;return r>0?-2:-1}function fm(u,s,r,c,f){let d=s.href,p=s.title||null,g=u[1].replace(f.other.outputLinkReplace,"$1");c.state.inLink=!0;let b={type:u[0].charAt(0)==="!"?"image":"link",raw:r,href:d,title:p,text:g,tokens:c.inlineTokens(g)};return c.state.inLink=!1,b}function Fv(u,s,r){let c=u.match(r.other.indentCodeCompensation);if(c===null)return s;let f=c[1];return s.split(`
...
${m}`:m,f=f?`${f}
${E}`:E;let A=this.lexer.state.top;if(this.lexer.state.top=!0,this.lexer.blockTokens(E,d,!0),this.lexer.state.top=A,r.length===0)break;let N=d.at(-1);if((N==null?void 0:N.type)==="code")break;if((N==null?void 0:N.type)==="blockquote"){let D=N,G=D.raw+`
`+r.join(`
`),L=this.blockquote(G);d[d.length-1]=L,c=c.substring(0,c.length-D.raw.length)+L.raw,f=f.substring(0,f.length-D.text.length)+L.text;break}else if((N==null?void 0:N.type)==="list"){let D=N,G=D.raw+`
`+r.join(`
`),L=this.list(G);d[d.length-1]=L,c=c.substring(0,c.length-N.raw.length)+L.raw,f=f.substring(0,f.length-D.raw.length)+L.raw,r=G.substring(d.at(-1).raw.length).split(`
`);continue}}return{type:"blockquote",raw:c,tokens:d,text:f}}}list(u){var r,c;let s=this.rules.block.list.exec(u);if(s){let f=s[1].trim(),d=f.length>1,p={type:"list",raw:"",ordered:d,start:d?+f.slice(0,-1):"",loose:!1,items:[]};f=d?`\\d{1,9}\\${f.slice(-1)}`:`\\${f}`,this.options.pedantic&&(f=d?f:"[*+-]");let g=this.rules.other.listItemRegex(f),b=!1;for(;u;){let E=!1,A="",N="";if(!(s=g.exec(u))||this.rules.block.hr.test(u))break;A=s[0],u=u.substring(A.length);let D=s[2].split(`
`,1)[0].replace(this.rules.other.listReplaceTabs,X=>" ".repeat(3*X.length)),G=u.split(`
`,1)[0],L=!D.trim(),B=0;if(this.options.pedantic?(B=2,N=D.trimStart()):L?B=s[1].length+1:(B=s[2].search(this.rules.other.nonSpaceChar),B=B>4?1:B,N=D.slice(B),B+=s[1].length),L&&this.rules.other.blankLine.test(G)&&(A+=G+`
`,u=u.substring(G.length+1),E=!0),!E){let X=this.rules.other.nextBulletRegex(B),K=this.rules.other.hrRegex(B),H=this.rules.other.fencesBeginRegex(B),I=this.rules.other.headingBeginRegex(B),ee=this.rules.other.htmlBeginRegex(B);for(;u;){let se=u.split(`
`,1)[0],W;if(G=se,this.options.pedantic?(G=G.replace(this.rules.other.listReplaceNesting,"  "),W=G):W=G.replace(this.rules.other.tabCharGlobal,"    "),H.test(G)||I.test(G)||ee.test(G)||X.test(G)||K.test(G))break;if(W.search(this.rules.other.nonSpaceChar)>=B||!G.trim())N+=`
`+W.slice(B);else{if(L||D.replace(this.rules.other.tabCharGlobal,"    ").search(this.rules.other.nonSpaceChar)>=4||H.test(D)||I.test(D)||K.test(D))break;N+=`
`+G}!L&&!G.trim()&&(L=!0),A+=se+`
`,u=u.substring(se.length+1),D=W.slice(B)}}p.loose||(b?p.loose=!0:this.rules.other.doubleBlankLine.test(A)&&(b=!0)),p.items.push({type:"list_item",raw:A,task:!!this.options.gfm&&this.rules.other.listIsTask.test(N),loose:!1,text:N,tokens:[]}),p.raw+=A}let m=p.items.at(-1);if(m)m.raw=m.raw.trimEnd(),m.text=m.text.trimEnd();else return;p.raw=p.raw.trimEnd();for(let E of p.items){if(this.lexer.state.top=!1,E.tokens=this.lexer.blockTokens(E.text,[]),E.task){if(E.text=E.text.replace(this.rules.other.listReplaceTask,""),((r=E.tokens[0])==null?void 0:r.type)==="text"||((c=E.tokens[0])==null?void 0:c.type)==="paragraph"){E.tokens[0].raw=E.tokens[0].raw.replace(this.rules.other.listReplaceTask,""),E.tokens[0].text=E.tokens[0].text.replace(this.rules.other.listReplaceTask,"");for(let N=this.lexer.inlineQueue.length-1;N>=0;N--)if(this.rules.other.listIsTask.test(this.lexer.inlineQueue[N].src)){this.lexer.inlineQueue[N].src=this.lexer.inlineQueue[N].src.replace(this.rules.other.listReplaceTask,"");break}}let A=this.rules.other.listTaskCheckbox.exec(E.raw);if(A){let N={type:"checkbox",raw:A[0]+" ",checked:A[0]!=="[ ]"};E.checked=N.checked,p.loose?E.tokens[0]&&["paragraph","text"].includes(E.tokens[0].type)&&"tokens"in E.tokens[0]&&E.tokens[0].tokens?(E.tokens[0].raw=N.raw+E.tokens[0].raw,E.tokens[0].text=N.raw+E.tokens[0].text,E.tokens[0].tokens.unshift(N)):E.tokens.unshift({type:"paragraph",raw:N.raw,text:N.raw,tokens:[N]}):E.tokens.unshift(N)}}if(!p.loose){let A=E.tokens.filter(D=>D.type==="space"),N=A.length>0&&A.some(D=>this.rules.other.anyLine.test(D.raw));p.loose=N}}if(p.loose)for(let E of p.items){E.loose=!0;for(let A of E.tokens)A.type==="text"&&(A.type="paragraph")}return p}}html(u){let s=this.rules.block.html.exec(u);if(s)return{type:"html",block:!0,raw:s[0],pre:s[1]==="pre"||s[1]==="script"||s[1]==="style",text:s[0]}}def(u){let s=this.rules.block.def.exec(u);if(s){let r=s[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal," "),c=s[2]?s[2].replace(this.rules.other.hrefBrackets,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",f=s[3]?s[3].substring(1,s[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):s[3];return{type:"def",tag:r,raw:s[0],href:c,title:f}}}table(u){var p;let s=this.rules.block.table.exec(u);if(!s||!this.rules.other.tableDelimiter.test(s[2]))return;let r=om(s[1]),c=s[2].replace(this.rules.other.tableAlignChars,"").split("|"),f=(p=s[3])!=null&&p.trim()?s[3].replace(this.rules.other.tableRowBlankLine,"").split(`
...
`)?"":`
`)+g.raw,m.text+=`
`+g.raw,this.inlineQueue.at(-1).src=m.text):this.tokens.links[g.tag]||(this.tokens.links[g.tag]={href:g.href,title:g.title},r.push(g));continue}if(g=this.tokenizer.table(s)){s=s.substring(g.raw.length),r.push(g);continue}if(g=this.tokenizer.lheading(s)){s=s.substring(g.raw.length),r.push(g);continue}let b=s;if((p=this.options.extensions)!=null&&p.startBlock){let m=1/0,E=s.slice(1),A;this.options.extensions.startBlock.forEach(N=>{A=N.call({lexer:this},E),typeof A=="number"&&A>=0&&(m=Math.min(m,A))}),m<1/0&&m>=0&&(b=s.substring(0,m+1))}if(this.state.top&&(g=this.tokenizer.paragraph(b))){let m=r.at(-1);c&&(m==null?void 0:m.type)==="paragraph"?(m.raw+=(m.raw.endsWith(`
`)?"":`
`)+g.raw,m.text+=`
...
`)?"":`
`)+g.raw,m.text+=`
`+g.text,this.inlineQueue.pop(),this.inlineQueue.at(-1).src=m.text):r.push(g);continue}if(s){let m="Infinite loop on byte: "+s.charCodeAt(0);if(this.options.silent){console.error(m);break}else throw new Error(m)}}return this.state.top=!0,r}inline(s,r=[]){return this.inlineQueue.push({src:s,tokens:r}),r}inlineTokens(s,r=[]){var b,m,E,A,N;let c=s,f=null;if(this.tokens.links){let D=Object.keys(this.tokens.links);if(D.length>0)for(;(f=this.tokenizer.rules.inline.reflinkSearch.exec(c))!=null;)D.includes(f[0].slice(f[0].lastIndexOf("[")+1,-1))&&(c=c.slice(0,f.index)+"["+"a".repeat(f[0].length-2)+"]"+c.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))}for(;(f=this.tokenizer.rules.inline.anyPunctuation.exec(c))!=null;)c=c.slice(0,f.index)+"++"+c.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);let d;for(;(f=this.tokenizer.rules.inline.blockSkip.exec(c))!=null;)d=f[2]?f[2].length:0,c=c.slice(0,f.index+d)+"["+"a".repeat(f[0].length-d-2)+"]"+c.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);c=((m=(b=this.options.hooks)==null?void 0:b.emStrongMask)==null?void 0:m.call({lexer:this},c))??c;let p=!1,g="";for(;s;){p||(g=""),p=!1;let D;if((A=(E=this.options.extensions)==null?void 0:E.inline)!=null&&A.some(L=>(D=L.call({lexer:this},s,r))?(s=s.substring(D.raw.length),r.push(D),!0):!1))continue;if(D=this.tokenizer.escape(s)){s=s.substring(D.raw.length),r.push(D);continue}if(D=this.tokenizer.tag(s)){s=s.substring(D.raw.length),r.push(D);continue}if(D=this.tokenizer.link(s)){s=s.substring(D.raw.length),r.push(D);continue}if(D=this.tokenizer.reflink(s,this.tokens.links)){s=s.substring(D.raw.length);let L=r.at(-1);D.type==="text"&&(L==null?void 0:L.type)==="text"?(L.raw+=D.raw,L.text+=D.text):r.push(D);continue}if(D=this.tokenizer.emStrong(s,c,g)){s=s.substring(D.raw.length),r.push(D);continue}if(D=this.tokenizer.codespan(s)){s=s.substring(D.raw.length),r.push(D);continue}if(D=this.tokenizer.br(s)){s=s.substring(D.raw.length),r.push(D);continue}if(D=this.tokenizer.del(s)){s=s.substring(D.raw.length),r.push(D);continue}if(D=this.tokenizer.autolink(s)){s=s.substring(D.raw.length),r.push(D);continue}if(!this.state.inLink&&(D=this.tokenizer.url(s))){s=s.substring(D.raw.length),r.push(D);continue}let G=s;if((N=this.options.extensions)!=null&&N.startInline){let L=1/0,B=s.slice(1),X;this.options.extensions.startInline.forEach(K=>{X=K.call({lexer:this},B),typeof X=="number"&&X>=0&&(L=Math.min(L,X))}),L<1/0&&L>=0&&(G=s.substring(0,L+1))}if(D=this.tokenizer.inlineText(G)){s=s.substring(D.raw.length),D.raw.slice(-1)!=="_"&&(g=D.raw.slice(-1)),p=!0;let L=r.at(-1);(L==null?void 0:L.type)==="text"?(L.raw+=D.raw,L.text+=D.text):r.push(D);continue}if(s){let L="Infinite loop on byte: "+s.charCodeAt(0);if(this.options.silent){console.error(L);break}else throw new Error(L)}}return r}},Mu=class{constructor(u){Ae(this,"options");Ae(this,"parser");this.options=u||rl}space(u){return""}code({text:u,lang:s,escaped:r}){var d;let c=(d=(s||"").match(Pe.notSpaceStart))==null?void 0:d[0],f=u.replace(Pe.endingNewline,"")+`
