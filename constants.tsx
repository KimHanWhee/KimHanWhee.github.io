...
import { Project, SkillCategory, EducationItem, NavItem, BlogPost } from './types';
...
export const KEY_METRICS = [
  { label: 'Monthly Traffic', value: '3억+', suffix: '건', description: '안정적인 대용량 트래픽 처리' },
  { label: 'Enterprise Clients', value: '50+', suffix: '개사', description: '주요 대기업 및 금융사' },
  { label: 'Uptime', value: '99.9', suffix: '%', description: '무중단 배포 및 운영' },
  { label: 'Experience', value: '5+', suffix: 'Years', description: '백엔드 엔지니어링 경력' },
];
...
export const PROJECTS: Project[] = [
  {
    ...
    techStack: ['Java', 'Spring Boot', 'Spring Cloud', 'Redis', 'RabbitMQ', 'R2DBC', 'Netflix Eureka', 'WebFlux'],
    keyAchievements: [
...
export const EDUCATION: EducationItem[] = [
  {
    ...
    degree: 'kt University에서 진행한 Docker 클라우드 컨테이너 기반 아키텍처 교육 과정',
  ...
  },
  {
    ...
    degree: '엔코아 아카데미(Encore Academy)에서 진행한 빅데이터 기반 개발자 양성 과정',
  ...
  },
  {
    ...
    degree: '이노베이션 아카데미(Innovation Academy)에서 진행한 자기주도학습 기반의 알고리즘 문제 풀이 과정',
  ...
  },
  {
    ...
    degree: '디지털 전환(Digital Transformation)시대의 핵심 클라우드 전문 인재 양성 교육 과정',
