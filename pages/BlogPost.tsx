    ...
    <div className="min-h-screen bg-white font-sans selection:bg-secondary/20 selection:text-primary">
      ...
      <div className="bg-slate-50 border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 relative">
          ...
          <Link to="/blog" className="inline-flex items-center text-slate-500 hover:text-secondary mb-8 transition-colors font-medium">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-6 text-slate-600 border-t border-slate-200/60 pt-6">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              {post.tags.map(tag => (
                 <span key={tag} className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-white border border-slate-200 text-slate-700 shadow-sm">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-20 pt-10 border-t border-slate-100 flex flex-col items-center">
           ...
           <Link to="/blog" className="px-8 py-3 bg-primary text-white font-bold rounded-lg hover:bg-slate-800 transition-colors shadow-lg shadow-slate-900/20">
             다른 글 보러가기
           </Link>
        </div>
      </div>
